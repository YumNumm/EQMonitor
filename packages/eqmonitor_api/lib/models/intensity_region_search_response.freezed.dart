...
class _IntensityRegionSearchResponse implements IntensityRegionSearchResponse {
  const _IntensityRegionSearchResponse({required final  List<IntensityRegionSearchItem> items, @JsonKey(includeIfNull: false, name: 'next_token') this.nextToken, @JsonKey(includeIfNull: false, name: 'next_pooling') this.nextPooling}): _items = items;
