...
@JsonKey(name: 'event_id') String get eventId; IntensityStationInfo get station; EarthquakePartial get earthquake;
...
@useResult
$Res call({
@JsonKey(name: 'event_id') String eventId, IntensityStationInfo station, EarthquakePartial earthquake
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'event_id')  String eventId,  IntensityStationInfo station,  EarthquakePartial earthquake)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _IntensityStationSearchItem() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'event_id')  String eventId,  IntensityStationInfo station,  EarthquakePartial earthquake)  $default,) {final _that = this;
switch (_that) {
case _IntensityStationSearchItem():
return $default(_that.eventId,_that.station,_that.earthquake);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'event_id')  String eventId,  IntensityStationInfo station,  EarthquakePartial earthquake)?  $default,) {final _that = this;
switch (_that) {
case _IntensityStationSearchItem() when $default != null:
return $default(_that.eventId,_that.station,_that.earthquake);case _:
  return null;
...
class _IntensityStationSearchItem implements IntensityStationSearchItem {
  const _IntensityStationSearchItem({@JsonKey(name: 'event_id') required this.eventId, required this.station, required this.earthquake});
