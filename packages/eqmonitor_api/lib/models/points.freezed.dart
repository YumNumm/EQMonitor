...
mixin _$Points {
 ...
 String get code; String get name; String get region; String get type; Location get location;@JsonKey(includeIfNull: true) num? get intensity; num get intensityDiff;
...
@useResult
$Res call({
 String code, String name, String region, String type, Location location,@JsonKey(includeIfNull: true) num? intensity, num intensityDiff
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String code,  String name,  String region,  String type,  Location location, @JsonKey(includeIfNull: true)  num? intensity,  num intensityDiff)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Points() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String code,  String name,  String region,  String type,  Location location, @JsonKey(includeIfNull: true)  num? intensity,  num intensityDiff)  $default,) {final _that = this;
switch (_that) {
case _Points():
return $default(_that.code,_that.name,_that.region,_that.type,_that.location,_that.intensity,_that.intensityDiff);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String code,  String name,  String region,  String type,  Location location, @JsonKey(includeIfNull: true)  num? intensity,  num intensityDiff)?  $default,) {final _that = this;
switch (_that) {
case _Points() when $default != null:
return $default(_that.code,_that.name,_that.region,_that.type,_that.location,_that.intensity,_that.intensityDiff);case _:
  return null;
...
class _Points implements Points {
  const _Points({required this.code, required this.name, required this.region, required this.type, required this.location, @JsonKey(includeIfNull: true) required this.intensity, required this.intensityDiff});
