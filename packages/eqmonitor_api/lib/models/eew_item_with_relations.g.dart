  ...
  ($checkedConvert) {
    final val = _EewItemWithRelations(
      ...
      infoType: $checkedConvert(
        'info_type',
        (v) => $enumDecode(_$EewItemWithRelationsInfoTypeEnumMap, v),
      ),
...
const _$EewItemWithRelationsInfoTypeEnumMap = {
  EewItemWithRelationsInfoType.publication: 'PUBLICATION',
  EewItemWithRelationsInfoType.correction: 'CORRECTION',
  EewItemWithRelationsInfoType.delay: 'DELAY',
  EewItemWithRelationsInfoType.cancellation: 'CANCELLATION',
};
