  ...
  ($checkedConvert) {
    final val = _IntensityMapImageItem(
      ...
      language: $checkedConvert(
        'language',
        (v) => $enumDecode(_$IntensityMapImageItemLanguageEnumMap, v),
      ),
...
const _$IntensityMapImageItemLanguageEnumMap = {
  IntensityMapImageItemLanguage.ja: 'ja',
  IntensityMapImageItemLanguage.en: 'en',
  IntensityMapImageItemLanguage.zh: 'zh',
};
