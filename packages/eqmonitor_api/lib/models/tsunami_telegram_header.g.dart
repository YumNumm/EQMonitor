...
_TsunamiTelegramHeader _$TsunamiTelegramHeaderFromJson(
  ...
  ($checkedConvert) {
    final val = _TsunamiTelegramHeader(
      ...
      type: $checkedConvert(
        'type',
        (v) => $enumDecode(_$TsunamiTelegramHeaderTypeEnumMap, v),
      ),
      title: $checkedConvert('title', (v) => v as String),
      status: $checkedConvert(
        'status',
        (v) => $enumDecode(_$TsunamiTelegramHeaderStatusEnumMap, v),
      ),
      infoType: $checkedConvert(
        'info_type',
        (v) => $enumDecode(_$TsunamiTelegramHeaderInfoTypeEnumMap, v),
      ),
...
const _$TsunamiTelegramHeaderTypeEnumMap = {
  TsunamiTelegramHeaderType.vtse41: 'VTSE41',
  TsunamiTelegramHeaderType.vtse51: 'VTSE51',
  TsunamiTelegramHeaderType.vtse52: 'VTSE52',
};

const _$TsunamiTelegramHeaderStatusEnumMap = {
  TsunamiTelegramHeaderStatus.normal: 'NORMAL',
  TsunamiTelegramHeaderStatus.training: 'TRAINING',
  TsunamiTelegramHeaderStatus.test: 'TEST',
};

const _$TsunamiTelegramHeaderInfoTypeEnumMap = {
  TsunamiTelegramHeaderInfoType.publication: 'PUBLICATION',
  TsunamiTelegramHeaderInfoType.correction: 'CORRECTION',
  TsunamiTelegramHeaderInfoType.delay: 'DELAY',
  TsunamiTelegramHeaderInfoType.cancellation: 'CANCELLATION',
};
