  ...
  ($checkedConvert) {
    final val = _TelegramDetail(
      ...
      infoType: $checkedConvert(
        'info_type',
        (v) => $enumDecode(_$TelegramDetailInfoTypeEnumMap, v),
      ),
...
const _$TelegramDetailInfoTypeEnumMap = {
  TelegramDetailInfoType.publication: 'PUBLICATION',
  TelegramDetailInfoType.correction: 'CORRECTION',
  TelegramDetailInfoType.delay: 'DELAY',
  TelegramDetailInfoType.cancellation: 'CANCELLATION',
};
