...
/// @nodoc
class _$EewsCopyWithImpl<$Res>
    implements $EewsCopyWith<$Res> {
  _$EewsCopyWithImpl(this._self, this._then);

  final Eews _self;
  final $Res Function(Eews) _then;
...
as Type,serialNo: null == serialNo ? _self.serialNo : serialNo // ignore: cast_nullable_to_non_nullable
...
as Hypocenter?,magnitude: freezed == magnitude ? _self.magnitude : magnitude // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [Eews].
extension EewsPatterns on Eews {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Eews value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _Eews() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Eews value)  $default,){
final _that = this;
switch (_that) {
case _Eews():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Eews value)?  $default,){
final _that = this;
switch (_that) {
case _Eews() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String eventId,  Type type,  num serialNo,  List<Regions> regions,  String reportTime, @JsonKey(includeIfNull: false)  String? maxIntensity, @JsonKey(includeIfNull: false)  String? headline, @JsonKey(includeIfNull: false)  String? originTime, @JsonKey(includeIfNull: false)  String? arrivalTime, @JsonKey(includeIfNull: false)  Hypocenter? hypocenter, @JsonKey(includeIfNull: false)  num? magnitude, @JsonKey(includeIfNull: false)  bool? isWarning, @JsonKey(includeIfNull: false)  bool? isLastInfo, @JsonKey(includeIfNull: false)  bool? isCancel, @JsonKey(includeIfNull: false)  String? hypocenterReduceName, @JsonKey(includeIfNull: false)  bool? hasWarningZones, @JsonKey(includeIfNull: false)  bool? isPlum, @JsonKey(includeIfNull: false)  bool? isLevel, @JsonKey(includeIfNull: false)  bool? isOnePoint, @JsonKey(includeIfNull: false)  String? comment, @JsonKey(includeIfNull: false)  List<Prefectures>? prefectures)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Eews() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String eventId,  Type type,  num serialNo,  List<Regions> regions,  String reportTime, @JsonKey(includeIfNull: false)  String? maxIntensity, @JsonKey(includeIfNull: false)  String? headline, @JsonKey(includeIfNull: false)  String? originTime, @JsonKey(includeIfNull: false)  String? arrivalTime, @JsonKey(includeIfNull: false)  Hypocenter? hypocenter, @JsonKey(includeIfNull: false)  num? magnitude, @JsonKey(includeIfNull: false)  bool? isWarning, @JsonKey(includeIfNull: false)  bool? isLastInfo, @JsonKey(includeIfNull: false)  bool? isCancel, @JsonKey(includeIfNull: false)  String? hypocenterReduceName, @JsonKey(includeIfNull: false)  bool? hasWarningZones, @JsonKey(includeIfNull: false)  bool? isPlum, @JsonKey(includeIfNull: false)  bool? isLevel, @JsonKey(includeIfNull: false)  bool? isOnePoint, @JsonKey(includeIfNull: false)  String? comment, @JsonKey(includeIfNull: false)  List<Prefectures>? prefectures)  $default,) {final _that = this;
switch (_that) {
case _Eews():
return $default(_that.eventId,_that.type,_that.serialNo,_that.regions,_that.reportTime,_that.maxIntensity,_that.headline,_that.originTime,_that.arrivalTime,_that.hypocenter,_that.magnitude,_that.isWarning,_that.isLastInfo,_that.isCancel,_that.hypocenterReduceName,_that.hasWarningZones,_that.isPlum,_that.isLevel,_that.isOnePoint,_that.comment,_that.prefectures);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String eventId,  Type type,  num serialNo,  List<Regions> regions,  String reportTime, @JsonKey(includeIfNull: false)  String? maxIntensity, @JsonKey(includeIfNull: false)  String? headline, @JsonKey(includeIfNull: false)  String? originTime, @JsonKey(includeIfNull: false)  String? arrivalTime, @JsonKey(includeIfNull: false)  Hypocenter? hypocenter, @JsonKey(includeIfNull: false)  num? magnitude, @JsonKey(includeIfNull: false)  bool? isWarning, @JsonKey(includeIfNull: false)  bool? isLastInfo, @JsonKey(includeIfNull: false)  bool? isCancel, @JsonKey(includeIfNull: false)  String? hypocenterReduceName, @JsonKey(includeIfNull: false)  bool? hasWarningZones, @JsonKey(includeIfNull: false)  bool? isPlum, @JsonKey(includeIfNull: false)  bool? isLevel, @JsonKey(includeIfNull: false)  bool? isOnePoint, @JsonKey(includeIfNull: false)  String? comment, @JsonKey(includeIfNull: false)  List<Prefectures>? prefectures)?  $default,) {final _that = this;
switch (_that) {
case _Eews() when $default != null:
return $default(_that.eventId,_that.type,_that.serialNo,_that.regions,_that.reportTime,_that.maxIntensity,_that.headline,_that.originTime,_that.arrivalTime,_that.hypocenter,_that.magnitude,_that.isWarning,_that.isLastInfo,_that.isCancel,_that.hypocenterReduceName,_that.hasWarningZones,_that.isPlum,_that.isLevel,_that.isOnePoint,_that.comment,_that.prefectures);case _:
  return null;
...
class _Eews implements Eews {
  const _Eews({required this.eventId, required this.type, required this.serialNo, required final  List<Regions> regions, required this.reportTime, @JsonKey(includeIfNull: false) this.maxIntensity, @JsonKey(includeIfNull: false) this.headline, @JsonKey(includeIfNull: false) this.originTime, @JsonKey(includeIfNull: false) this.arrivalTime, @JsonKey(includeIfNull: false) this.hypocenter, @JsonKey(includeIfNull: false) this.magnitude, @JsonKey(includeIfNull: false) this.isWarning, @JsonKey(includeIfNull: false) this.isLastInfo, @JsonKey(includeIfNull: false) this.isCancel, @JsonKey(includeIfNull: false) this.hypocenterReduceName, @JsonKey(includeIfNull: false) this.hasWarningZones, @JsonKey(includeIfNull: false) this.isPlum, @JsonKey(includeIfNull: false) this.isLevel, @JsonKey(includeIfNull: false) this.isOnePoint, @JsonKey(includeIfNull: false) this.comment, @JsonKey(includeIfNull: false) final  List<Prefectures>? prefectures}): _regions = regions,_prefectures = prefectures;
  factory _Eews.fromJson(Map<String, dynamic> json) => _$EewsFromJson(json);
...
@pragma('vm:prefer-inline')
_$EewsCopyWith<_Eews> get copyWith => __$EewsCopyWithImpl<_Eews>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$EewsToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Eews&&(identical(other.eventId, eventId) || other.eventId == eventId)&&(identical(other.type, type) || other.type == type)&&(identical(other.serialNo, serialNo) || other.serialNo == serialNo)&&const DeepCollectionEquality().equals(other._regions, _regions)&&(identical(other.reportTime, reportTime) || other.reportTime == reportTime)&&(identical(other.maxIntensity, maxIntensity) || other.maxIntensity == maxIntensity)&&(identical(other.headline, headline) || other.headline == headline)&&(identical(other.originTime, originTime) || other.originTime == originTime)&&(identical(other.arrivalTime, arrivalTime) || other.arrivalTime == arrivalTime)&&(identical(other.hypocenter, hypocenter) || other.hypocenter == hypocenter)&&(identical(other.magnitude, magnitude) || other.magnitude == magnitude)&&(identical(other.isWarning, isWarning) || other.isWarning == isWarning)&&(identical(other.isLastInfo, isLastInfo) || other.isLastInfo == isLastInfo)&&(identical(other.isCancel, isCancel) || other.isCancel == isCancel)&&(identical(other.hypocenterReduceName, hypocenterReduceName) || other.hypocenterReduceName == hypocenterReduceName)&&(identical(other.hasWarningZones, hasWarningZones) || other.hasWarningZones == hasWarningZones)&&(identical(other.isPlum, isPlum) || other.isPlum == isPlum)&&(identical(other.isLevel, isLevel) || other.isLevel == isLevel)&&(identical(other.isOnePoint, isOnePoint) || other.isOnePoint == isOnePoint)&&(identical(other.comment, comment) || other.comment == comment)&&const DeepCollectionEquality().equals(other._prefectures, _prefectures));
}
...
/// @nodoc
abstract mixin class _$EewsCopyWith<$Res> implements $EewsCopyWith<$Res> {
  factory _$EewsCopyWith(_Eews value, $Res Function(_Eews) _then) = __$EewsCopyWithImpl;
@override @useResult
$Res call({
 String eventId, Type type, num serialNo, List<Regions> regions, String reportTime,@JsonKey(includeIfNull: false) String? maxIntensity,@JsonKey(includeIfNull: false) String? headline,@JsonKey(includeIfNull: false) String? originTime,@JsonKey(includeIfNull: false) String? arrivalTime,@JsonKey(includeIfNull: false) Hypocenter? hypocenter,@JsonKey(includeIfNull: false) num? magnitude,@JsonKey(includeIfNull: false) bool? isWarning,@JsonKey(includeIfNull: false) bool? isLastInfo,@JsonKey(includeIfNull: false) bool? isCancel,@JsonKey(includeIfNull: false) String? hypocenterReduceName,@JsonKey(includeIfNull: false) bool? hasWarningZones,@JsonKey(includeIfNull: false) bool? isPlum,@JsonKey(includeIfNull: false) bool? isLevel,@JsonKey(includeIfNull: false) bool? isOnePoint,@JsonKey(includeIfNull: false) String? comment,@JsonKey(includeIfNull: false) List<Prefectures>? prefectures
});
...
/// @nodoc
class __$EewsCopyWithImpl<$Res>
    implements _$EewsCopyWith<$Res> {
  __$EewsCopyWithImpl(this._self, this._then);

  final _Eews _self;
  final $Res Function(_Eews) _then;
