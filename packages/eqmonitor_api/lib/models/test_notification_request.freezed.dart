...
mixin _$TestNotificationRequest {
 ...
 TestNotificationRequestType get type;
...
@useResult
$Res call({
 TestNotificationRequestType type
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( TestNotificationRequestType type)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TestNotificationRequest() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( TestNotificationRequestType type)  $default,) {final _that = this;
switch (_that) {
case _TestNotificationRequest():
return $default(_that.type);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( TestNotificationRequestType type)?  $default,) {final _that = this;
switch (_that) {
case _TestNotificationRequest() when $default != null:
return $default(_that.type);case _:
  return null;
...
@override final  TestNotificationRequestType type;
