...
mixin _$TestNotificationResponse {
 ...
 String get message; TestNotificationResponseFramework get framework;
...
@useResult
$Res call({
 String message, TestNotificationResponseFramework framework
});
...
as TestNotificationResponseFramework,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String message,  TestNotificationResponseFramework framework)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TestNotificationResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String message,  TestNotificationResponseFramework framework)  $default,) {final _that = this;
switch (_that) {
case _TestNotificationResponse():
return $default(_that.message,_that.framework);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String message,  TestNotificationResponseFramework framework)?  $default,) {final _that = this;
switch (_that) {
case _TestNotificationResponse() when $default != null:
return $default(_that.message,_that.framework);case _:
  return null;
...
@override final  TestNotificationResponseFramework framework;
