...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<Items2> items)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DispatchSummaryListResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<Items2> items)  $default,) {final _that = this;
switch (_that) {
case _DispatchSummaryListResponse():
return $default(_that.items);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<Items2> items)?  $default,) {final _that = this;
switch (_that) {
case _DispatchSummaryListResponse() when $default != null:
return $default(_that.items);case _:
  return null;
...
class _DispatchSummaryListResponse implements DispatchSummaryListResponse {
  const _DispatchSummaryListResponse({required final  List<Items2> items}): _items = items;
