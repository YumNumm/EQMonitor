...
mixin _$PrePeriods2 {
 ...
 num get band;@JsonKey(name: 'lpgm_intensity') String get lpgmIntensity; num get sva;
...
@useResult
$Res call({
 num band,@JsonKey(name: 'lpgm_intensity') String lpgmIntensity, num sva
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( num band, @JsonKey(name: 'lpgm_intensity')  String lpgmIntensity,  num sva)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PrePeriods2() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( num band, @JsonKey(name: 'lpgm_intensity')  String lpgmIntensity,  num sva)  $default,) {final _that = this;
switch (_that) {
case _PrePeriods2():
return $default(_that.band,_that.lpgmIntensity,_that.sva);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( num band, @JsonKey(name: 'lpgm_intensity')  String lpgmIntensity,  num sva)?  $default,) {final _that = this;
switch (_that) {
case _PrePeriods2() when $default != null:
return $default(_that.band,_that.lpgmIntensity,_that.sva);case _:
  return null;
...
class _PrePeriods2 implements PrePeriods2 {
  const _PrePeriods2({required this.band, @JsonKey(name: 'lpgm_intensity') required this.lpgmIntensity, required this.sva});
  factory _PrePeriods2.fromJson(Map<String, dynamic> json) => _$PrePeriods2FromJson(json);

@override final  num band;
@override@JsonKey(name: 'lpgm_intensity') final  String lpgmIntensity;
