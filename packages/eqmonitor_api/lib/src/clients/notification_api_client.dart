...
abstract class NotificationApiClient {
  ...
  getV2DeviceMeNotificationHistory({
  ...
  getV2DeviceMeNotificationDispatches();

  /// 配信サマリー詳細（admin）
  @GET(
    NotificationApiClientUrls.getV2DeviceMeNotificationDispatchesCorrelationKey,
  )
...
abstract class NotificationApiClientUrls {
  ...
  static const getV2DeviceMeNotificationHistory =
      "/v2/device/me/notification/history";

  /// /v2/device/me/notification/dispatches
  static const getV2DeviceMeNotificationDispatches =
      "/v2/device/me/notification/dispatches";

  /// /v2/device/me/notification/dispatches/{correlationKey}
  static const getV2DeviceMeNotificationDispatchesCorrelationKey =
      "/v2/device/me/notification/dispatches/{correlationKey}";

  /// /v2/device/me/notification/test
  static const postV2DeviceMeNotificationTest =
      "/v2/device/me/notification/test";
}
