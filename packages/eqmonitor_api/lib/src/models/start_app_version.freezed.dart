...
class _StartAppVersion implements StartAppVersion {
  const _StartAppVersion({@JsonKey(name: 'required_versions') required  List<RequiredVersion> requiredVersions, @JsonKey(includeIfNull: false) this.latest}): _requiredVersions = requiredVersions;
