...
@pragma('vm:prefer-inline') @override $Res call({Object? eventId = null,Object? stepsPlanned = null,Object? telegramTypes = null,}) {
  return _then(TestScenarioResponse(
...
class _TestScenarioResponse implements TestScenarioResponse {
  const _TestScenarioResponse({@JsonKey(name: 'event_id') required this.eventId, @JsonKey(name: 'steps_planned') required this.stepsPlanned, @JsonKey(name: 'telegram_types') required  List<String> telegramTypes}): _telegramTypes = telegramTypes;
