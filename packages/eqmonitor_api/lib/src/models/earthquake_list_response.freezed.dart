...
class _EarthquakeListResponse implements EarthquakeListResponse {
  const _EarthquakeListResponse({required final  List<EarthquakePartial> items, @JsonKey(includeIfNull: false, name: 'next_token') this.nextToken, @JsonKey(includeIfNull: false, name: 'next_pooling') this.nextPooling}): _items = items;
