...
_TsunamiNotificationTier _$TsunamiNotificationTierFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  '_TsunamiNotificationTier',
  json,
  ($checkedConvert) {
    final val = _TsunamiNotificationTier(
...
Map<String, dynamic> _$TsunamiNotificationTierToJson(
  _TsunamiNotificationTier instance,
) => <String, dynamic>{
