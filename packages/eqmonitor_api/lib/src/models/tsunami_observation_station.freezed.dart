...
mixin _$TsunamiObservationStation {
 ...
 String get code; String get name;@JsonKey(name: 'first_height') TsunamiObservationStationFirstHeight get firstHeight;@JsonKey(includeIfNull: false) String? get sensor;@JsonKey(includeIfNull: false, name: 'max_height') TsunamiObservationStationMaxHeight? get maxHeight;
...
@override
String toString() {
  return 'TsunamiObservationStation(code: $code, name: $name, firstHeight: $firstHeight, sensor: $sensor, maxHeight: $maxHeight)';
}
...
@useResult
$Res call({
 String code, String name,@JsonKey(name: 'first_height') TsunamiObservationStationFirstHeight firstHeight,@JsonKey(includeIfNull: false) String? sensor,@JsonKey(includeIfNull: false, name: 'max_height') TsunamiObservationStationMaxHeight? maxHeight
});
...
as TsunamiObservationStationFirstHeight,sensor: freezed == sensor ? _self.sensor : sensor // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String code,  String name, @JsonKey(name: 'first_height')  TsunamiObservationStationFirstHeight firstHeight, @JsonKey(includeIfNull: false)  String? sensor, @JsonKey(includeIfNull: false, name: 'max_height')  TsunamiObservationStationMaxHeight? maxHeight)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TsunamiObservationStation() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String code,  String name, @JsonKey(name: 'first_height')  TsunamiObservationStationFirstHeight firstHeight, @JsonKey(includeIfNull: false)  String? sensor, @JsonKey(includeIfNull: false, name: 'max_height')  TsunamiObservationStationMaxHeight? maxHeight)  $default,) {final _that = this;
switch (_that) {
case _TsunamiObservationStation():
return $default(_that.code,_that.name,_that.firstHeight,_that.sensor,_that.maxHeight);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String code,  String name, @JsonKey(name: 'first_height')  TsunamiObservationStationFirstHeight firstHeight, @JsonKey(includeIfNull: false)  String? sensor, @JsonKey(includeIfNull: false, name: 'max_height')  TsunamiObservationStationMaxHeight? maxHeight)?  $default,) {final _that = this;
switch (_that) {
case _TsunamiObservationStation() when $default != null:
return $default(_that.code,_that.name,_that.firstHeight,_that.sensor,_that.maxHeight);case _:
  return null;
...
class _TsunamiObservationStation implements TsunamiObservationStation {
  const _TsunamiObservationStation({required this.code, required this.name, @JsonKey(name: 'first_height') required this.firstHeight, @JsonKey(includeIfNull: false) this.sensor, @JsonKey(includeIfNull: false, name: 'max_height') this.maxHeight});
  factory _TsunamiObservationStation.fromJson(Map<String, dynamic> json) => _$TsunamiObservationStationFromJson(json);

@override final  String code;
@override final  String name;
@override@JsonKey(name: 'first_height') final  TsunamiObservationStationFirstHeight firstHeight;
