...
_UpdateRegionSlotRequest _$UpdateRegionSlotRequestFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  '_UpdateRegionSlotRequest',
  json,
  ($checkedConvert) {
    final val = _UpdateRegionSlotRequest(
...
Map<String, dynamic> _$UpdateRegionSlotRequestToJson(
  _UpdateRegionSlotRequest instance,
) => <String, dynamic>{
