...
mixin _$ShakeDetectionSnapshot {
 ...
 Type3 get type; int get revision; DateTime get responseAt; List<Events3> get events;
...
@useResult
$Res call({
 Type3 type, int revision, DateTime responseAt, List<Events3> events
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Type3 type,  int revision,  DateTime responseAt,  List<Events3> events)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ShakeDetectionSnapshot() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Type3 type,  int revision,  DateTime responseAt,  List<Events3> events)  $default,) {final _that = this;
switch (_that) {
case _ShakeDetectionSnapshot():
return $default(_that.type,_that.revision,_that.responseAt,_that.events);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Type3 type,  int revision,  DateTime responseAt,  List<Events3> events)?  $default,) {final _that = this;
switch (_that) {
case _ShakeDetectionSnapshot() when $default != null:
return $default(_that.type,_that.revision,_that.responseAt,_that.events);case _:
  return null;
...
class _ShakeDetectionSnapshot implements ShakeDetectionSnapshot {
  const _ShakeDetectionSnapshot({required this.type, required this.revision, required this.responseAt, required final  List<Events3> events}): _events = events;
...
@override final  DateTime responseAt;
 final  List<Events3> _events;
@override List<Events3> get events {
