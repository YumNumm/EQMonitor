...
@pragma('vm:prefer-inline') @override $Res call({Object? code = null,Object? name = null,Object? kana = freezed,Object? cities = null,}) {
  return _then(EarthquakeStationRegion(
...
class _EarthquakeStationRegion implements EarthquakeStationRegion {
  const _EarthquakeStationRegion({required this.code, required this.name, @JsonKey(includeIfNull: true) required this.kana, required  List<EarthquakeStationCity> cities}): _cities = cities;
