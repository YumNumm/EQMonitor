...
_TsunamiStateEarthquake _$TsunamiStateEarthquakeFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  '_TsunamiStateEarthquake',
  json,
  ($checkedConvert) {
    final val = _TsunamiStateEarthquake(
...
Map<String, dynamic> _$TsunamiStateEarthquakeToJson(
  _TsunamiStateEarthquake instance,
) => <String, dynamic>{
