      ...
      ($checkedConvert) {
        final val = _NotificationLogItem(
          ...
          result: $checkedConvert(
            'result',
            (v) => $enumDecode(_$NotificationDeliveryResultEnumMap, v),
          ),
...
const _$NotificationDeliveryResultEnumMap = {
  NotificationDeliveryResult.ok: 'OK',
  NotificationDeliveryResult.ng: 'NG',
};
