...
@pragma('vm:prefer-inline') @override $Res call({Object? items = null,Object? nextToken = freezed,Object? nextPooling = freezed,}) {
  return _then(AdminReplayFileListResponse(
...
class _AdminReplayFileListResponse implements AdminReplayFileListResponse {
  const _AdminReplayFileListResponse({required  List<ReplayFile> items, @JsonKey(includeIfNull: false, name: 'next_token') this.nextToken, @JsonKey(includeIfNull: false, name: 'next_pooling') this.nextPooling}): _items = items;
