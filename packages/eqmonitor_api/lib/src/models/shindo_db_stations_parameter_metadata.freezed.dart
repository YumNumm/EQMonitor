...
/// @nodoc
mixin _$ShindoDbStationsParameterMetadata {

/// const: "SHINDO_DB_STATIONS"
...
/// Create a copy of ShindoDbStationsParameterMetadata
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ShindoDbStationsParameterMetadataCopyWith<ShindoDbStationsParameterMetadata> get copyWith => _$ShindoDbStationsParameterMetadataCopyWithImpl<ShindoDbStationsParameterMetadata>(this as ShindoDbStationsParameterMetadata, _$identity);

  /// Serializes this ShindoDbStationsParameterMetadata to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ShindoDbStationsParameterMetadata&&(identical(other.type, type) || other.type == type)&&(identical(other.schemaVersion, schemaVersion) || other.schemaVersion == schemaVersion)&&(identical(other.sourceVersion, sourceVersion) || other.sourceVersion == sourceVersion)&&(identical(other.sourceUpdatedAt, sourceUpdatedAt) || other.sourceUpdatedAt == sourceUpdatedAt)&&const DeepCollectionEquality().equals(other.sourceUrls, sourceUrls)&&(identical(other.sha256, sha256) || other.sha256 == sha256));
}
...
@override
String toString() {
  return 'ShindoDbStationsParameterMetadata(type: $type, schemaVersion: $schemaVersion, sourceVersion: $sourceVersion, sourceUpdatedAt: $sourceUpdatedAt, sourceUrls: $sourceUrls, sha256: $sha256)';
}
...
/// @nodoc
abstract mixin class $ShindoDbStationsParameterMetadataCopyWith<$Res>  {
  factory $ShindoDbStationsParameterMetadataCopyWith(ShindoDbStationsParameterMetadata value, $Res Function(ShindoDbStationsParameterMetadata) _then) = _$ShindoDbStationsParameterMetadataCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$ShindoDbStationsParameterMetadataCopyWithImpl<$Res>
    implements $ShindoDbStationsParameterMetadataCopyWith<$Res> {
  _$ShindoDbStationsParameterMetadataCopyWithImpl(this._self, this._then);

  final ShindoDbStationsParameterMetadata _self;
  final $Res Function(ShindoDbStationsParameterMetadata) _then;
...
@pragma('vm:prefer-inline') @override $Res call({Object? type = null,Object? schemaVersion = null,Object? sourceVersion = null,Object? sourceUpdatedAt = freezed,Object? sourceUrls = null,Object? sha256 = null,}) {
  return _then(ShindoDbStationsParameterMetadata(
...
/// Adds pattern-matching-related methods to [ShindoDbStationsParameterMetadata].
extension ShindoDbStationsParameterMetadataPatterns on ShindoDbStationsParameterMetadata {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ShindoDbStationsParameterMetadata value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ShindoDbStationsParameterMetadata() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ShindoDbStationsParameterMetadata value)  $default,){
final _that = this;
switch (_that) {
case _ShindoDbStationsParameterMetadata():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ShindoDbStationsParameterMetadata value)?  $default,){
final _that = this;
switch (_that) {
case _ShindoDbStationsParameterMetadata() when $default != null:
return $default(_that);case _:
...
class _ShindoDbStationsParameterMetadata implements ShindoDbStationsParameterMetadata {
  const _ShindoDbStationsParameterMetadata({required this.type, @JsonKey(name: 'schema_version') required this.schemaVersion, @JsonKey(name: 'source_version') required this.sourceVersion, @JsonKey(includeIfNull: true, name: 'source_updated_at') required this.sourceUpdatedAt, @JsonKey(name: 'source_urls') required  List<String> sourceUrls, required this.sha256}): _sourceUrls = sourceUrls;
  factory _ShindoDbStationsParameterMetadata.fromJson(Map<String, dynamic> json) => _$ShindoDbStationsParameterMetadataFromJson(json);
...
@pragma('vm:prefer-inline')
_$ShindoDbStationsParameterMetadataCopyWith<_ShindoDbStationsParameterMetadata> get copyWith => __$ShindoDbStationsParameterMetadataCopyWithImpl<_ShindoDbStationsParameterMetadata>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ShindoDbStationsParameterMetadataToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ShindoDbStationsParameterMetadata&&(identical(other.type, type) || other.type == type)&&(identical(other.schemaVersion, schemaVersion) || other.schemaVersion == schemaVersion)&&(identical(other.sourceVersion, sourceVersion) || other.sourceVersion == sourceVersion)&&(identical(other.sourceUpdatedAt, sourceUpdatedAt) || other.sourceUpdatedAt == sourceUpdatedAt)&&const DeepCollectionEquality().equals(other._sourceUrls, _sourceUrls)&&(identical(other.sha256, sha256) || other.sha256 == sha256));
}
...
/// @nodoc
abstract mixin class _$ShindoDbStationsParameterMetadataCopyWith<$Res> implements $ShindoDbStationsParameterMetadataCopyWith<$Res> {
  factory _$ShindoDbStationsParameterMetadataCopyWith(_ShindoDbStationsParameterMetadata value, $Res Function(_ShindoDbStationsParameterMetadata) _then) = __$ShindoDbStationsParameterMetadataCopyWithImpl;
@override @useResult
$Res call({
 String type,@JsonKey(name: 'schema_version') int schemaVersion,@JsonKey(name: 'source_version') String sourceVersion,@JsonKey(includeIfNull: true, name: 'source_updated_at') String? sourceUpdatedAt,@JsonKey(name: 'source_urls') List<String> sourceUrls, String sha256
});
...
/// @nodoc
class __$ShindoDbStationsParameterMetadataCopyWithImpl<$Res>
    implements _$ShindoDbStationsParameterMetadataCopyWith<$Res> {
  __$ShindoDbStationsParameterMetadataCopyWithImpl(this._self, this._then);

  final _ShindoDbStationsParameterMetadata _self;
  final $Res Function(_ShindoDbStationsParameterMetadata) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? type = null,Object? schemaVersion = null,Object? sourceVersion = null,Object? sourceUpdatedAt = freezed,Object? sourceUrls = null,Object? sha256 = null,}) {
  return _then(_ShindoDbStationsParameterMetadata(
type: null == type ? _self.type : type // ignore: cast_nullable_to_non_nullable
as String,schemaVersion: null == schemaVersion ? _self.schemaVersion : schemaVersion // ignore: cast_nullable_to_non_nullable
as int,sourceVersion: null == sourceVersion ? _self.sourceVersion : sourceVersion // ignore: cast_nullable_to_non_nullable
as String,sourceUpdatedAt: freezed == sourceUpdatedAt ? _self.sourceUpdatedAt : sourceUpdatedAt // ignore: cast_nullable_to_non_nullable
