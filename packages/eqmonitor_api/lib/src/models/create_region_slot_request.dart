...
part 'create_region_slot_request.freezed.dart';
part 'create_region_slot_request.g.dart';

@Freezed()
abstract class CreateRegionSlotRequest with _$CreateRegionSlotRequest {
  const factory CreateRegionSlotRequest({
  ...
  factory CreateRegionSlotRequest.fromJson(Map<String, Object?> json) => _$CreateRegionSlotRequestFromJson(json);
}
