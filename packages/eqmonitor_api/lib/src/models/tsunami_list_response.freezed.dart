...
class _TsunamiListResponse implements TsunamiListResponse {
  const _TsunamiListResponse({required final  List<TsunamiState> items, @JsonKey(includeIfNull: false, name: 'next_token') this.nextToken, @JsonKey(includeIfNull: false, name: 'next_pooling') this.nextPooling}): _items = items;
