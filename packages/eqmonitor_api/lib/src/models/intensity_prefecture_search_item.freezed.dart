...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is IntensityPrefectureSearchItem&&(identical(other.intensity, intensity) || other.intensity == intensity)&&(identical(other.earthquake, earthquake) || other.earthquake == earthquake));
}
...
@override
String toString() {
  return 'IntensityPrefectureSearchItem(intensity: $intensity, earthquake: $earthquake)';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? intensity = null,Object? earthquake = null,}) {
  return _then(IntensityPrefectureSearchItem(
...
class _IntensityPrefectureSearchItem implements IntensityPrefectureSearchItem {
  const _IntensityPrefectureSearchItem({required this.intensity, required this.earthquake});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _IntensityPrefectureSearchItem&&(identical(other.intensity, intensity) || other.intensity == intensity)&&(identical(other.earthquake, earthquake) || other.earthquake == earthquake));
}
