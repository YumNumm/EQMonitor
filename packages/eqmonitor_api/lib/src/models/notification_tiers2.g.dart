...
_NotificationTiers2 _$NotificationTiers2FromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      '_NotificationTiers2',
      json,
      ($checkedConvert) {
        final val = _NotificationTiers2(
...
Map<String, dynamic> _$NotificationTiers2ToJson(_NotificationTiers2 instance) =>
    <String, dynamic>{
...
const _$MinJmaIntensityEnumMap = {
  ...
  MinJmaIntensity.value6unknown: '!6-',
