...
_LpgmPrePeriod _$LpgmPrePeriodFromJson(Map<String, dynamic> json) =>
    $checkedCreate('_LpgmPrePeriod', json, ($checkedConvert) {
      final val = _LpgmPrePeriod(
...
Map<String, dynamic> _$LpgmPrePeriodToJson(_LpgmPrePeriod instance) =>
    <String, dynamic>{
      'band': instance.band,
