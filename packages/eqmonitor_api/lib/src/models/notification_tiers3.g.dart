...
_NotificationTiers3 _$NotificationTiers3FromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      '_NotificationTiers3',
      json,
      ($checkedConvert) {
        final val = _NotificationTiers3(
...
Map<String, dynamic> _$NotificationTiers3ToJson(_NotificationTiers3 instance) =>
    <String, dynamic>{
