...
part 'upsert_singleton_slot_request.freezed.dart';
part 'upsert_singleton_slot_request.g.dart';

@Freezed()
abstract class UpsertSingletonSlotRequest with _$UpsertSingletonSlotRequest {
  const factory UpsertSingletonSlotRequest({
  ...
  factory UpsertSingletonSlotRequest.fromJson(Map<String, Object?> json) => _$UpsertSingletonSlotRequestFromJson(json);
}
