...
/// Adds pattern-matching-related methods to [TelegramPartial].
extension TelegramPartialPatterns on TelegramPartial {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _TelegramPartial value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _TelegramPartial() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _TelegramPartial value)  $default,){
final _that = this;
switch (_that) {
case _TelegramPartial():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _TelegramPartial value)?  $default,){
final _that = this;
switch (_that) {
case _TelegramPartial() when $default != null:
return $default(_that);case _:
...
switch (_that) {
case _TelegramPartial() when $default != null:
return $default(_that.id,_that.eventId,_that.type,_that.title,_that.status,_that.infoType,_that.editorialOffice,_that.publishingOffice,_that.pressedAt,_that.reportedAt,_that.infoKind,_that.infoKindVersion,_that.hash,_that.createdAt,_that.serialNo,_that.targetedAt,_that.revokedAt,_that.headline);case _:
  return orElse();
...
class _TelegramPartial implements TelegramPartial {
  const _TelegramPartial({required this.id, @JsonKey(name: 'event_id') required this.eventId, required this.type, required this.title, required this.status, @JsonKey(name: 'info_type') required this.infoType, @JsonKey(name: 'editorial_office') required this.editorialOffice, @JsonKey(name: 'publishing_office') required  List<String> publishingOffice, @JsonKey(name: 'pressed_at') required this.pressedAt, @JsonKey(name: 'reported_at') required this.reportedAt, @JsonKey(name: 'info_kind') required this.infoKind, @JsonKey(name: 'info_kind_version') required this.infoKindVersion, required this.hash, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(includeIfNull: false, name: 'serial_no') this.serialNo, @JsonKey(includeIfNull: false, name: 'targeted_at') this.targetedAt, @JsonKey(includeIfNull: false, name: 'revoked_at') this.revokedAt, @JsonKey(includeIfNull: false) this.headline}): _publishingOffice = publishingOffice;
  factory _TelegramPartial.fromJson(Map<String, dynamic> json) => _$TelegramPartialFromJson(json);
...
@pragma('vm:prefer-inline')
_$TelegramPartialCopyWith<_TelegramPartial> get copyWith => __$TelegramPartialCopyWithImpl<_TelegramPartial>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$TelegramPartialToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TelegramPartial&&(identical(other.id, id) || other.id == id)&&(identical(other.eventId, eventId) || other.eventId == eventId)&&(identical(other.type, type) || other.type == type)&&(identical(other.title, title) || other.title == title)&&(identical(other.status, status) || other.status == status)&&(identical(other.infoType, infoType) || other.infoType == infoType)&&(identical(other.editorialOffice, editorialOffice) || other.editorialOffice == editorialOffice)&&const DeepCollectionEquality().equals(other._publishingOffice, _publishingOffice)&&(identical(other.pressedAt, pressedAt) || other.pressedAt == pressedAt)&&(identical(other.reportedAt, reportedAt) || other.reportedAt == reportedAt)&&(identical(other.infoKind, infoKind) || other.infoKind == infoKind)&&(identical(other.infoKindVersion, infoKindVersion) || other.infoKindVersion == infoKindVersion)&&(identical(other.hash, hash) || other.hash == hash)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.serialNo, serialNo) || other.serialNo == serialNo)&&(identical(other.targetedAt, targetedAt) || other.targetedAt == targetedAt)&&(identical(other.revokedAt, revokedAt) || other.revokedAt == revokedAt)&&(identical(other.headline, headline) || other.headline == headline));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,eventId,type,title,status,infoType,editorialOffice,const DeepCollectionEquality().hash(_publishingOffice),pressedAt,reportedAt,infoKind,infoKindVersion,hash,createdAt,serialNo,targetedAt,revokedAt,headline);
...
/// @nodoc
abstract mixin class _$TelegramPartialCopyWith<$Res> implements $TelegramPartialCopyWith<$Res> {
  factory _$TelegramPartialCopyWith(_TelegramPartial value, $Res Function(_TelegramPartial) _then) = __$TelegramPartialCopyWithImpl;
@override @useResult
$Res call({
 String id,@JsonKey(name: 'event_id') String eventId, TelegramType type, String title, TelegramStatus status,@JsonKey(name: 'info_type') InfoType infoType,@JsonKey(name: 'editorial_office') String editorialOffice,@JsonKey(name: 'publishing_office') List<String> publishingOffice,@JsonKey(name: 'pressed_at') DateTime pressedAt,@JsonKey(name: 'reported_at') DateTime reportedAt,@JsonKey(name: 'info_kind') String infoKind,@JsonKey(name: 'info_kind_version') String infoKindVersion, String hash,@JsonKey(name: 'created_at') DateTime createdAt,@JsonKey(includeIfNull: false, name: 'serial_no') num? serialNo,@JsonKey(includeIfNull: false, name: 'targeted_at') DateTime? targetedAt,@JsonKey(includeIfNull: false, name: 'revoked_at') DateTime? revokedAt,@JsonKey(includeIfNull: false) String? headline
});
...
/// @nodoc
class __$TelegramPartialCopyWithImpl<$Res>
    implements _$TelegramPartialCopyWith<$Res> {
  __$TelegramPartialCopyWithImpl(this._self, this._then);

  final _TelegramPartial _self;
  final $Res Function(_TelegramPartial) _then;
