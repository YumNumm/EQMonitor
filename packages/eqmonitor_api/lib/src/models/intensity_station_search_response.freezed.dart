...
@pragma('vm:prefer-inline') @override $Res call({Object? items = null,Object? nextToken = freezed,Object? nextPooling = freezed,}) {
  return _then(IntensityStationSearchResponse(
...
class _IntensityStationSearchResponse implements IntensityStationSearchResponse {
  const _IntensityStationSearchResponse({required  List<IntensityStationSearchItem> items, @JsonKey(includeIfNull: false, name: 'next_token') this.nextToken, @JsonKey(includeIfNull: false, name: 'next_pooling') this.nextPooling}): _items = items;
