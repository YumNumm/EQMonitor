...
TelegramBodyUnionEewTelegramBody _$TelegramBodyUnionEewTelegramBodyFromJson(
  ...
  ($checkedConvert) {
    final val = TelegramBodyUnionEewTelegramBody(
      ...
      eewIntensityRegions: $checkedConvert('eewIntensityRegions', (v) => v),
      eewWarningZones: $checkedConvert('eewWarningZones', (v) => v),
      eewWarningPrefectures: $checkedConvert('eewWarningPrefectures', (v) => v),
      eewWarningRegions: $checkedConvert('eewWarningRegions', (v) => v),
      $type: $checkedConvert('runtimeType', (v) => v as String?),
    );
    return val;
  },
