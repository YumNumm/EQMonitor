...
/// const: "geojson"
 String get type; SeismicityLayerSpan get span; String get url;@JsonKey(name: 'generated_at') String get generatedAt; int get count;
...
@useResult
$Res call({
 String type, SeismicityLayerSpan span, String url,@JsonKey(name: 'generated_at') String generatedAt, int count
});
...
as SeismicityLayerSpan,url: null == url ? _self.url : url // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String type,  SeismicityLayerSpan span,  String url, @JsonKey(name: 'generated_at')  String generatedAt,  int count)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SeismicityManifestLayer() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String type,  SeismicityLayerSpan span,  String url, @JsonKey(name: 'generated_at')  String generatedAt,  int count)  $default,) {final _that = this;
switch (_that) {
case _SeismicityManifestLayer():
return $default(_that.type,_that.span,_that.url,_that.generatedAt,_that.count);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String type,  SeismicityLayerSpan span,  String url, @JsonKey(name: 'generated_at')  String generatedAt,  int count)?  $default,) {final _that = this;
switch (_that) {
case _SeismicityManifestLayer() when $default != null:
return $default(_that.type,_that.span,_that.url,_that.generatedAt,_that.count);case _:
  return null;
...
@override final  SeismicityLayerSpan span;
