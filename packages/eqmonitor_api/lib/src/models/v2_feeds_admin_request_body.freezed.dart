...
@pragma('vm:prefer-inline') @override $Res call({Object? feedType = null,Object? priority = null,Object? isImportant = null,Object? publishedAt = null,Object? data = null,Object? translations = null,Object? expiresAt = freezed,}) {
  return _then(V2FeedsAdminRequestBody(
...
class _V2FeedsAdminRequestBody implements V2FeedsAdminRequestBody {
  const _V2FeedsAdminRequestBody({required this.feedType, required this.priority, required this.isImportant, required this.publishedAt, required this.data, required  List<Translations> translations, @JsonKey(includeIfNull: false) this.expiresAt}): _translations = translations;
