...
mixin _$V2FeedsAdminRequestBody {
 ...
 String get feedType; String get priority; bool get isImportant; String get publishedAt; Data get data; List<Translations> get translations;@JsonKey(includeIfNull: false) String? get expiresAt;
...
@useResult
$Res call({
 String feedType, String priority, bool isImportant, String publishedAt, Data data, List<Translations> translations,@JsonKey(includeIfNull: false) String? expiresAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String feedType,  String priority,  bool isImportant,  String publishedAt,  Data data,  List<Translations> translations, @JsonKey(includeIfNull: false)  String? expiresAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _V2FeedsAdminRequestBody() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String feedType,  String priority,  bool isImportant,  String publishedAt,  Data data,  List<Translations> translations, @JsonKey(includeIfNull: false)  String? expiresAt)  $default,) {final _that = this;
switch (_that) {
case _V2FeedsAdminRequestBody():
return $default(_that.feedType,_that.priority,_that.isImportant,_that.publishedAt,_that.data,_that.translations,_that.expiresAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String feedType,  String priority,  bool isImportant,  String publishedAt,  Data data,  List<Translations> translations, @JsonKey(includeIfNull: false)  String? expiresAt)?  $default,) {final _that = this;
switch (_that) {
case _V2FeedsAdminRequestBody() when $default != null:
return $default(_that.feedType,_that.priority,_that.isImportant,_that.publishedAt,_that.data,_that.translations,_that.expiresAt);case _:
  return null;
