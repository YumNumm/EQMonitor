...
/// @nodoc
abstract mixin class $CreateRegionSlotRequestCopyWith<$Res>  {
...
/// @nodoc
class _$CreateRegionSlotRequestCopyWithImpl<$Res>
    implements $CreateRegionSlotRequestCopyWith<$Res> {
  _$CreateRegionSlotRequestCopyWithImpl(this._self, this._then);

  final CreateRegionSlotRequest _self;
  final $Res Function(CreateRegionSlotRequest) _then;
...
/// Adds pattern-matching-related methods to [CreateRegionSlotRequest].
extension CreateRegionSlotRequestPatterns on CreateRegionSlotRequest {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _CreateRegionSlotRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _CreateRegionSlotRequest value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _CreateRegionSlotRequest value)?  $default,){
final _that = this;
switch (_that) {
case _CreateRegionSlotRequest() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$CreateRegionSlotRequestCopyWith<_CreateRegionSlotRequest> get copyWith => __$CreateRegionSlotRequestCopyWithImpl<_CreateRegionSlotRequest>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$CreateRegionSlotRequestToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CreateRegionSlotRequest&&(identical(other.regionId, regionId) || other.regionId == regionId)&&(identical(other.regionName, regionName) || other.regionName == regionName)&&(identical(other.cityCode, cityCode) || other.cityCode == cityCode)&&(identical(other.cityName, cityName) || other.cityName == cityName)&&(identical(other.eewEnabled, eewEnabled) || other.eewEnabled == eewEnabled)&&(identical(other.eewMinIntensity, eewMinIntensity) || other.eewMinIntensity == eewMinIntensity)&&const DeepCollectionEquality().equals(other._eewOverrides, _eewOverrides)&&(identical(other.earthquakeEnabled, earthquakeEnabled) || other.earthquakeEnabled == earthquakeEnabled)&&(identical(other.earthquakeMinIntensity, earthquakeMinIntensity) || other.earthquakeMinIntensity == earthquakeMinIntensity)&&const DeepCollectionEquality().equals(other._earthquakeOverrides, _earthquakeOverrides));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,regionId,regionName,cityCode,cityName,eewEnabled,eewMinIntensity,const DeepCollectionEquality().hash(_eewOverrides),earthquakeEnabled,earthquakeMinIntensity,const DeepCollectionEquality().hash(_earthquakeOverrides));
...
/// @nodoc
abstract mixin class _$CreateRegionSlotRequestCopyWith<$Res> implements $CreateRegionSlotRequestCopyWith<$Res> {
...
/// @nodoc
class __$CreateRegionSlotRequestCopyWithImpl<$Res>
    implements _$CreateRegionSlotRequestCopyWith<$Res> {
  __$CreateRegionSlotRequestCopyWithImpl(this._self, this._then);

  final _CreateRegionSlotRequest _self;
  final $Res Function(_CreateRegionSlotRequest) _then;
