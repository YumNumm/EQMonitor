...
mixin _$LocalizedName {
 ...
 String get ja;@JsonKey(includeIfNull: false) String? get en;@JsonKey(includeIfNull: false, name: 'zh_hans') String? get zhHans;@JsonKey(includeIfNull: false, name: 'zh_hant') String? get zhHant;@JsonKey(includeIfNull: false) String? get ko;@JsonKey(includeIfNull: false) String? get es;@JsonKey(includeIfNull: false) String? get pt;@JsonKey(includeIfNull: false) String? get id;@JsonKey(includeIfNull: false) String? get vi;@JsonKey(includeIfNull: false) String? get tl;@JsonKey(includeIfNull: false) String? get th;@JsonKey(includeIfNull: false) String? get ne;@JsonKey(includeIfNull: false) String? get km;@JsonKey(includeIfNull: false) String? get my;@JsonKey(includeIfNull: false) String? get mn;
...
@useResult
$Res call({
 String ja,@JsonKey(includeIfNull: false) String? en,@JsonKey(includeIfNull: false, name: 'zh_hans') String? zhHans,@JsonKey(includeIfNull: false, name: 'zh_hant') String? zhHant,@JsonKey(includeIfNull: false) String? ko,@JsonKey(includeIfNull: false) String? es,@JsonKey(includeIfNull: false) String? pt,@JsonKey(includeIfNull: false) String? id,@JsonKey(includeIfNull: false) String? vi,@JsonKey(includeIfNull: false) String? tl,@JsonKey(includeIfNull: false) String? th,@JsonKey(includeIfNull: false) String? ne,@JsonKey(includeIfNull: false) String? km,@JsonKey(includeIfNull: false) String? my,@JsonKey(includeIfNull: false) String? mn
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String ja, @JsonKey(includeIfNull: false)  String? en, @JsonKey(includeIfNull: false, name: 'zh_hans')  String? zhHans, @JsonKey(includeIfNull: false, name: 'zh_hant')  String? zhHant, @JsonKey(includeIfNull: false)  String? ko, @JsonKey(includeIfNull: false)  String? es, @JsonKey(includeIfNull: false)  String? pt, @JsonKey(includeIfNull: false)  String? id, @JsonKey(includeIfNull: false)  String? vi, @JsonKey(includeIfNull: false)  String? tl, @JsonKey(includeIfNull: false)  String? th, @JsonKey(includeIfNull: false)  String? ne, @JsonKey(includeIfNull: false)  String? km, @JsonKey(includeIfNull: false)  String? my, @JsonKey(includeIfNull: false)  String? mn)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LocalizedName() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String ja, @JsonKey(includeIfNull: false)  String? en, @JsonKey(includeIfNull: false, name: 'zh_hans')  String? zhHans, @JsonKey(includeIfNull: false, name: 'zh_hant')  String? zhHant, @JsonKey(includeIfNull: false)  String? ko, @JsonKey(includeIfNull: false)  String? es, @JsonKey(includeIfNull: false)  String? pt, @JsonKey(includeIfNull: false)  String? id, @JsonKey(includeIfNull: false)  String? vi, @JsonKey(includeIfNull: false)  String? tl, @JsonKey(includeIfNull: false)  String? th, @JsonKey(includeIfNull: false)  String? ne, @JsonKey(includeIfNull: false)  String? km, @JsonKey(includeIfNull: false)  String? my, @JsonKey(includeIfNull: false)  String? mn)  $default,) {final _that = this;
switch (_that) {
case _LocalizedName():
return $default(_that.ja,_that.en,_that.zhHans,_that.zhHant,_that.ko,_that.es,_that.pt,_that.id,_that.vi,_that.tl,_that.th,_that.ne,_that.km,_that.my,_that.mn);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String ja, @JsonKey(includeIfNull: false)  String? en, @JsonKey(includeIfNull: false, name: 'zh_hans')  String? zhHans, @JsonKey(includeIfNull: false, name: 'zh_hant')  String? zhHant, @JsonKey(includeIfNull: false)  String? ko, @JsonKey(includeIfNull: false)  String? es, @JsonKey(includeIfNull: false)  String? pt, @JsonKey(includeIfNull: false)  String? id, @JsonKey(includeIfNull: false)  String? vi, @JsonKey(includeIfNull: false)  String? tl, @JsonKey(includeIfNull: false)  String? th, @JsonKey(includeIfNull: false)  String? ne, @JsonKey(includeIfNull: false)  String? km, @JsonKey(includeIfNull: false)  String? my, @JsonKey(includeIfNull: false)  String? mn)?  $default,) {final _that = this;
switch (_that) {
case _LocalizedName() when $default != null:
return $default(_that.ja,_that.en,_that.zhHans,_that.zhHant,_that.ko,_that.es,_that.pt,_that.id,_that.vi,_that.tl,_that.th,_that.ne,_that.km,_that.my,_that.mn);case _:
  return null;
...
class _LocalizedName implements LocalizedName {
  const _LocalizedName({required this.ja, @JsonKey(includeIfNull: false) this.en, @JsonKey(includeIfNull: false, name: 'zh_hans') this.zhHans, @JsonKey(includeIfNull: false, name: 'zh_hant') this.zhHant, @JsonKey(includeIfNull: false) this.ko, @JsonKey(includeIfNull: false) this.es, @JsonKey(includeIfNull: false) this.pt, @JsonKey(includeIfNull: false) this.id, @JsonKey(includeIfNull: false) this.vi, @JsonKey(includeIfNull: false) this.tl, @JsonKey(includeIfNull: false) this.th, @JsonKey(includeIfNull: false) this.ne, @JsonKey(includeIfNull: false) this.km, @JsonKey(includeIfNull: false) this.my, @JsonKey(includeIfNull: false) this.mn});
...
@override@JsonKey(includeIfNull: false, name: 'zh_hans') final  String? zhHans;
@override@JsonKey(includeIfNull: false, name: 'zh_hant') final  String? zhHant;
@override@JsonKey(includeIfNull: false) final  String? ko;
@override@JsonKey(includeIfNull: false) final  String? es;
@override@JsonKey(includeIfNull: false) final  String? pt;
@override@JsonKey(includeIfNull: false) final  String? id;
@override@JsonKey(includeIfNull: false) final  String? vi;
@override@JsonKey(includeIfNull: false) final  String? tl;
@override@JsonKey(includeIfNull: false) final  String? th;
@override@JsonKey(includeIfNull: false) final  String? ne;
@override@JsonKey(includeIfNull: false) final  String? km;
@override@JsonKey(includeIfNull: false) final  String? my;
@override@JsonKey(includeIfNull: false) final  String? mn;
