...
class TelegramBodyUnionEewTelegramBody implements TelegramBodyUnion {
  const TelegramBodyUnionEewTelegramBody({required this.type, required this.eew, @JsonKey(includeIfNull: false) this.eewIntensityRegions, @JsonKey(includeIfNull: false) this.eewWarningZones, @JsonKey(includeIfNull: false) this.eewWarningPrefectures, @JsonKey(includeIfNull: false) this.eewWarningRegions, final  String? $type}): $type = $type ?? 'eewTelegramBody';
...
@override final  dynamic type;
 final  dynamic eew;
@JsonKey(includeIfNull: false) final  dynamic eewIntensityRegions;
@JsonKey(includeIfNull: false) final  dynamic eewWarningZones;
@JsonKey(includeIfNull: false) final  dynamic eewWarningPrefectures;
@JsonKey(includeIfNull: false) final  dynamic eewWarningRegions;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TelegramBodyUnionEewTelegramBody&&const DeepCollectionEquality().equals(other.type, type)&&const DeepCollectionEquality().equals(other.eew, eew)&&const DeepCollectionEquality().equals(other.eewIntensityRegions, eewIntensityRegions)&&const DeepCollectionEquality().equals(other.eewWarningZones, eewWarningZones)&&const DeepCollectionEquality().equals(other.eewWarningPrefectures, eewWarningPrefectures)&&const DeepCollectionEquality().equals(other.eewWarningRegions, eewWarningRegions));
}
