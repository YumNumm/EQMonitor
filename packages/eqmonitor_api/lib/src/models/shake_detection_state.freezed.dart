...
class _ShakeDetectionState implements ShakeDetectionState {
  const _ShakeDetectionState({required this.type, required this.eventId, required this.serialNo, required this.createdAt, required this.updatedAt, required this.expiresAt, required this.level, required final  List<ChangeReasons> changeReasons, required final  List<MergedEvents> mergedEvents, required this.pointCount, required this.region, required final  List<Points> points, @JsonKey(includeIfNull: false) this.test, @JsonKey(includeIfNull: false) this.correlatedEew}): _changeReasons = changeReasons,_mergedEvents = mergedEvents,_points = points;
