...
_Events3 _$Events3FromJson(
  Map<String, dynamic> json,
) => $checkedCreate('_Events3', json, ($checkedConvert) {
  final val = _Events3(
    ...
    mergedEvents: $checkedConvert(
      'mergedEvents',
      (v) => (v as List<dynamic>)
          .map((e) => MergedEvents3.fromJson(e as Map<String, dynamic>))
          .toList(),
    ),
    pointCount: $checkedConvert('pointCount', (v) => (v as num).toInt()),
    region: $checkedConvert(
      'region',
      (v) => Region3.fromJson(v as Map<String, dynamic>),
    ),
    ...
    test: $checkedConvert(
      'test',
      (v) => v == null ? null : Test3.fromJson(v as Map<String, dynamic>),
    ),
    correlatedEew: $checkedConvert(
      'correlatedEew',
      (v) =>
          v == null ? null : CorrelatedEew3.fromJson(v as Map<String, dynamic>),
    ),
  );
  return val;
});

Map<String, dynamic> _$Events3ToJson(_Events3 instance) => <String, dynamic>{
  'type': instance.type,
