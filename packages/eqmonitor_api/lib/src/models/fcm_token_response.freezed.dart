...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FcmTokenResponse&&(identical(other.token, token) || other.token == token));
}
...
@override
String toString() {
  return 'FcmTokenResponse(token: $token)';
}
...
class _FcmTokenResponse implements FcmTokenResponse {
  const _FcmTokenResponse({required this.token});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FcmTokenResponse&&(identical(other.token, token) || other.token == token));
}
