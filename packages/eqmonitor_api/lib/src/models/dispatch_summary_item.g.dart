...
_DispatchSummaryItem _$DispatchSummaryItemFromJson(
  Map<String, dynamic> json,
) => $checkedCreate('_DispatchSummaryItem', json, ($checkedConvert) {
  final val = _DispatchSummaryItem(
...
Map<String, dynamic> _$DispatchSummaryItemToJson(
  _DispatchSummaryItem instance,
) => <String, dynamic>{
