...
$CityMaxIntensityResponseCopyWith<CityMaxIntensityResponse> get copyWith => _$CityMaxIntensityResponseCopyWithImpl<CityMaxIntensityResponse>(this as CityMaxIntensityResponse, _$identity);

  /// Serializes this CityMaxIntensityResponse to a JSON map.
...
/// @nodoc
abstract mixin class $CityMaxIntensityResponseCopyWith<$Res>  {
...
/// @nodoc
class _$CityMaxIntensityResponseCopyWithImpl<$Res>
    implements $CityMaxIntensityResponseCopyWith<$Res> {
  _$CityMaxIntensityResponseCopyWithImpl(this._self, this._then);

  final CityMaxIntensityResponse _self;
  final $Res Function(CityMaxIntensityResponse) _then;
...
/// Adds pattern-matching-related methods to [CityMaxIntensityResponse].
extension CityMaxIntensityResponsePatterns on CityMaxIntensityResponse {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _CityMaxIntensityResponse value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _CityMaxIntensityResponse value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _CityMaxIntensityResponse value)?  $default,){
final _that = this;
switch (_that) {
case _CityMaxIntensityResponse() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$CityMaxIntensityResponseCopyWith<_CityMaxIntensityResponse> get copyWith => __$CityMaxIntensityResponseCopyWithImpl<_CityMaxIntensityResponse>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$CityMaxIntensityResponseToJson(this, );
}
...
/// @nodoc
abstract mixin class _$CityMaxIntensityResponseCopyWith<$Res> implements $CityMaxIntensityResponseCopyWith<$Res> {
...
/// @nodoc
class __$CityMaxIntensityResponseCopyWithImpl<$Res>
    implements _$CityMaxIntensityResponseCopyWith<$Res> {
  __$CityMaxIntensityResponseCopyWithImpl(this._self, this._then);

  final _CityMaxIntensityResponse _self;
  final $Res Function(_CityMaxIntensityResponse) _then;
