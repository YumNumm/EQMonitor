...
@Freezed()
abstract class TsunamiStationObservationFirstHeight
    with _$TsunamiStationObservationFirstHeight {
  const factory TsunamiStationObservationFirstHeight({
    /// 欠測時、識別不能時は出現しない
    @JsonKey(includeIfNull: false, name: 'arrival_time') DateTime? arrivalTime,
    @JsonKey(includeIfNull: false) WaveInitial? initial,
  ...
  factory TsunamiStationObservationFirstHeight.fromJson(
    Map<String, Object?> json,
  ) => _$TsunamiStationObservationFirstHeightFromJson(json);
}
