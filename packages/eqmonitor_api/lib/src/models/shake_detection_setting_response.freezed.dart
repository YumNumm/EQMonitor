...
mixin _$ShakeDetectionSettingResponse {
 ...
 String get id;@JsonKey(includeIfNull: true, name: 'sub_region_id') String? get subRegionId;@JsonKey(name: 'min_level') ShakeDetectionLevel get minLevel;@JsonKey(name: 'is_current_location') bool get isCurrentLocation;@JsonKey(name: 'created_at') String get createdAt;@JsonKey(name: 'updated_at') String get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,subRegionId,minLevel,isCurrentLocation,createdAt,updatedAt);

@override
String toString() {
  return 'ShakeDetectionSettingResponse(id: $id, subRegionId: $subRegionId, minLevel: $minLevel, isCurrentLocation: $isCurrentLocation, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id,@JsonKey(includeIfNull: true, name: 'sub_region_id') String? subRegionId,@JsonKey(name: 'min_level') ShakeDetectionLevel minLevel,@JsonKey(name: 'is_current_location') bool isCurrentLocation,@JsonKey(name: 'created_at') String createdAt,@JsonKey(name: 'updated_at') String updatedAt
});
...
/// Create a copy of ShakeDetectionSettingResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? subRegionId = freezed,Object? minLevel = null,Object? isCurrentLocation = null,Object? createdAt = null,Object? updatedAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(includeIfNull: true, name: 'sub_region_id')  String? subRegionId, @JsonKey(name: 'min_level')  ShakeDetectionLevel minLevel, @JsonKey(name: 'is_current_location')  bool isCurrentLocation, @JsonKey(name: 'created_at')  String createdAt, @JsonKey(name: 'updated_at')  String updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ShakeDetectionSettingResponse() when $default != null:
return $default(_that.id,_that.subRegionId,_that.minLevel,_that.isCurrentLocation,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(includeIfNull: true, name: 'sub_region_id')  String? subRegionId, @JsonKey(name: 'min_level')  ShakeDetectionLevel minLevel, @JsonKey(name: 'is_current_location')  bool isCurrentLocation, @JsonKey(name: 'created_at')  String createdAt, @JsonKey(name: 'updated_at')  String updatedAt)  $default,) {final _that = this;
switch (_that) {
case _ShakeDetectionSettingResponse():
return $default(_that.id,_that.subRegionId,_that.minLevel,_that.isCurrentLocation,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(includeIfNull: true, name: 'sub_region_id')  String? subRegionId, @JsonKey(name: 'min_level')  ShakeDetectionLevel minLevel, @JsonKey(name: 'is_current_location')  bool isCurrentLocation, @JsonKey(name: 'created_at')  String createdAt, @JsonKey(name: 'updated_at')  String updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _ShakeDetectionSettingResponse() when $default != null:
return $default(_that.id,_that.subRegionId,_that.minLevel,_that.isCurrentLocation,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _ShakeDetectionSettingResponse implements ShakeDetectionSettingResponse {
  const _ShakeDetectionSettingResponse({required this.id, @JsonKey(includeIfNull: true, name: 'sub_region_id') required this.subRegionId, @JsonKey(name: 'min_level') required this.minLevel, @JsonKey(name: 'is_current_location') required this.isCurrentLocation, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'updated_at') required this.updatedAt});
...
/// Create a copy of ShakeDetectionSettingResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? subRegionId = freezed,Object? minLevel = null,Object? isCurrentLocation = null,Object? createdAt = null,Object? updatedAt = null,}) {
