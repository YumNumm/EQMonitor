...
) => $checkedCreate('FeedItemDataUnionFeedEarthquakeNoticeData', json, (
  $checkedConvert,
) {
...
_$FeedItemDataUnionFeedEarthquakeExplanationDataFromJson(
  Map<String, dynamic> json,
) => $checkedCreate('FeedItemDataUnionFeedEarthquakeExplanationData', json, (
  $checkedConvert,
) {
...
_$FeedItemDataUnionFeedEarthquakeCountsDataFromJson(
  Map<String, dynamic> json,
) => $checkedCreate('FeedItemDataUnionFeedEarthquakeCountsData', json, (
  $checkedConvert,
) {
...
_$FeedItemDataUnionFeedEarthquakeNankaiDataFromJson(
  Map<String, dynamic> json,
) => $checkedCreate('FeedItemDataUnionFeedEarthquakeNankaiData', json, (
  $checkedConvert,
) {
...
FeedItemDataUnionFeedAppUpdateData _$FeedItemDataUnionFeedAppUpdateDataFromJson(
  Map<String, dynamic> json,
) => $checkedCreate('FeedItemDataUnionFeedAppUpdateData', json, (
  $checkedConvert,
) {
...
FeedItemDataUnionFeedIncidentData _$FeedItemDataUnionFeedIncidentDataFromJson(
  Map<String, dynamic> json,
) => $checkedCreate('FeedItemDataUnionFeedIncidentData', json, (
  $checkedConvert,
) {
...
_$FeedItemDataUnionFeedDeveloperMessageDataFromJson(
  Map<String, dynamic> json,
) => $checkedCreate('FeedItemDataUnionFeedDeveloperMessageData', json, (
  $checkedConvert,
) {
