...
part 'shindo_db_stations_parameter_metadata.freezed.dart';
part 'shindo_db_stations_parameter_metadata.g.dart';

@Freezed()
abstract class ShindoDbStationsParameterMetadata with _$ShindoDbStationsParameterMetadata {
  const factory ShindoDbStationsParameterMetadata({
