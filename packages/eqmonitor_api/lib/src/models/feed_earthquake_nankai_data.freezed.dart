...
/// const: "EARTHQUAKE_NANKAI"
 ...
 InfoType get infoType;/// const: "南海トラフ地震臨時情報" | const: "南海トラフ地震関連解説情報" | const: "北海道・三陸沖後発地震注意情報"
 TelegramType get telegramType;@JsonKey(includeIfNull: false) FeedNankaiEarthquakeInfo? get earthquakeInfo;@JsonKey(includeIfNull: false) String? get nextAdvisory;@JsonKey(includeIfNull: false) String? get text;
...
@override
String toString() {
  return 'FeedEarthquakeNankaiData(type: $type, infoType: $infoType, telegramType: $telegramType, earthquakeInfo: $earthquakeInfo, nextAdvisory: $nextAdvisory, text: $text)';
}
...
@useResult
$Res call({
 String type, InfoType infoType, TelegramType telegramType,@JsonKey(includeIfNull: false) FeedNankaiEarthquakeInfo? earthquakeInfo,@JsonKey(includeIfNull: false) String? nextAdvisory,@JsonKey(includeIfNull: false) String? text
});
...
/// Create a copy of FeedEarthquakeNankaiData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? type = null,Object? infoType = null,Object? telegramType = null,Object? earthquakeInfo = freezed,Object? nextAdvisory = freezed,Object? text = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String type,  InfoType infoType,  TelegramType telegramType, @JsonKey(includeIfNull: false)  FeedNankaiEarthquakeInfo? earthquakeInfo, @JsonKey(includeIfNull: false)  String? nextAdvisory, @JsonKey(includeIfNull: false)  String? text)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FeedEarthquakeNankaiData() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String type,  InfoType infoType,  TelegramType telegramType, @JsonKey(includeIfNull: false)  FeedNankaiEarthquakeInfo? earthquakeInfo, @JsonKey(includeIfNull: false)  String? nextAdvisory, @JsonKey(includeIfNull: false)  String? text)  $default,) {final _that = this;
switch (_that) {
case _FeedEarthquakeNankaiData():
return $default(_that.type,_that.infoType,_that.telegramType,_that.earthquakeInfo,_that.nextAdvisory,_that.text);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String type,  InfoType infoType,  TelegramType telegramType, @JsonKey(includeIfNull: false)  FeedNankaiEarthquakeInfo? earthquakeInfo, @JsonKey(includeIfNull: false)  String? nextAdvisory, @JsonKey(includeIfNull: false)  String? text)?  $default,) {final _that = this;
switch (_that) {
case _FeedEarthquakeNankaiData() when $default != null:
return $default(_that.type,_that.infoType,_that.telegramType,_that.earthquakeInfo,_that.nextAdvisory,_that.text);case _:
  return null;
...
class _FeedEarthquakeNankaiData implements FeedEarthquakeNankaiData {
  const _FeedEarthquakeNankaiData({required this.type, required this.infoType, required this.telegramType, @JsonKey(includeIfNull: false) this.earthquakeInfo, @JsonKey(includeIfNull: false) this.nextAdvisory, @JsonKey(includeIfNull: false) this.text});
...
@override final  TelegramType telegramType;
