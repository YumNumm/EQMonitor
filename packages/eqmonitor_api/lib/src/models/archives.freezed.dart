...
mixin _$Archives {
 ...
 Partition get partition; HypocenterCoverage get period; String get url;@JsonKey(name: 'feature_count') int get featureCount;@JsonKey(name: 'size_bytes') int get sizeBytes;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,partition,period,url,featureCount,sizeBytes);

@override
String toString() {
  return 'Archives(partition: $partition, period: $period, url: $url, featureCount: $featureCount, sizeBytes: $sizeBytes)';
}
...
@useResult
$Res call({
 Partition partition, HypocenterCoverage period, String url,@JsonKey(name: 'feature_count') int featureCount,@JsonKey(name: 'size_bytes') int sizeBytes
});
...
/// Create a copy of Archives
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? partition = null,Object? period = null,Object? url = null,Object? featureCount = null,Object? sizeBytes = null,}) {
...
as HypocenterCoverage,url: null == url ? _self.url : url // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Partition partition,  HypocenterCoverage period,  String url, @JsonKey(name: 'feature_count')  int featureCount, @JsonKey(name: 'size_bytes')  int sizeBytes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Archives() when $default != null:
return $default(_that.partition,_that.period,_that.url,_that.featureCount,_that.sizeBytes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Partition partition,  HypocenterCoverage period,  String url, @JsonKey(name: 'feature_count')  int featureCount, @JsonKey(name: 'size_bytes')  int sizeBytes)  $default,) {final _that = this;
switch (_that) {
case _Archives():
return $default(_that.partition,_that.period,_that.url,_that.featureCount,_that.sizeBytes);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Partition partition,  HypocenterCoverage period,  String url, @JsonKey(name: 'feature_count')  int featureCount, @JsonKey(name: 'size_bytes')  int sizeBytes)?  $default,) {final _that = this;
switch (_that) {
case _Archives() when $default != null:
return $default(_that.partition,_that.period,_that.url,_that.featureCount,_that.sizeBytes);case _:
  return null;
...
class _Archives implements Archives {
  const _Archives({required this.partition, required this.period, required this.url, @JsonKey(name: 'feature_count') required this.featureCount, @JsonKey(name: 'size_bytes') required this.sizeBytes});
...
/// Create a copy of Archives
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? partition = null,Object? period = null,Object? url = null,Object? featureCount = null,Object? sizeBytes = null,}) {
