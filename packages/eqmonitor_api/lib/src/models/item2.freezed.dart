...
/// @nodoc
abstract mixin class $Item2CopyWith<$Res>  {
  factory $Item2CopyWith(Item2 value, $Res Function(Item2) _then) = _$Item2CopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$Item2CopyWithImpl<$Res>
    implements $Item2CopyWith<$Res> {
  _$Item2CopyWithImpl(this._self, this._then);

  final Item2 _self;
  final $Res Function(Item2) _then;
...
/// Adds pattern-matching-related methods to [Item2].
extension Item2Patterns on Item2 {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Item2 value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _Item2() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Item2 value)  $default,){
final _that = this;
switch (_that) {
case _Item2():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Item2 value)?  $default,){
final _that = this;
switch (_that) {
case _Item2() when $default != null:
return $default(_that);case _:
...
class _Item2 implements Item2 {
  const _Item2({required this.correlationKey, required this.eventType, required this.eventId, required this.serialNo, required this.jmaReportTime, required this.targetDevices, required this.enqueuedFcm, required this.enqueuedApns, required this.enqueuedBroadcast, required this.successFcm, required this.failedFcm, required this.successApns, required this.failedApns, required this.createdAt, required this.updatedAt, @JsonKey(includeIfNull: false) this.headline, @JsonKey(includeIfNull: false) this.resolverDelayMs});
...
@pragma('vm:prefer-inline')
_$Item2CopyWith<_Item2> get copyWith => __$Item2CopyWithImpl<_Item2>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$Item2ToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Item2&&(identical(other.correlationKey, correlationKey) || other.correlationKey == correlationKey)&&(identical(other.eventType, eventType) || other.eventType == eventType)&&(identical(other.eventId, eventId) || other.eventId == eventId)&&(identical(other.serialNo, serialNo) || other.serialNo == serialNo)&&(identical(other.jmaReportTime, jmaReportTime) || other.jmaReportTime == jmaReportTime)&&(identical(other.targetDevices, targetDevices) || other.targetDevices == targetDevices)&&(identical(other.enqueuedFcm, enqueuedFcm) || other.enqueuedFcm == enqueuedFcm)&&(identical(other.enqueuedApns, enqueuedApns) || other.enqueuedApns == enqueuedApns)&&(identical(other.enqueuedBroadcast, enqueuedBroadcast) || other.enqueuedBroadcast == enqueuedBroadcast)&&(identical(other.successFcm, successFcm) || other.successFcm == successFcm)&&(identical(other.failedFcm, failedFcm) || other.failedFcm == failedFcm)&&(identical(other.successApns, successApns) || other.successApns == successApns)&&(identical(other.failedApns, failedApns) || other.failedApns == failedApns)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.headline, headline) || other.headline == headline)&&(identical(other.resolverDelayMs, resolverDelayMs) || other.resolverDelayMs == resolverDelayMs));
}
...
/// @nodoc
abstract mixin class _$Item2CopyWith<$Res> implements $Item2CopyWith<$Res> {
  factory _$Item2CopyWith(_Item2 value, $Res Function(_Item2) _then) = __$Item2CopyWithImpl;
@override @useResult
$Res call({
 String correlationKey, String eventType, String eventId, num serialNo, String jmaReportTime, num targetDevices, num enqueuedFcm, num enqueuedApns, num enqueuedBroadcast, num successFcm, num failedFcm, num successApns, num failedApns, String createdAt, String updatedAt,@JsonKey(includeIfNull: false) String? headline,@JsonKey(includeIfNull: false) num? resolverDelayMs
});
...
/// @nodoc
class __$Item2CopyWithImpl<$Res>
    implements _$Item2CopyWith<$Res> {
  __$Item2CopyWithImpl(this._self, this._then);

  final _Item2 _self;
  final $Res Function(_Item2) _then;
