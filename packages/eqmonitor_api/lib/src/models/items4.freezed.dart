...
@override
String toString() {
  return 'Items4(id: $id, eventId: $eventId, type: $type, title: $title, status: $status, infoType: $infoType, editorialOffice: $editorialOffice, publishingOffice: $publishingOffice, pressedAt: $pressedAt, reportedAt: $reportedAt, infoKind: $infoKind, infoKindVersion: $infoKindVersion, hash: $hash, createdAt: $createdAt, serialNo: $serialNo, targetedAt: $targetedAt, revokedAt: $revokedAt, headline: $headline)';
}
...
/// @nodoc
abstract mixin class $Items4CopyWith<$Res>  {
  factory $Items4CopyWith(Items4 value, $Res Function(Items4) _then) = _$Items4CopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$Items4CopyWithImpl<$Res>
    implements $Items4CopyWith<$Res> {
  _$Items4CopyWithImpl(this._self, this._then);

  final Items4 _self;
  final $Res Function(Items4) _then;
...
/// Adds pattern-matching-related methods to [Items4].
extension Items4Patterns on Items4 {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Items4 value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _Items4() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Items4 value)  $default,){
final _that = this;
switch (_that) {
case _Items4():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Items4 value)?  $default,){
final _that = this;
switch (_that) {
case _Items4() when $default != null:
return $default(_that);case _:
...
class _Items4 implements Items4 {
  const _Items4({required this.id, @JsonKey(name: 'event_id') required this.eventId, required this.type, required this.title, required this.status, @JsonKey(name: 'info_type') required this.infoType, @JsonKey(name: 'editorial_office') required this.editorialOffice, @JsonKey(name: 'publishing_office') required final  List<String> publishingOffice, @JsonKey(name: 'pressed_at') required this.pressedAt, @JsonKey(name: 'reported_at') required this.reportedAt, @JsonKey(name: 'info_kind') required this.infoKind, @JsonKey(name: 'info_kind_version') required this.infoKindVersion, required this.hash, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(includeIfNull: false, name: 'serial_no') this.serialNo, @JsonKey(includeIfNull: false, name: 'targeted_at') this.targetedAt, @JsonKey(includeIfNull: false, name: 'revoked_at') this.revokedAt, @JsonKey(includeIfNull: false) this.headline}): _publishingOffice = publishingOffice;
  factory _Items4.fromJson(Map<String, dynamic> json) => _$Items4FromJson(json);
...
@pragma('vm:prefer-inline')
_$Items4CopyWith<_Items4> get copyWith => __$Items4CopyWithImpl<_Items4>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$Items4ToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Items4&&(identical(other.id, id) || other.id == id)&&(identical(other.eventId, eventId) || other.eventId == eventId)&&(identical(other.type, type) || other.type == type)&&(identical(other.title, title) || other.title == title)&&(identical(other.status, status) || other.status == status)&&(identical(other.infoType, infoType) || other.infoType == infoType)&&(identical(other.editorialOffice, editorialOffice) || other.editorialOffice == editorialOffice)&&const DeepCollectionEquality().equals(other._publishingOffice, _publishingOffice)&&(identical(other.pressedAt, pressedAt) || other.pressedAt == pressedAt)&&(identical(other.reportedAt, reportedAt) || other.reportedAt == reportedAt)&&(identical(other.infoKind, infoKind) || other.infoKind == infoKind)&&(identical(other.infoKindVersion, infoKindVersion) || other.infoKindVersion == infoKindVersion)&&(identical(other.hash, hash) || other.hash == hash)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.serialNo, serialNo) || other.serialNo == serialNo)&&(identical(other.targetedAt, targetedAt) || other.targetedAt == targetedAt)&&(identical(other.revokedAt, revokedAt) || other.revokedAt == revokedAt)&&(identical(other.headline, headline) || other.headline == headline));
}
...
/// @nodoc
abstract mixin class _$Items4CopyWith<$Res> implements $Items4CopyWith<$Res> {
  factory _$Items4CopyWith(_Items4 value, $Res Function(_Items4) _then) = __$Items4CopyWithImpl;
@override @useResult
$Res call({
 String id,@JsonKey(name: 'event_id') String eventId, TelegramType type, String title, TelegramStatus status,@JsonKey(name: 'info_type') InfoType infoType,@JsonKey(name: 'editorial_office') String editorialOffice,@JsonKey(name: 'publishing_office') List<String> publishingOffice,@JsonKey(name: 'pressed_at') DateTime pressedAt,@JsonKey(name: 'reported_at') DateTime reportedAt,@JsonKey(name: 'info_kind') String infoKind,@JsonKey(name: 'info_kind_version') String infoKindVersion, String hash,@JsonKey(name: 'created_at') DateTime createdAt,@JsonKey(includeIfNull: false, name: 'serial_no') num? serialNo,@JsonKey(includeIfNull: false, name: 'targeted_at') DateTime? targetedAt,@JsonKey(includeIfNull: false, name: 'revoked_at') DateTime? revokedAt,@JsonKey(includeIfNull: false) String? headline
});
...
/// @nodoc
class __$Items4CopyWithImpl<$Res>
    implements _$Items4CopyWith<$Res> {
  __$Items4CopyWithImpl(this._self, this._then);

  final _Items4 _self;
  final $Res Function(_Items4) _then;
