...
part 'telegram_partial.freezed.dart';
part 'telegram_partial.g.dart';

@Freezed()
abstract class TelegramPartial with _$TelegramPartial {
  const factory TelegramPartial({
    required String id,
  ...
  factory TelegramPartial.fromJson(Map<String, Object?> json) => _$TelegramPartialFromJson(json);
}
