...
@pragma('vm:prefer-inline') @override $Res call({Object? type = null,Object? revision = null,Object? responseAt = null,Object? events = null,}) {
  return _then(RealtimeShakeDetectionSnapshotPayload(
...
class _RealtimeShakeDetectionSnapshotPayload implements RealtimeShakeDetectionSnapshotPayload {
  const _RealtimeShakeDetectionSnapshotPayload({required this.type, required this.revision, required this.responseAt, required  List<ShakeDetectionState> events}): _events = events;
