...
_NotificationTier _$NotificationTierFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      '_NotificationTier',
      json,
      ($checkedConvert) {
        final val = _NotificationTier(
...
Map<String, dynamic> _$NotificationTierToJson(_NotificationTier instance) =>
    <String, dynamic>{
