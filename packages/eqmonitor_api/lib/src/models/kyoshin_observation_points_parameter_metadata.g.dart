...
_$KyoshinObservationPointsParameterMetadataFromJson(
...
Map<String, dynamic> _$KyoshinObservationPointsParameterMetadataToJson(
  _KyoshinObservationPointsParameterMetadata instance,
) => <String, dynamic>{
  'type': instance.type,
