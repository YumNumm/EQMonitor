...
@override
String toString() {
  return 'TsunamiRegionEstimationMaxHeight(isOver: $isOver, isObserving: $isObserving, observedAt: $observedAt, value: $value, qualitative: $qualitative, revise: $revise)';
}
...
class _TsunamiRegionEstimationMaxHeight implements TsunamiRegionEstimationMaxHeight {
  const _TsunamiRegionEstimationMaxHeight({@JsonKey(name: 'is_over') required this.isOver, @JsonKey(name: 'is_observing') required this.isObserving, @JsonKey(includeIfNull: false, name: 'observed_at') this.observedAt, @JsonKey(includeIfNull: false) this.value, @JsonKey(includeIfNull: false) this.qualitative, @JsonKey(includeIfNull: false) this.revise});
