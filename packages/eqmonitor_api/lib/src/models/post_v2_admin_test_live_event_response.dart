...
@Freezed()
abstract class PostV2AdminTestLiveEventResponse
    with _$PostV2AdminTestLiveEventResponse {
  const factory PostV2AdminTestLiveEventResponse({
    required dynamic ok,
  }) = _PostV2AdminTestLiveEventResponse;

  factory PostV2AdminTestLiveEventResponse.fromJson(
    Map<String, Object?> json,
  ) => _$PostV2AdminTestLiveEventResponseFromJson(json);
}
