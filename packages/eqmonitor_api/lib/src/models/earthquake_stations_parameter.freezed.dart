...
@pragma('vm:prefer-inline') @override $Res call({Object? metadata = null,Object? prefectures = null,}) {
  return _then(EarthquakeStationsParameter(
...
class _EarthquakeStationsParameter implements EarthquakeStationsParameter {
  const _EarthquakeStationsParameter({required this.metadata, required  List<EarthquakeStationPrefecture> prefectures}): _prefectures = prefectures;
