...
_NotificationDefaultsResponse _$NotificationDefaultsResponseFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  '_NotificationDefaultsResponse',
  json,
  ($checkedConvert) {
    final val = _NotificationDefaultsResponse(
      eewEnabled: $checkedConvert('eew_enabled', (v) => v as bool),
      earthquakeEnabled: $checkedConvert(
        'earthquake_enabled',
        (v) => v as bool,
      ),
      eewDefaultSound: $checkedConvert('eew_default_sound', (v) => v as String),
      eewDefaultInterruptionLevel: $checkedConvert(
        'eew_default_interruption_level',
        (v) => $enumDecode(_$EewDefaultInterruptionLevelEnumMap, v),
      ),
      ...
      earthquakeDefaultInterruptionLevel: $checkedConvert(
        ...
        (v) => $enumDecode(_$EarthquakeDefaultInterruptionLevelEnumMap, v),
      ),
...
Map<String, dynamic> _$NotificationDefaultsResponseToJson(
  _NotificationDefaultsResponse instance,
) => <String, dynamic>{
