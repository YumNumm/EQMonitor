...
$WarningCopyWith<Warning> get copyWith => _$WarningCopyWithImpl<Warning>(this as Warning, _$identity);
  ...
  /// Serializes this Warning to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Warning&&(identical(other.text, text) || other.text == text)&&const DeepCollectionEquality().equals(other.codes, codes));
}
...
@override
String toString() {
  return 'Warning(text: $text, codes: $codes)';
}
...
class _Warning implements Warning {
  const _Warning({required this.text, required final  List<String> codes}): _codes = codes;
  factory _Warning.fromJson(Map<String, dynamic> json) => _$WarningFromJson(json);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Warning&&(identical(other.text, text) || other.text == text)&&const DeepCollectionEquality().equals(other._codes, _codes));
}
