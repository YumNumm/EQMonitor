...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is IntensityRegionSearchItem&&(identical(other.intensity, intensity) || other.intensity == intensity)&&(identical(other.earthquake, earthquake) || other.earthquake == earthquake));
}
...
@override
String toString() {
  return 'IntensityRegionSearchItem(intensity: $intensity, earthquake: $earthquake)';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? intensity = null,Object? earthquake = null,}) {
  return _then(IntensityRegionSearchItem(
...
class _IntensityRegionSearchItem implements IntensityRegionSearchItem {
  const _IntensityRegionSearchItem({required this.intensity, required this.earthquake});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _IntensityRegionSearchItem&&(identical(other.intensity, intensity) || other.intensity == intensity)&&(identical(other.earthquake, earthquake) || other.earthquake == earthquake));
}
