...
mixin _$EewIntensityRegionArrivalTimeTime {
 ...
 EewIntensityRegionArrivalTimeType get type;@JsonKey(includeIfNull: false) DateTime? get value;
...
@useResult
$Res call({
 EewIntensityRegionArrivalTimeType type,@JsonKey(includeIfNull: false) DateTime? value
});
...
@pragma('vm:prefer-inline') @override $Res call({Object? type = null,Object? value = freezed,}) {
  return _then(EewIntensityRegionArrivalTimeTime(
type: null == type ? _self.type : type // ignore: cast_nullable_to_non_nullable
as EewIntensityRegionArrivalTimeType,value: freezed == value ? _self.value : value // ignore: cast_nullable_to_non_nullable
as DateTime?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( EewIntensityRegionArrivalTimeType type, @JsonKey(includeIfNull: false)  DateTime? value)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EewIntensityRegionArrivalTimeTime() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( EewIntensityRegionArrivalTimeType type, @JsonKey(includeIfNull: false)  DateTime? value)  $default,) {final _that = this;
switch (_that) {
case _EewIntensityRegionArrivalTimeTime():
return $default(_that.type,_that.value);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( EewIntensityRegionArrivalTimeType type, @JsonKey(includeIfNull: false)  DateTime? value)?  $default,) {final _that = this;
switch (_that) {
case _EewIntensityRegionArrivalTimeTime() when $default != null:
return $default(_that.type,_that.value);case _:
  return null;
...
class _EewIntensityRegionArrivalTimeTime implements EewIntensityRegionArrivalTimeTime {
  const _EewIntensityRegionArrivalTimeTime({required this.type, @JsonKey(includeIfNull: false) this.value});
...
@override@JsonKey(includeIfNull: false) final  DateTime? value;
