  ...
  test('震源APIの生成ファイルから末尾空白を除去する', () {
    ...
    final files =
        [
              ...
              'earthquake_hypocenters_union.dart',
              'earthquake_hypocenters_union.freezed.dart',
              'migration_service_unavailable_response.dart',
              'migration_service_unavailable_response.freezed.dart',
              'archives.dart',
