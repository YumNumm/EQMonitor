...
class NotificationSettings_EewSettings_Region
  ...
  factory NotificationSettings_EewSettings_Region.fromJson(
          $core.String i,
          [$pb.ExtensionRegistry r =
              $pb.ExtensionRegistry.EMPTY]) =>
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames
          ? ''
          : 'NotificationSettings.EewSettings.Region',
    ...
    ..e<$1.JmaIntensity>(
        3,
        _omitFieldNames ? '' : 'emergencyIntensity',
        $pb.PbFieldType.OE,
        defaultOrMaker:
            $1.JmaIntensity.JMA_INTENSITY_UNSPECIFIED,
        valueOf: $1.JmaIntensity.valueOf,
        enumValues: $1.JmaIntensity.values)
    ..e<$1.JmaIntensity>(
        4,
        _omitFieldNames ? '' : 'silentIntensity',
        $pb.PbFieldType.OE,
        defaultOrMaker:
            $1.JmaIntensity.JMA_INTENSITY_UNSPECIFIED,
        valueOf: $1.JmaIntensity.valueOf,
  ...
  NotificationSettings_EewSettings_Region clone() =>
      NotificationSettings_EewSettings_Region()
  ...
  NotificationSettings_EewSettings_Region
      createEmptyInstance() => create();
  static $pb.PbList<NotificationSettings_EewSettings_Region>
      createRepeated() => $pb.PbList<
          NotificationSettings_EewSettings_Region>();
  @$core.pragma('dart2js:noInline')
  static NotificationSettings_EewSettings_Region
...
class NotificationSettings_EewSettings
    extends $pb.GeneratedMessage {
  factory NotificationSettings_EewSettings({
    $1.JmaIntensity? emergencyIntensity,
    $1.JmaIntensity? silentIntensity,
    $core.Iterable<NotificationSettings_EewSettings_Region>?
        regions,
  }) {
    final $result = create();
    if (emergencyIntensity != null) {
  ...
  factory NotificationSettings_EewSettings.fromBuffer(
          $core.List<$core.int> i,
          [$pb.ExtensionRegistry r =
              $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory NotificationSettings_EewSettings.fromJson(
          $core.String i,
          [$pb.ExtensionRegistry r =
              $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames
          ? ''
          : 'NotificationSettings.EewSettings',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'eqmonitor'),
      createEmptyInstance: create)
    ..e<$1.JmaIntensity>(
  ...
  NotificationSettings_EewSettings clone() =>
      NotificationSettings_EewSettings()
        ..mergeFromMessage(this);
  @$core.Deprecated(
      'Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  ...
  NotificationSettings_EewSettings copyWith(
          void Function(NotificationSettings_EewSettings)
              updates) =>
      super.copyWith((message) => updates(
              message as NotificationSettings_EewSettings))
  ...
  NotificationSettings_EewSettings createEmptyInstance() =>
      create();
  static $pb.PbList<NotificationSettings_EewSettings>
      createRepeated() =>
          $pb.PbList<NotificationSettings_EewSettings>();
  @$core.pragma('dart2js:noInline')
  static NotificationSettings_EewSettings getDefault() =>
      _defaultInstance ??=
          $pb.GeneratedMessage.$_defaultFor<
              NotificationSettings_EewSettings>(create);
  ...
  @$pb.TagNumber(3)
  $core.List<NotificationSettings_EewSettings_Region>
      get regions => $_getList(2);
}
...
class NotificationSettings_EarthquakeSettings_Region
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames
          ? ''
          : 'NotificationSettings.EarthquakeSettings.Region',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'eqmonitor'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'code')
  ...
  NotificationSettings_EarthquakeSettings_Region clone() =>
      NotificationSettings_EarthquakeSettings_Region()
        ..mergeFromMessage(this);
  @$core.Deprecated(
      'Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  ...
  @$core.pragma('dart2js:noInline')
  static NotificationSettings_EarthquakeSettings_Region
      create() =>
          NotificationSettings_EarthquakeSettings_Region
              ._();
  NotificationSettings_EarthquakeSettings_Region
...
class NotificationSettings_EarthquakeSettings
    extends $pb.GeneratedMessage {
  ...
  factory NotificationSettings_EarthquakeSettings.fromBuffer(
          ...
          [$pb.ExtensionRegistry r =
              $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory NotificationSettings_EarthquakeSettings.fromJson(
          $core.String i,
          [$pb.ExtensionRegistry r =
              $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames
          ? ''
          : 'NotificationSettings.EarthquakeSettings',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'eqmonitor'),
      createEmptyInstance: create)
    ..e<$1.JmaIntensity>(
  ...
  NotificationSettings_EarthquakeSettings clone() =>
      NotificationSettings_EarthquakeSettings()
        ..mergeFromMessage(this);
  @$core.Deprecated(
      'Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  ...
  NotificationSettings_EarthquakeSettings
      createEmptyInstance() => create();
  static $pb.PbList<NotificationSettings_EarthquakeSettings>
      createRepeated() => $pb.PbList<
          NotificationSettings_EarthquakeSettings>();
  @$core.pragma('dart2js:noInline')
  static NotificationSettings_EarthquakeSettings
      getDefault() => _defaultInstance ??=
          $pb.GeneratedMessage.$_defaultFor<
                  NotificationSettings_EarthquakeSettings>(
              create);
  ...
  @$pb.TagNumber(3)
  $core.List<NotificationSettings_EarthquakeSettings_Region>
      get regions => $_getList(2);
}
...
class NotificationSettings extends $pb.GeneratedMessage {
  ...
  factory NotificationSettings.fromBuffer(
          $core.List<$core.int> i,
          [$pb.ExtensionRegistry r =
              $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  ...
  NotificationSettings copyWith(
          void Function(NotificationSettings) updates) =>
      super.copyWith((message) =>
              updates(message as NotificationSettings))
          as NotificationSettings;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static NotificationSettings create() =>
      NotificationSettings._();
  NotificationSettings createEmptyInstance() => create();
  static $pb.PbList<NotificationSettings>
      createRepeated() =>
          $pb.PbList<NotificationSettings>();
  @$core.pragma('dart2js:noInline')
  static NotificationSettings getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage
          .$_defaultFor<NotificationSettings>(create);
  static NotificationSettings? _defaultInstance;

  @$pb.TagNumber(1)
  NotificationSettings_EewSettings get eewSettings =>
      $_getN(0);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(1)
  NotificationSettings_EewSettings ensureEewSettings() =>
      $_ensure(0);

  @$pb.TagNumber(2)
  NotificationSettings_EarthquakeSettings
      get earthquakeSettings => $_getN(1);
  @$pb.TagNumber(2)
  set earthquakeSettings(
      NotificationSettings_EarthquakeSettings v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  NotificationSettings_EarthquakeSettings
      ensureEarthquakeSettings() => $_ensure(1);
}
