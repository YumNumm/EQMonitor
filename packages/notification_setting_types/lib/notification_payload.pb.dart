...
class NotificationPayload_EewInformation
  ...
  factory NotificationPayload_EewInformation.fromBuffer(
          $core.List<$core.int> i,
          [$pb.ExtensionRegistry r =
              $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory NotificationPayload_EewInformation.fromJson(
          $core.String i,
          [$pb.ExtensionRegistry r =
              $pb.ExtensionRegistry.EMPTY]) =>
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames
          ? ''
          : 'NotificationPayload.EewInformation',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'eqmonitor'),
    ...
    ..e<JmaIntensity>(
        2,
        _omitFieldNames ? '' : 'maxIntensity',
        $pb.PbFieldType.OE,
        defaultOrMaker:
            JmaIntensity.JMA_INTENSITY_UNSPECIFIED,
        valueOf: JmaIntensity.valueOf,
        enumValues: JmaIntensity.values)
    ..pc<NotificationPayload_EewRegionIntensity>(
        3,
        _omitFieldNames ? '' : 'regionIntensities',
        $pb.PbFieldType.PM,
        subBuilder:
  ...
  NotificationPayload_EewInformation clone() =>
      NotificationPayload_EewInformation()
  ...
  NotificationPayload_EewInformation copyWith(
          void Function(NotificationPayload_EewInformation)
              updates) =>
  ...
  NotificationPayload_EewInformation
      createEmptyInstance() => create();
  static $pb.PbList<NotificationPayload_EewInformation>
      createRepeated() =>
          $pb.PbList<NotificationPayload_EewInformation>();
  @$core.pragma('dart2js:noInline')
  static NotificationPayload_EewInformation getDefault() =>
      _defaultInstance ??=
          $pb.GeneratedMessage.$_defaultFor<
              NotificationPayload_EewInformation>(create);
  static NotificationPayload_EewInformation?
      _defaultInstance;

  @$pb.TagNumber(1)
  NotificationPayload_HypoInformation get hypoInformation =>
      $_getN(0);
  @$pb.TagNumber(1)
  set hypoInformation(
      NotificationPayload_HypoInformation v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  NotificationPayload_HypoInformation
      ensureHypoInformation() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $core.List<NotificationPayload_EewRegionIntensity>
      get regionIntensities => $_getList(2);
}

class NotificationPayload_EarthquakeInformation
    extends $pb.GeneratedMessage {
  factory NotificationPayload_EarthquakeInformation({
    NotificationPayload_HypoInformation? hypoInformation,
    JmaIntensity? maxIntensity,
    $core.Iterable<NotificationPayload_RegionIntensity>?
        regionIntensities,
  }) {
    final $result = create();
    if (hypoInformation != null) {
  ...
  factory NotificationPayload_EarthquakeInformation.fromBuffer(
          ...
          [$pb.ExtensionRegistry r =
              $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory NotificationPayload_EarthquakeInformation.fromJson(
          $core.String i,
          [$pb.ExtensionRegistry r =
              $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames
          ? ''
          : 'NotificationPayload.EarthquakeInformation',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'eqmonitor'),
      createEmptyInstance: create)
    ..aOM<NotificationPayload_HypoInformation>(
  ...
  NotificationPayload_EarthquakeInformation clone() =>
      NotificationPayload_EarthquakeInformation()
        ..mergeFromMessage(this);
  @$core.Deprecated(
      'Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  ...
  @$core.pragma('dart2js:noInline')
  static NotificationPayload_EarthquakeInformation
      create() =>
          NotificationPayload_EarthquakeInformation._();
  NotificationPayload_EarthquakeInformation
      createEmptyInstance() => create();
  static $pb
      .PbList<NotificationPayload_EarthquakeInformation>
      createRepeated() => $pb.PbList<
          NotificationPayload_EarthquakeInformation>();
  @$core.pragma('dart2js:noInline')
  static NotificationPayload_EarthquakeInformation
      getDefault() => _defaultInstance ??= $pb
          .GeneratedMessage.$_defaultFor<
              NotificationPayload_EarthquakeInformation>(
          create);
  static NotificationPayload_EarthquakeInformation?
      _defaultInstance;
  ...
  @$pb.TagNumber(3)
  $core.List<NotificationPayload_RegionIntensity>
      get regionIntensities => $_getList(2);
}

class NotificationPayload_RegionIntensity
    extends $pb.GeneratedMessage {
  ...
  factory NotificationPayload_RegionIntensity.fromBuffer(
          ...
          [$pb.ExtensionRegistry r =
              $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory NotificationPayload_RegionIntensity.fromJson(
          $core.String i,
          [$pb.ExtensionRegistry r =
              $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames
          ? ''
          : 'NotificationPayload.RegionIntensity',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'eqmonitor'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'code')
    ..e<JmaIntensity>(2, _omitFieldNames ? '' : 'intensity',
        $pb.PbFieldType.OE,
        defaultOrMaker:
            JmaIntensity.JMA_INTENSITY_UNSPECIFIED,
        valueOf: JmaIntensity.valueOf,
  ...
  NotificationPayload_RegionIntensity clone() =>
      NotificationPayload_RegionIntensity()
        ..mergeFromMessage(this);
  @$core.Deprecated(
      'Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  ...
  NotificationPayload_RegionIntensity copyWith(
          void Function(NotificationPayload_RegionIntensity)
              updates) =>
      super.copyWith((message) => updates(message
  ...
  NotificationPayload_RegionIntensity
      createEmptyInstance() => create();
  static $pb.PbList<NotificationPayload_RegionIntensity>
      createRepeated() =>
  ...
  static NotificationPayload_RegionIntensity getDefault() =>
      _defaultInstance ??=
          $pb.GeneratedMessage.$_defaultFor<
              NotificationPayload_RegionIntensity>(create);
  static NotificationPayload_RegionIntensity?
      _defaultInstance;
...
class NotificationPayload_EewRegionIntensity
    extends $pb.GeneratedMessage {
  ...
  factory NotificationPayload_EewRegionIntensity.fromBuffer(
          ...
          [$pb.ExtensionRegistry r =
              $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory NotificationPayload_EewRegionIntensity.fromJson(
          $core.String i,
          [$pb.ExtensionRegistry r =
              $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames
          ? ''
          : 'NotificationPayload.EewRegionIntensity',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'eqmonitor'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'code')
  ...
  NotificationPayload_EewRegionIntensity
      createEmptyInstance() => create();
  static $pb.PbList<NotificationPayload_EewRegionIntensity>
      createRepeated() => $pb.PbList<
          NotificationPayload_EewRegionIntensity>();
  @$core.pragma('dart2js:noInline')
  static NotificationPayload_EewRegionIntensity
      getDefault() => _defaultInstance ??=
          $pb.GeneratedMessage.$_defaultFor<
                  NotificationPayload_EewRegionIntensity>(
              create);
  static NotificationPayload_EewRegionIntensity?
...
class NotificationPayload_HypoInformation
    extends $pb.GeneratedMessage {
  ...
  factory NotificationPayload_HypoInformation.fromBuffer(
          ...
          [$pb.ExtensionRegistry r =
              $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory NotificationPayload_HypoInformation.fromJson(
          $core.String i,
          [$pb.ExtensionRegistry r =
              $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames
          ? ''
          : 'NotificationPayload.HypoInformation',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'eqmonitor'),
      createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'code',
        $pb.PbFieldType.O3)
    ...
    ..a<$core.double>(4, _omitFieldNames ? '' : 'longitude',
        $pb.PbFieldType.OF)
    ..a<$core.int>(5, _omitFieldNames ? '' : 'depth',
        $pb.PbFieldType.O3)
    ..a<$core.double>(6, _omitFieldNames ? '' : 'magnitude',
        $pb.PbFieldType.OF)
    ..hasRequiredFields = false;
  ...
  NotificationPayload_HypoInformation copyWith(
          void Function(NotificationPayload_HypoInformation)
              updates) =>
      super.copyWith((message) => updates(message
  ...
  NotificationPayload_HypoInformation
      createEmptyInstance() => create();
  static $pb.PbList<NotificationPayload_HypoInformation>
      createRepeated() =>
  ...
  static NotificationPayload_HypoInformation getDefault() =>
      _defaultInstance ??=
          $pb.GeneratedMessage.$_defaultFor<
              NotificationPayload_HypoInformation>(create);
  static NotificationPayload_HypoInformation?
      _defaultInstance;
...
class NotificationPayload extends $pb.GeneratedMessage {
  ...
  factory NotificationPayload.fromBuffer(
          $core.List<$core.int> i,
          [$pb.ExtensionRegistry r =
              $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<NotificationPayload_Type>(2,
        _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE,
        defaultOrMaker:
            NotificationPayload_Type.TYPE_UNSPECIFIED,
  ...
  @$core.Deprecated(
      ...
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  NotificationPayload clone() =>
      NotificationPayload()..mergeFromMessage(this);
  @$core.Deprecated(
      'Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  NotificationPayload copyWith(
          void Function(NotificationPayload) updates) =>
      super.copyWith((message) =>
              updates(message as NotificationPayload))
          as NotificationPayload;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static NotificationPayload create() =>
  ...
  @$core.pragma('dart2js:noInline')
  static NotificationPayload getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage
          .$_defaultFor<NotificationPayload>(create);
  ...
  @$pb.TagNumber(3)
  NotificationPayload_EewInformation get eewInformation =>
      $_getN(2);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(3)
  NotificationPayload_EewInformation
      ensureEewInformation() => $_ensure(2);

  @$pb.TagNumber(4)
  NotificationPayload_EarthquakeInformation
      get earthquakeInformation => $_getN(3);
  @$pb.TagNumber(4)
  set earthquakeInformation(
      NotificationPayload_EarthquakeInformation v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  NotificationPayload_EarthquakeInformation
      ensureEarthquakeInformation() => $_ensure(3);
}
