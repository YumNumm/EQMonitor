...
final $typed_data.Uint8List tsunamiParameterDescriptor =
    $convert.base64Decode(
        'ChBUc3VuYW1pUGFyYW1ldGVyEisKBWl0ZW1zGAEgAygLMhUuVHN1bmFtaVBhcmFtZXRlckl0ZW'
        '1SBWl0ZW1z');

@$core.Deprecated(
    'Use tsunamiParameterItemDescriptor instead')
...
final $typed_data.Uint8List tsunamiParameterItemDescriptor =
    $convert.base64Decode(
