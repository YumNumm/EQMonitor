...
class JmaMap_TopoJSONMapData extends $pb.GeneratedMessage {
  ...
  factory JmaMap_TopoJSONMapData.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory JmaMap_TopoJSONMapData.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'JmaMap.TopoJSONMapData',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'net.yumnumm.eqmonitor.jma_map'),
      createEmptyInstance: create)
    ..e<JmaMap_JmaMapData_JmaMapType>(
        ...
        enumValues: JmaMap_JmaMapData_JmaMapType.values)
    ..aOS(2, _omitFieldNames ? '' : 'name')
    ..pc<JmaMap_TopoJSONGeometry>(
        3, _omitFieldNames ? '' : 'geometries', $pb.PbFieldType.PM,
        subBuilder: JmaMap_TopoJSONGeometry.create)
    ..pc<JmaMap_TopoJSONArc>(
        4, _omitFieldNames ? '' : 'arcs', $pb.PbFieldType.PM,
        subBuilder: JmaMap_TopoJSONArc.create)
    ..aOM<JmaMap_LatLngBounds>(5, _omitFieldNames ? '' : 'bounds',
        subBuilder: JmaMap_LatLngBounds.create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  JmaMap_TopoJSONMapData clone() =>
      JmaMap_TopoJSONMapData()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  JmaMap_TopoJSONMapData copyWith(
          void Function(JmaMap_TopoJSONMapData) updates) =>
      super.copyWith((message) => updates(message as JmaMap_TopoJSONMapData))
          as JmaMap_TopoJSONMapData;
  ...
  static $pb.PbList<JmaMap_TopoJSONMapData> createRepeated() =>
      $pb.PbList<JmaMap_TopoJSONMapData>();
  @$core.pragma('dart2js:noInline')
  static JmaMap_TopoJSONMapData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<JmaMap_TopoJSONMapData>(create);
...
class JmaMap_TopoJSONGeometry extends $pb.GeneratedMessage {
  ...
  factory JmaMap_TopoJSONGeometry.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory JmaMap_TopoJSONGeometry.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'JmaMap.TopoJSONGeometry',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'net.yumnumm.eqmonitor.jma_map'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'type')
    ..pc<JmaMap_TopoJSONArcIndices>(
        2, _omitFieldNames ? '' : 'arcIndices', $pb.PbFieldType.PM,
        protoName: 'arcIndices', subBuilder: JmaMap_TopoJSONArcIndices.create)
    ..aOM<JmaMap_JmaMapData_JmaMapDataItem_Property>(
        3, _omitFieldNames ? '' : 'property',
        subBuilder: JmaMap_JmaMapData_JmaMapDataItem_Property.create)
    ..aOM<JmaMap_LatLngBounds>(4, _omitFieldNames ? '' : 'bounds',
        subBuilder: JmaMap_LatLngBounds.create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  JmaMap_TopoJSONGeometry clone() =>
      JmaMap_TopoJSONGeometry()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  JmaMap_TopoJSONGeometry copyWith(
          void Function(JmaMap_TopoJSONGeometry) updates) =>
      super.copyWith((message) => updates(message as JmaMap_TopoJSONGeometry))
          as JmaMap_TopoJSONGeometry;
  ...
  static $pb.PbList<JmaMap_TopoJSONGeometry> createRepeated() =>
      $pb.PbList<JmaMap_TopoJSONGeometry>();
  @$core.pragma('dart2js:noInline')
  static JmaMap_TopoJSONGeometry getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<JmaMap_TopoJSONGeometry>(create);
...
class JmaMap_TopoJSONArcIndices extends $pb.GeneratedMessage {
  ...
  factory JmaMap_TopoJSONArcIndices.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory JmaMap_TopoJSONArcIndices.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'JmaMap.TopoJSONArcIndices',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'net.yumnumm.eqmonitor.jma_map'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  JmaMap_TopoJSONArcIndices clone() =>
      JmaMap_TopoJSONArcIndices()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  JmaMap_TopoJSONArcIndices copyWith(
          void Function(JmaMap_TopoJSONArcIndices) updates) =>
      super.copyWith((message) => updates(message as JmaMap_TopoJSONArcIndices))
          as JmaMap_TopoJSONArcIndices;
  ...
  static $pb.PbList<JmaMap_TopoJSONArcIndices> createRepeated() =>
      $pb.PbList<JmaMap_TopoJSONArcIndices>();
  @$core.pragma('dart2js:noInline')
  static JmaMap_TopoJSONArcIndices getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<JmaMap_TopoJSONArcIndices>(create);
...
class JmaMap_TopoJSONArc extends $pb.GeneratedMessage {
  ...
  factory JmaMap_TopoJSONArc.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory JmaMap_TopoJSONArc.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'JmaMap.TopoJSONArc',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'net.yumnumm.eqmonitor.jma_map'),
      createEmptyInstance: create)
    ..pc<JmaMap_LatLng>(
        1, _omitFieldNames ? '' : 'positions', $pb.PbFieldType.PM,
        subBuilder: JmaMap_LatLng.create)
    ..aOM<JmaMap_LatLngBounds>(2, _omitFieldNames ? '' : 'bounds',
        subBuilder: JmaMap_LatLngBounds.create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  JmaMap_TopoJSONArc copyWith(void Function(JmaMap_TopoJSONArc) updates) =>
      super.copyWith((message) => updates(message as JmaMap_TopoJSONArc))
          as JmaMap_TopoJSONArc;
  ...
  static $pb.PbList<JmaMap_TopoJSONArc> createRepeated() =>
      $pb.PbList<JmaMap_TopoJSONArc>();
  @$core.pragma('dart2js:noInline')
  static JmaMap_TopoJSONArc getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<JmaMap_TopoJSONArc>(create);
...
class JmaMap extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<JmaMap_TopoJSONMapData>(
        2, _omitFieldNames ? '' : 'topoJsonData', $pb.PbFieldType.PM,
        protoName: 'topoJsonData', subBuilder: JmaMap_TopoJSONMapData.create)
    ..hasRequiredFields = false;
