...
class JmaCodeTableHeader extends $pb.GeneratedMessage {
  factory JmaCodeTableHeader({
    ...
    final $result = create();
    if (dateVersion != null) {
      $result.dateVersion = dateVersion;
    }
    if (fetchedAt != null) {
  ...
  JmaCodeTableHeader._() : super();
  factory JmaCodeTableHeader.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory JmaCodeTableHeader.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'JmaCodeTableHeader', createEmptyInstance: create)
  ...
  JmaCodeTableHeader clone() => JmaCodeTableHeader()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  JmaCodeTableHeader copyWith(void Function(JmaCodeTableHeader) updates) => super.copyWith((message) => updates(message as JmaCodeTableHeader)) as JmaCodeTableHeader;
  ...
  static $pb.PbList<JmaCodeTableHeader> createRepeated() => $pb.PbList<JmaCodeTableHeader>();
  @$core.pragma('dart2js:noInline')
  static JmaCodeTableHeader getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<JmaCodeTableHeader>(create);
  static JmaCodeTableHeader? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get dateVersion => $_getSZ(0);
  @$pb.TagNumber(1)
  set dateVersion($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasDateVersion() => $_has(0);
  @$pb.TagNumber(1)
  void clearDateVersion() => clearField(1);

  @$pb.TagNumber(2)
  $core.String get fetchedAt => $_getSZ(1);
  @$pb.TagNumber(2)
  set fetchedAt($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasFetchedAt() => $_has(1);
  @$pb.TagNumber(2)
  void clearFetchedAt() => clearField(2);
  ...
  @$pb.TagNumber(4)
  set sha384($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasSha384() => $_has(3);
  @$pb.TagNumber(4)
  void clearSha384() => clearField(4);
}
...
class JmaCodeTable extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'JmaCodeTable', createEmptyInstance: create)
    ..aOM<JmaCodeTableHeader>(1, _omitFieldNames ? '' : 'header', subBuilder: JmaCodeTableHeader.create)
  ...
  @$pb.TagNumber(1)
  set header(JmaCodeTableHeader v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(23)
  AreaInformationPrefectureEarthquake get areaInformationPrefectureEarthquake => $_getN(2);
  @$pb.TagNumber(23)
  ...
  @$pb.TagNumber(23)
  AreaInformationPrefectureEarthquake ensureAreaInformationPrefectureEarthquake() => $_ensure(2);
