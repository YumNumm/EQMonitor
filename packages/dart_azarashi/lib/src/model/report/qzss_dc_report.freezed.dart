...
mixin _$QzssDcReport {
 ...
 String get sentence;@Uint8ListConverter() Uint8List get message; String get nmea; String? get messageHeader; int? get satelliteId; int? get satellitePrn;@Uint8ListConverter() Uint8List get raw; String get preamble; String get messageType;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is QzssDcReport&&(identical(other.sentence, sentence) || other.sentence == sentence)&&const DeepCollectionEquality().equals(other.message, message)&&(identical(other.nmea, nmea) || other.nmea == nmea)&&(identical(other.messageHeader, messageHeader) || other.messageHeader == messageHeader)&&(identical(other.satelliteId, satelliteId) || other.satelliteId == satelliteId)&&(identical(other.satellitePrn, satellitePrn) || other.satellitePrn == satellitePrn)&&const DeepCollectionEquality().equals(other.raw, raw)&&(identical(other.preamble, preamble) || other.preamble == preamble)&&(identical(other.messageType, messageType) || other.messageType == messageType));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,sentence,const DeepCollectionEquality().hash(message),nmea,messageHeader,satelliteId,satellitePrn,const DeepCollectionEquality().hash(raw),preamble,messageType);

@override
String toString() {
  return 'QzssDcReport(sentence: $sentence, message: $message, nmea: $nmea, messageHeader: $messageHeader, satelliteId: $satelliteId, satellitePrn: $satellitePrn, raw: $raw, preamble: $preamble, messageType: $messageType)';
}
...
@useResult
$Res call({
 String sentence,@Uint8ListConverter() Uint8List message, String nmea, String? messageHeader, int? satelliteId, int? satellitePrn,@Uint8ListConverter() Uint8List raw, String preamble, String messageType
});
...
/// Create a copy of QzssDcReport
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? sentence = null,Object? message = null,Object? nmea = null,Object? messageHeader = freezed,Object? satelliteId = freezed,Object? satellitePrn = freezed,Object? raw = null,Object? preamble = null,Object? messageType = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  int version,  String reportClassification,  String reportClassificationEn,  int reportClassificationNo,  String disasterCategory,  String disasterCategoryEn,  int disasterCategoryNo,  DateTime reportTime,  String informationType,  String informationTypeEn,  int informationTypeNo,  String? longPeriodGroundMotionLowerLimit,  int longPeriodGroundMotionLowerLimitRaw,  String? longPeriodGroundMotionUpperLimit,  int longPeriodGroundMotionUpperLimitRaw,  List<String> notificationsOnDisasterPrevention,  List<int> notificationsOnDisasterPreventionRaw,  DateTime occurrenceTimeOfEarthquake,  String depthOfHypocenter,  int depthOfHypocenterRaw,  String magnitude,  int magnitudeRaw,  bool assumptive,  String seismicEpicenter,  int seismicEpicenterRaw,  String seismicIntensityLowerLimit,  int seismicIntensityLowerLimitRaw,  String seismicIntensityUpperLimit,  int seismicIntensityUpperLimitRaw,  List<String> eewForecastRegions,  List<int> eewForecastRegionsRaw)?  earthquakeEarlyWarning,TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  int version,  String reportClassification,  String reportClassificationEn,  int reportClassificationNo,  String disasterCategory,  String disasterCategoryEn,  int disasterCategoryNo,  DateTime reportTime,  String informationType,  String informationTypeEn,  int informationTypeNo,  List<String> notificationsOnDisasterPrevention,  List<int> notificationsOnDisasterPreventionRaw,  DateTime occurrenceTimeOfEarthquake,  String depthOfHypocenter,  int depthOfHypocenterRaw,  String magnitude,  int magnitudeRaw,  String seismicEpicenter,  int seismicEpicenterRaw,  HypocenterCoordinates coordinatesOfHypocenter)?  hypocenter,TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  int version,  String reportClassification,  String reportClassificationEn,  int reportClassificationNo,  String disasterCategory,  String disasterCategoryEn,  int disasterCategoryNo,  DateTime reportTime,  String informationType,  String informationTypeEn,  int informationTypeNo,  DateTime occurrenceTimeOfEarthquake,  List<String> seismicIntensities,  List<int> seismicIntensitiesRaw,  List<String> prefectures,  List<int> prefecturesRaw)?  seismicIntensity,TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  int version,  String reportClassification,  String reportClassificationEn,  int reportClassificationNo,  String disasterCategory,  String disasterCategoryEn,  int disasterCategoryNo,  DateTime reportTime,  String informationType,  String informationTypeEn,  int informationTypeNo,  List<String> notificationsOnDisasterPrevention,  List<int> notificationsOnDisasterPreventionRaw,  String tsunamiWarningCode,  int tsunamiWarningCodeRaw,  List<DateTime?> expectedTsunamiArrivalTimes,  List<String> tsunamiHeights,  List<int> tsunamiHeightsRaw,  List<String> tsunamiForecastRegions,  List<int> tsunamiForecastRegionsRaw)?  tsunami,TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  int version,  String reportClassification,  String reportClassificationEn,  int reportClassificationNo,  String disasterCategory,  String disasterCategoryEn,  int disasterCategoryNo,  DateTime reportTime,  String informationType,  String informationTypeEn,  int informationTypeNo,  String informationSerialCode,  int informationSerialCodeRaw, @Uint8ListConverter()  Uint8List textInformation,  int pageNumber,  int totalPage)?  nankaiTroughEarthquake,TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  int version,  String reportClassification,  String reportClassificationEn,  int reportClassificationNo,  String disasterCategory,  String disasterCategoryEn,  int disasterCategoryNo,  DateTime reportTime,  String informationType,  String informationTypeEn,  int informationTypeNo,  String tsunamigenicPotentialEn,  int tsunamigenicPotentialRaw,  List<DateTime?> expectedTsunamiArrivalTimes,  List<String> tsunamiHeightsEn,  List<int> tsunamiHeightsRaw,  List<String> coastalRegionsEn,  List<int> coastalRegionsRaw)?  northwestPacificTsunami,TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  int version,  String reportClassification,  String reportClassificationEn,  int reportClassificationNo,  String disasterCategory,  String disasterCategoryEn,  int disasterCategoryNo,  DateTime reportTime,  String informationType,  String informationTypeEn,  int informationTypeNo,  List<String> floodWarningLevels,  List<int> floodWarningLevelsRaw,  List<String> floodForecastRegions,  List<int> floodForecastRegionsRaw)?  flood,TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  int version,  String reportClassification,  String reportClassificationEn,  int reportClassificationNo,  String disasterCategory,  String disasterCategoryEn,  int disasterCategoryNo,  DateTime reportTime,  String informationType,  String informationTypeEn,  int informationTypeNo,  List<String> marineWarningCodes,  List<int> marineWarningCodesRaw,  List<String> marineForecastRegions,  List<int> marineForecastRegionsRaw)?  marine,TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  int version,  String reportClassification,  String reportClassificationEn,  int reportClassificationNo,  String disasterCategory,  String disasterCategoryEn,  int disasterCategoryNo,  DateTime reportTime,  String informationType,  String informationTypeEn,  int informationTypeNo,  String weatherWarningState,  int weatherWarningStateRaw,  List<String> weatherRelatedDisasterSubCategories,  List<int> weatherRelatedDisasterSubCategoriesRaw,  List<String> weatherForecastRegions,  List<int> weatherForecastRegionsRaw)?  weather,TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  int version,  String reportClassification,  String reportClassificationEn,  int reportClassificationNo,  String disasterCategory,  String disasterCategoryEn,  int disasterCategoryNo,  DateTime reportTime,  String informationType,  String informationTypeEn,  int informationTypeNo,  int ambiguityOfActivityTimeNo,  DateTime activityTime,  String volcanicWarningCode,  int volcanicWarningCodeRaw,  String volcanoName,  int volcanoNameRaw,  List<String> localGovernments,  List<int> localGovernmentsRaw)?  volcano,TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  int version,  String reportClassification,  String reportClassificationEn,  int reportClassificationNo,  String disasterCategory,  String disasterCategoryEn,  int disasterCategoryNo,  DateTime reportTime,  String informationType,  String informationTypeEn,  int informationTypeNo,  DateTime activityTime,  String ashFallWarningType,  int ashFallWarningTypeRaw,  String volcanoName,  int volcanoNameRaw,  List<int> expectedAshFallTimes,  List<String> ashFallWarningCodes,  List<int> ashFallWarningCodesRaw,  List<String> localGovernments,  List<int> localGovernmentsRaw)?  ashFall,TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  int version,  String reportClassification,  String reportClassificationEn,  int reportClassificationNo,  String disasterCategory,  String disasterCategoryEn,  int disasterCategoryNo,  DateTime reportTime,  String informationType,  String informationTypeEn,  int informationTypeNo,  DateTime referenceTime,  String referenceTimeType,  int referenceTimeTypeRaw,  int elapsedTimeFromReferenceTime,  String typhoonNumber,  int typhoonNumberRaw,  String typhoonScaleCategory,  int typhoonScaleCategoryRaw,  String typhoonIntensityCategory,  int typhoonIntensityCategoryRaw,  HypocenterCoordinates coordinatesOfTyphoon,  String centralPressure,  int centralPressureRaw,  String maximumWindSpeed,  int maximumWindSpeedRaw,  String maximumGustWindSpeed,  int maximumGustWindSpeedRaw)?  typhoon,TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  String dcxMessageType)?  dcxNull,TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  String dcxMessageType)?  dcxOutsideJapan,TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  String dcxMessageType)?  dcxLAlert,TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  String dcxMessageType)?  dcxJAlert,TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  String dcxMessageType)?  dcxMTInfo,TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  String dcxMessageType)?  dcxUnknown,required TResult orElse(),}) {final _that = this;
switch (_that) {
case QzssDcReportEarthquakeEarlyWarning() when earthquakeEarlyWarning != null:
return earthquakeEarlyWarning(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.version,_that.reportClassification,_that.reportClassificationEn,_that.reportClassificationNo,_that.disasterCategory,_that.disasterCategoryEn,_that.disasterCategoryNo,_that.reportTime,_that.informationType,_that.informationTypeEn,_that.informationTypeNo,_that.longPeriodGroundMotionLowerLimit,_that.longPeriodGroundMotionLowerLimitRaw,_that.longPeriodGroundMotionUpperLimit,_that.longPeriodGroundMotionUpperLimitRaw,_that.notificationsOnDisasterPrevention,_that.notificationsOnDisasterPreventionRaw,_that.occurrenceTimeOfEarthquake,_that.depthOfHypocenter,_that.depthOfHypocenterRaw,_that.magnitude,_that.magnitudeRaw,_that.assumptive,_that.seismicEpicenter,_that.seismicEpicenterRaw,_that.seismicIntensityLowerLimit,_that.seismicIntensityLowerLimitRaw,_that.seismicIntensityUpperLimit,_that.seismicIntensityUpperLimitRaw,_that.eewForecastRegions,_that.eewForecastRegionsRaw);case QzssDcReportHypocenter() when hypocenter != null:
return hypocenter(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.version,_that.reportClassification,_that.reportClassificationEn,_that.reportClassificationNo,_that.disasterCategory,_that.disasterCategoryEn,_that.disasterCategoryNo,_that.reportTime,_that.informationType,_that.informationTypeEn,_that.informationTypeNo,_that.notificationsOnDisasterPrevention,_that.notificationsOnDisasterPreventionRaw,_that.occurrenceTimeOfEarthquake,_that.depthOfHypocenter,_that.depthOfHypocenterRaw,_that.magnitude,_that.magnitudeRaw,_that.seismicEpicenter,_that.seismicEpicenterRaw,_that.coordinatesOfHypocenter);case QzssDcReportSeismicIntensity() when seismicIntensity != null:
return seismicIntensity(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.version,_that.reportClassification,_that.reportClassificationEn,_that.reportClassificationNo,_that.disasterCategory,_that.disasterCategoryEn,_that.disasterCategoryNo,_that.reportTime,_that.informationType,_that.informationTypeEn,_that.informationTypeNo,_that.occurrenceTimeOfEarthquake,_that.seismicIntensities,_that.seismicIntensitiesRaw,_that.prefectures,_that.prefecturesRaw);case QzssDcReportTsunami() when tsunami != null:
return tsunami(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.version,_that.reportClassification,_that.reportClassificationEn,_that.reportClassificationNo,_that.disasterCategory,_that.disasterCategoryEn,_that.disasterCategoryNo,_that.reportTime,_that.informationType,_that.informationTypeEn,_that.informationTypeNo,_that.notificationsOnDisasterPrevention,_that.notificationsOnDisasterPreventionRaw,_that.tsunamiWarningCode,_that.tsunamiWarningCodeRaw,_that.expectedTsunamiArrivalTimes,_that.tsunamiHeights,_that.tsunamiHeightsRaw,_that.tsunamiForecastRegions,_that.tsunamiForecastRegionsRaw);case QzssDcReportNankaiTroughEarthquake() when nankaiTroughEarthquake != null:
return nankaiTroughEarthquake(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.version,_that.reportClassification,_that.reportClassificationEn,_that.reportClassificationNo,_that.disasterCategory,_that.disasterCategoryEn,_that.disasterCategoryNo,_that.reportTime,_that.informationType,_that.informationTypeEn,_that.informationTypeNo,_that.informationSerialCode,_that.informationSerialCodeRaw,_that.textInformation,_that.pageNumber,_that.totalPage);case QzssDcReportNorthwestPacificTsunami() when northwestPacificTsunami != null:
return northwestPacificTsunami(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.version,_that.reportClassification,_that.reportClassificationEn,_that.reportClassificationNo,_that.disasterCategory,_that.disasterCategoryEn,_that.disasterCategoryNo,_that.reportTime,_that.informationType,_that.informationTypeEn,_that.informationTypeNo,_that.tsunamigenicPotentialEn,_that.tsunamigenicPotentialRaw,_that.expectedTsunamiArrivalTimes,_that.tsunamiHeightsEn,_that.tsunamiHeightsRaw,_that.coastalRegionsEn,_that.coastalRegionsRaw);case QzssDcReportFlood() when flood != null:
return flood(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.version,_that.reportClassification,_that.reportClassificationEn,_that.reportClassificationNo,_that.disasterCategory,_that.disasterCategoryEn,_that.disasterCategoryNo,_that.reportTime,_that.informationType,_that.informationTypeEn,_that.informationTypeNo,_that.floodWarningLevels,_that.floodWarningLevelsRaw,_that.floodForecastRegions,_that.floodForecastRegionsRaw);case QzssDcReportMarine() when marine != null:
return marine(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.version,_that.reportClassification,_that.reportClassificationEn,_that.reportClassificationNo,_that.disasterCategory,_that.disasterCategoryEn,_that.disasterCategoryNo,_that.reportTime,_that.informationType,_that.informationTypeEn,_that.informationTypeNo,_that.marineWarningCodes,_that.marineWarningCodesRaw,_that.marineForecastRegions,_that.marineForecastRegionsRaw);case QzssDcReportWeather() when weather != null:
return weather(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.version,_that.reportClassification,_that.reportClassificationEn,_that.reportClassificationNo,_that.disasterCategory,_that.disasterCategoryEn,_that.disasterCategoryNo,_that.reportTime,_that.informationType,_that.informationTypeEn,_that.informationTypeNo,_that.weatherWarningState,_that.weatherWarningStateRaw,_that.weatherRelatedDisasterSubCategories,_that.weatherRelatedDisasterSubCategoriesRaw,_that.weatherForecastRegions,_that.weatherForecastRegionsRaw);case QzssDcReportVolcano() when volcano != null:
return volcano(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.version,_that.reportClassification,_that.reportClassificationEn,_that.reportClassificationNo,_that.disasterCategory,_that.disasterCategoryEn,_that.disasterCategoryNo,_that.reportTime,_that.informationType,_that.informationTypeEn,_that.informationTypeNo,_that.ambiguityOfActivityTimeNo,_that.activityTime,_that.volcanicWarningCode,_that.volcanicWarningCodeRaw,_that.volcanoName,_that.volcanoNameRaw,_that.localGovernments,_that.localGovernmentsRaw);case QzssDcReportAshFall() when ashFall != null:
return ashFall(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.version,_that.reportClassification,_that.reportClassificationEn,_that.reportClassificationNo,_that.disasterCategory,_that.disasterCategoryEn,_that.disasterCategoryNo,_that.reportTime,_that.informationType,_that.informationTypeEn,_that.informationTypeNo,_that.activityTime,_that.ashFallWarningType,_that.ashFallWarningTypeRaw,_that.volcanoName,_that.volcanoNameRaw,_that.expectedAshFallTimes,_that.ashFallWarningCodes,_that.ashFallWarningCodesRaw,_that.localGovernments,_that.localGovernmentsRaw);case QzssDcReportTyphoon() when typhoon != null:
return typhoon(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.version,_that.reportClassification,_that.reportClassificationEn,_that.reportClassificationNo,_that.disasterCategory,_that.disasterCategoryEn,_that.disasterCategoryNo,_that.reportTime,_that.informationType,_that.informationTypeEn,_that.informationTypeNo,_that.referenceTime,_that.referenceTimeType,_that.referenceTimeTypeRaw,_that.elapsedTimeFromReferenceTime,_that.typhoonNumber,_that.typhoonNumberRaw,_that.typhoonScaleCategory,_that.typhoonScaleCategoryRaw,_that.typhoonIntensityCategory,_that.typhoonIntensityCategoryRaw,_that.coordinatesOfTyphoon,_that.centralPressure,_that.centralPressureRaw,_that.maximumWindSpeed,_that.maximumWindSpeedRaw,_that.maximumGustWindSpeed,_that.maximumGustWindSpeedRaw);case QzssDcReportDcxNull() when dcxNull != null:
return dcxNull(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.dcxMessageType);case QzssDcReportDcxOutsideJapan() when dcxOutsideJapan != null:
return dcxOutsideJapan(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.dcxMessageType);case QzssDcReportDcxLAlert() when dcxLAlert != null:
return dcxLAlert(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.dcxMessageType);case QzssDcReportDcxJAlert() when dcxJAlert != null:
return dcxJAlert(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.dcxMessageType);case QzssDcReportDcxMTInfo() when dcxMTInfo != null:
return dcxMTInfo(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.dcxMessageType);case QzssDcReportDcxUnknown() when dcxUnknown != null:
return dcxUnknown(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.dcxMessageType);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  int version,  String reportClassification,  String reportClassificationEn,  int reportClassificationNo,  String disasterCategory,  String disasterCategoryEn,  int disasterCategoryNo,  DateTime reportTime,  String informationType,  String informationTypeEn,  int informationTypeNo,  String? longPeriodGroundMotionLowerLimit,  int longPeriodGroundMotionLowerLimitRaw,  String? longPeriodGroundMotionUpperLimit,  int longPeriodGroundMotionUpperLimitRaw,  List<String> notificationsOnDisasterPrevention,  List<int> notificationsOnDisasterPreventionRaw,  DateTime occurrenceTimeOfEarthquake,  String depthOfHypocenter,  int depthOfHypocenterRaw,  String magnitude,  int magnitudeRaw,  bool assumptive,  String seismicEpicenter,  int seismicEpicenterRaw,  String seismicIntensityLowerLimit,  int seismicIntensityLowerLimitRaw,  String seismicIntensityUpperLimit,  int seismicIntensityUpperLimitRaw,  List<String> eewForecastRegions,  List<int> eewForecastRegionsRaw)  earthquakeEarlyWarning,required TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  int version,  String reportClassification,  String reportClassificationEn,  int reportClassificationNo,  String disasterCategory,  String disasterCategoryEn,  int disasterCategoryNo,  DateTime reportTime,  String informationType,  String informationTypeEn,  int informationTypeNo,  List<String> notificationsOnDisasterPrevention,  List<int> notificationsOnDisasterPreventionRaw,  DateTime occurrenceTimeOfEarthquake,  String depthOfHypocenter,  int depthOfHypocenterRaw,  String magnitude,  int magnitudeRaw,  String seismicEpicenter,  int seismicEpicenterRaw,  HypocenterCoordinates coordinatesOfHypocenter)  hypocenter,required TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  int version,  String reportClassification,  String reportClassificationEn,  int reportClassificationNo,  String disasterCategory,  String disasterCategoryEn,  int disasterCategoryNo,  DateTime reportTime,  String informationType,  String informationTypeEn,  int informationTypeNo,  DateTime occurrenceTimeOfEarthquake,  List<String> seismicIntensities,  List<int> seismicIntensitiesRaw,  List<String> prefectures,  List<int> prefecturesRaw)  seismicIntensity,required TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  int version,  String reportClassification,  String reportClassificationEn,  int reportClassificationNo,  String disasterCategory,  String disasterCategoryEn,  int disasterCategoryNo,  DateTime reportTime,  String informationType,  String informationTypeEn,  int informationTypeNo,  List<String> notificationsOnDisasterPrevention,  List<int> notificationsOnDisasterPreventionRaw,  String tsunamiWarningCode,  int tsunamiWarningCodeRaw,  List<DateTime?> expectedTsunamiArrivalTimes,  List<String> tsunamiHeights,  List<int> tsunamiHeightsRaw,  List<String> tsunamiForecastRegions,  List<int> tsunamiForecastRegionsRaw)  tsunami,required TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  int version,  String reportClassification,  String reportClassificationEn,  int reportClassificationNo,  String disasterCategory,  String disasterCategoryEn,  int disasterCategoryNo,  DateTime reportTime,  String informationType,  String informationTypeEn,  int informationTypeNo,  String informationSerialCode,  int informationSerialCodeRaw, @Uint8ListConverter()  Uint8List textInformation,  int pageNumber,  int totalPage)  nankaiTroughEarthquake,required TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  int version,  String reportClassification,  String reportClassificationEn,  int reportClassificationNo,  String disasterCategory,  String disasterCategoryEn,  int disasterCategoryNo,  DateTime reportTime,  String informationType,  String informationTypeEn,  int informationTypeNo,  String tsunamigenicPotentialEn,  int tsunamigenicPotentialRaw,  List<DateTime?> expectedTsunamiArrivalTimes,  List<String> tsunamiHeightsEn,  List<int> tsunamiHeightsRaw,  List<String> coastalRegionsEn,  List<int> coastalRegionsRaw)  northwestPacificTsunami,required TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  int version,  String reportClassification,  String reportClassificationEn,  int reportClassificationNo,  String disasterCategory,  String disasterCategoryEn,  int disasterCategoryNo,  DateTime reportTime,  String informationType,  String informationTypeEn,  int informationTypeNo,  List<String> floodWarningLevels,  List<int> floodWarningLevelsRaw,  List<String> floodForecastRegions,  List<int> floodForecastRegionsRaw)  flood,required TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  int version,  String reportClassification,  String reportClassificationEn,  int reportClassificationNo,  String disasterCategory,  String disasterCategoryEn,  int disasterCategoryNo,  DateTime reportTime,  String informationType,  String informationTypeEn,  int informationTypeNo,  List<String> marineWarningCodes,  List<int> marineWarningCodesRaw,  List<String> marineForecastRegions,  List<int> marineForecastRegionsRaw)  marine,required TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  int version,  String reportClassification,  String reportClassificationEn,  int reportClassificationNo,  String disasterCategory,  String disasterCategoryEn,  int disasterCategoryNo,  DateTime reportTime,  String informationType,  String informationTypeEn,  int informationTypeNo,  String weatherWarningState,  int weatherWarningStateRaw,  List<String> weatherRelatedDisasterSubCategories,  List<int> weatherRelatedDisasterSubCategoriesRaw,  List<String> weatherForecastRegions,  List<int> weatherForecastRegionsRaw)  weather,required TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  int version,  String reportClassification,  String reportClassificationEn,  int reportClassificationNo,  String disasterCategory,  String disasterCategoryEn,  int disasterCategoryNo,  DateTime reportTime,  String informationType,  String informationTypeEn,  int informationTypeNo,  int ambiguityOfActivityTimeNo,  DateTime activityTime,  String volcanicWarningCode,  int volcanicWarningCodeRaw,  String volcanoName,  int volcanoNameRaw,  List<String> localGovernments,  List<int> localGovernmentsRaw)  volcano,required TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  int version,  String reportClassification,  String reportClassificationEn,  int reportClassificationNo,  String disasterCategory,  String disasterCategoryEn,  int disasterCategoryNo,  DateTime reportTime,  String informationType,  String informationTypeEn,  int informationTypeNo,  DateTime activityTime,  String ashFallWarningType,  int ashFallWarningTypeRaw,  String volcanoName,  int volcanoNameRaw,  List<int> expectedAshFallTimes,  List<String> ashFallWarningCodes,  List<int> ashFallWarningCodesRaw,  List<String> localGovernments,  List<int> localGovernmentsRaw)  ashFall,required TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  int version,  String reportClassification,  String reportClassificationEn,  int reportClassificationNo,  String disasterCategory,  String disasterCategoryEn,  int disasterCategoryNo,  DateTime reportTime,  String informationType,  String informationTypeEn,  int informationTypeNo,  DateTime referenceTime,  String referenceTimeType,  int referenceTimeTypeRaw,  int elapsedTimeFromReferenceTime,  String typhoonNumber,  int typhoonNumberRaw,  String typhoonScaleCategory,  int typhoonScaleCategoryRaw,  String typhoonIntensityCategory,  int typhoonIntensityCategoryRaw,  HypocenterCoordinates coordinatesOfTyphoon,  String centralPressure,  int centralPressureRaw,  String maximumWindSpeed,  int maximumWindSpeedRaw,  String maximumGustWindSpeed,  int maximumGustWindSpeedRaw)  typhoon,required TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  String dcxMessageType)  dcxNull,required TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  String dcxMessageType)  dcxOutsideJapan,required TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  String dcxMessageType)  dcxLAlert,required TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  String dcxMessageType)  dcxJAlert,required TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  String dcxMessageType)  dcxMTInfo,required TResult Function( String sentence, @Uint8ListConverter()  Uint8List message,  String nmea,  String? messageHeader,  int? satelliteId,  int? satellitePrn, @Uint8ListConverter()  Uint8List raw,  String preamble,  String messageType,  String dcxMessageType)  dcxUnknown,}) {final _that = this;
switch (_that) {
case QzssDcReportEarthquakeEarlyWarning():
return earthquakeEarlyWarning(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.version,_that.reportClassification,_that.reportClassificationEn,_that.reportClassificationNo,_that.disasterCategory,_that.disasterCategoryEn,_that.disasterCategoryNo,_that.reportTime,_that.informationType,_that.informationTypeEn,_that.informationTypeNo,_that.longPeriodGroundMotionLowerLimit,_that.longPeriodGroundMotionLowerLimitRaw,_that.longPeriodGroundMotionUpperLimit,_that.longPeriodGroundMotionUpperLimitRaw,_that.notificationsOnDisasterPrevention,_that.notificationsOnDisasterPreventionRaw,_that.occurrenceTimeOfEarthquake,_that.depthOfHypocenter,_that.depthOfHypocenterRaw,_that.magnitude,_that.magnitudeRaw,_that.assumptive,_that.seismicEpicenter,_that.seismicEpicenterRaw,_that.seismicIntensityLowerLimit,_that.seismicIntensityLowerLimitRaw,_that.seismicIntensityUpperLimit,_that.seismicIntensityUpperLimitRaw,_that.eewForecastRegions,_that.eewForecastRegionsRaw);case QzssDcReportHypocenter():
return hypocenter(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.version,_that.reportClassification,_that.reportClassificationEn,_that.reportClassificationNo,_that.disasterCategory,_that.disasterCategoryEn,_that.disasterCategoryNo,_that.reportTime,_that.informationType,_that.informationTypeEn,_that.informationTypeNo,_that.notificationsOnDisasterPrevention,_that.notificationsOnDisasterPreventionRaw,_that.occurrenceTimeOfEarthquake,_that.depthOfHypocenter,_that.depthOfHypocenterRaw,_that.magnitude,_that.magnitudeRaw,_that.seismicEpicenter,_that.seismicEpicenterRaw,_that.coordinatesOfHypocenter);case QzssDcReportSeismicIntensity():
return seismicIntensity(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.version,_that.reportClassification,_that.reportClassificationEn,_that.reportClassificationNo,_that.disasterCategory,_that.disasterCategoryEn,_that.disasterCategoryNo,_that.reportTime,_that.informationType,_that.informationTypeEn,_that.informationTypeNo,_that.occurrenceTimeOfEarthquake,_that.seismicIntensities,_that.seismicIntensitiesRaw,_that.prefectures,_that.prefecturesRaw);case QzssDcReportTsunami():
return tsunami(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.version,_that.reportClassification,_that.reportClassificationEn,_that.reportClassificationNo,_that.disasterCategory,_that.disasterCategoryEn,_that.disasterCategoryNo,_that.reportTime,_that.informationType,_that.informationTypeEn,_that.informationTypeNo,_that.notificationsOnDisasterPrevention,_that.notificationsOnDisasterPreventionRaw,_that.tsunamiWarningCode,_that.tsunamiWarningCodeRaw,_that.expectedTsunamiArrivalTimes,_that.tsunamiHeights,_that.tsunamiHeightsRaw,_that.tsunamiForecastRegions,_that.tsunamiForecastRegionsRaw);case QzssDcReportNankaiTroughEarthquake():
return nankaiTroughEarthquake(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.version,_that.reportClassification,_that.reportClassificationEn,_that.reportClassificationNo,_that.disasterCategory,_that.disasterCategoryEn,_that.disasterCategoryNo,_that.reportTime,_that.informationType,_that.informationTypeEn,_that.informationTypeNo,_that.informationSerialCode,_that.informationSerialCodeRaw,_that.textInformation,_that.pageNumber,_that.totalPage);case QzssDcReportNorthwestPacificTsunami():
return northwestPacificTsunami(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.version,_that.reportClassification,_that.reportClassificationEn,_that.reportClassificationNo,_that.disasterCategory,_that.disasterCategoryEn,_that.disasterCategoryNo,_that.reportTime,_that.informationType,_that.informationTypeEn,_that.informationTypeNo,_that.tsunamigenicPotentialEn,_that.tsunamigenicPotentialRaw,_that.expectedTsunamiArrivalTimes,_that.tsunamiHeightsEn,_that.tsunamiHeightsRaw,_that.coastalRegionsEn,_that.coastalRegionsRaw);case QzssDcReportFlood():
return flood(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.version,_that.reportClassification,_that.reportClassificationEn,_that.reportClassificationNo,_that.disasterCategory,_that.disasterCategoryEn,_that.disasterCategoryNo,_that.reportTime,_that.informationType,_that.informationTypeEn,_that.informationTypeNo,_that.floodWarningLevels,_that.floodWarningLevelsRaw,_that.floodForecastRegions,_that.floodForecastRegionsRaw);case QzssDcReportMarine():
return marine(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.version,_that.reportClassification,_that.reportClassificationEn,_that.reportClassificationNo,_that.disasterCategory,_that.disasterCategoryEn,_that.disasterCategoryNo,_that.reportTime,_that.informationType,_that.informationTypeEn,_that.informationTypeNo,_that.marineWarningCodes,_that.marineWarningCodesRaw,_that.marineForecastRegions,_that.marineForecastRegionsRaw);case QzssDcReportWeather():
return weather(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.version,_that.reportClassification,_that.reportClassificationEn,_that.reportClassificationNo,_that.disasterCategory,_that.disasterCategoryEn,_that.disasterCategoryNo,_that.reportTime,_that.informationType,_that.informationTypeEn,_that.informationTypeNo,_that.weatherWarningState,_that.weatherWarningStateRaw,_that.weatherRelatedDisasterSubCategories,_that.weatherRelatedDisasterSubCategoriesRaw,_that.weatherForecastRegions,_that.weatherForecastRegionsRaw);case QzssDcReportVolcano():
return volcano(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.version,_that.reportClassification,_that.reportClassificationEn,_that.reportClassificationNo,_that.disasterCategory,_that.disasterCategoryEn,_that.disasterCategoryNo,_that.reportTime,_that.informationType,_that.informationTypeEn,_that.informationTypeNo,_that.ambiguityOfActivityTimeNo,_that.activityTime,_that.volcanicWarningCode,_that.volcanicWarningCodeRaw,_that.volcanoName,_that.volcanoNameRaw,_that.localGovernments,_that.localGovernmentsRaw);case QzssDcReportAshFall():
return ashFall(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.version,_that.reportClassification,_that.reportClassificationEn,_that.reportClassificationNo,_that.disasterCategory,_that.disasterCategoryEn,_that.disasterCategoryNo,_that.reportTime,_that.informationType,_that.informationTypeEn,_that.informationTypeNo,_that.activityTime,_that.ashFallWarningType,_that.ashFallWarningTypeRaw,_that.volcanoName,_that.volcanoNameRaw,_that.expectedAshFallTimes,_that.ashFallWarningCodes,_that.ashFallWarningCodesRaw,_that.localGovernments,_that.localGovernmentsRaw);case QzssDcReportTyphoon():
return typhoon(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.version,_that.reportClassification,_that.reportClassificationEn,_that.reportClassificationNo,_that.disasterCategory,_that.disasterCategoryEn,_that.disasterCategoryNo,_that.reportTime,_that.informationType,_that.informationTypeEn,_that.informationTypeNo,_that.referenceTime,_that.referenceTimeType,_that.referenceTimeTypeRaw,_that.elapsedTimeFromReferenceTime,_that.typhoonNumber,_that.typhoonNumberRaw,_that.typhoonScaleCategory,_that.typhoonScaleCategoryRaw,_that.typhoonIntensityCategory,_that.typhoonIntensityCategoryRaw,_that.coordinatesOfTyphoon,_that.centralPressure,_that.centralPressureRaw,_that.maximumWindSpeed,_that.maximumWindSpeedRaw,_that.maximumGustWindSpeed,_that.maximumGustWindSpeedRaw);case QzssDcReportDcxNull():
return dcxNull(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.dcxMessageType);case QzssDcReportDcxOutsideJapan():
return dcxOutsideJapan(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.dcxMessageType);case QzssDcReportDcxLAlert():
return dcxLAlert(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.dcxMessageType);case QzssDcReportDcxJAlert():
return dcxJAlert(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.dcxMessageType);case QzssDcReportDcxMTInfo():
return dcxMTInfo(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.dcxMessageType);case QzssDcReportDcxUnknown():
return dcxUnknown(_that.sentence,_that.message,_that.nmea,_that.messageHeader,_that.satelliteId,_that.satellitePrn,_that.raw,_that.preamble,_that.messageType,_that.dcxMessageType);}
}
...
class QzssDcReportHypocenter extends QzssDcReport {
  const QzssDcReportHypocenter({required this.sentence, @Uint8ListConverter() required this.message, required this.nmea, this.messageHeader, this.satelliteId, this.satellitePrn, @Uint8ListConverter() required this.raw, required this.preamble, required this.messageType, required this.version, required this.reportClassification, required this.reportClassificationEn, required this.reportClassificationNo, required this.disasterCategory, required this.disasterCategoryEn, required this.disasterCategoryNo, required this.reportTime, required this.informationType, required this.informationTypeEn, required this.informationTypeNo, required final  List<String> notificationsOnDisasterPrevention, required final  List<int> notificationsOnDisasterPreventionRaw, required this.occurrenceTimeOfEarthquake, required this.depthOfHypocenter, required this.depthOfHypocenterRaw, required this.magnitude, required this.magnitudeRaw, required this.seismicEpicenter, required this.seismicEpicenterRaw, required this.coordinatesOfHypocenter, final  String? $type}): _notificationsOnDisasterPrevention = notificationsOnDisasterPrevention,_notificationsOnDisasterPreventionRaw = notificationsOnDisasterPreventionRaw,$type = $type ?? 'hypocenter',super._();
...
@override @useResult
$Res call({
 String sentence,@Uint8ListConverter() Uint8List message, String nmea, String? messageHeader, int? satelliteId, int? satellitePrn,@Uint8ListConverter() Uint8List raw, String preamble, String messageType, int version, String reportClassification, String reportClassificationEn, int reportClassificationNo, String disasterCategory, String disasterCategoryEn, int disasterCategoryNo, DateTime reportTime, String informationType, String informationTypeEn, int informationTypeNo, List<String> notificationsOnDisasterPrevention, List<int> notificationsOnDisasterPreventionRaw, DateTime occurrenceTimeOfEarthquake, String depthOfHypocenter, int depthOfHypocenterRaw, String magnitude, int magnitudeRaw, String seismicEpicenter, int seismicEpicenterRaw, HypocenterCoordinates coordinatesOfHypocenter
});
...
/// Create a copy of QzssDcReport
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? sentence = null,Object? message = null,Object? nmea = null,Object? messageHeader = freezed,Object? satelliteId = freezed,Object? satellitePrn = freezed,Object? raw = null,Object? preamble = null,Object? messageType = null,Object? version = null,Object? reportClassification = null,Object? reportClassificationEn = null,Object? reportClassificationNo = null,Object? disasterCategory = null,Object? disasterCategoryEn = null,Object? disasterCategoryNo = null,Object? reportTime = null,Object? informationType = null,Object? informationTypeEn = null,Object? informationTypeNo = null,Object? notificationsOnDisasterPrevention = null,Object? notificationsOnDisasterPreventionRaw = null,Object? occurrenceTimeOfEarthquake = null,Object? depthOfHypocenter = null,Object? depthOfHypocenterRaw = null,Object? magnitude = null,Object? magnitudeRaw = null,Object? seismicEpicenter = null,Object? seismicEpicenterRaw = null,Object? coordinatesOfHypocenter = null,}) {
...
@override @useResult
$Res call({
 String sentence,@Uint8ListConverter() Uint8List message, String nmea, String? messageHeader, int? satelliteId, int? satellitePrn,@Uint8ListConverter() Uint8List raw, String preamble, String messageType, int version, String reportClassification, String reportClassificationEn, int reportClassificationNo, String disasterCategory, String disasterCategoryEn, int disasterCategoryNo, DateTime reportTime, String informationType, String informationTypeEn, int informationTypeNo, DateTime occurrenceTimeOfEarthquake, List<String> seismicIntensities, List<int> seismicIntensitiesRaw, List<String> prefectures, List<int> prefecturesRaw
});
...
/// Create a copy of QzssDcReport
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? sentence = null,Object? message = null,Object? nmea = null,Object? messageHeader = freezed,Object? satelliteId = freezed,Object? satellitePrn = freezed,Object? raw = null,Object? preamble = null,Object? messageType = null,Object? version = null,Object? reportClassification = null,Object? reportClassificationEn = null,Object? reportClassificationNo = null,Object? disasterCategory = null,Object? disasterCategoryEn = null,Object? disasterCategoryNo = null,Object? reportTime = null,Object? informationType = null,Object? informationTypeEn = null,Object? informationTypeNo = null,Object? occurrenceTimeOfEarthquake = null,Object? seismicIntensities = null,Object? seismicIntensitiesRaw = null,Object? prefectures = null,Object? prefecturesRaw = null,}) {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is QzssDcReportTsunami&&(identical(other.sentence, sentence) || other.sentence == sentence)&&const DeepCollectionEquality().equals(other.message, message)&&(identical(other.nmea, nmea) || other.nmea == nmea)&&(identical(other.messageHeader, messageHeader) || other.messageHeader == messageHeader)&&(identical(other.satelliteId, satelliteId) || other.satelliteId == satelliteId)&&(identical(other.satellitePrn, satellitePrn) || other.satellitePrn == satellitePrn)&&const DeepCollectionEquality().equals(other.raw, raw)&&(identical(other.preamble, preamble) || other.preamble == preamble)&&(identical(other.messageType, messageType) || other.messageType == messageType)&&(identical(other.version, version) || other.version == version)&&(identical(other.reportClassification, reportClassification) || other.reportClassification == reportClassification)&&(identical(other.reportClassificationEn, reportClassificationEn) || other.reportClassificationEn == reportClassificationEn)&&(identical(other.reportClassificationNo, reportClassificationNo) || other.reportClassificationNo == reportClassificationNo)&&(identical(other.disasterCategory, disasterCategory) || other.disasterCategory == disasterCategory)&&(identical(other.disasterCategoryEn, disasterCategoryEn) || other.disasterCategoryEn == disasterCategoryEn)&&(identical(other.disasterCategoryNo, disasterCategoryNo) || other.disasterCategoryNo == disasterCategoryNo)&&(identical(other.reportTime, reportTime) || other.reportTime == reportTime)&&(identical(other.informationType, informationType) || other.informationType == informationType)&&(identical(other.informationTypeEn, informationTypeEn) || other.informationTypeEn == informationTypeEn)&&(identical(other.informationTypeNo, informationTypeNo) || other.informationTypeNo == informationTypeNo)&&const DeepCollectionEquality().equals(other._notificationsOnDisasterPrevention, _notificationsOnDisasterPrevention)&&const DeepCollectionEquality().equals(other._notificationsOnDisasterPreventionRaw, _notificationsOnDisasterPreventionRaw)&&(identical(other.tsunamiWarningCode, tsunamiWarningCode) || other.tsunamiWarningCode == tsunamiWarningCode)&&(identical(other.tsunamiWarningCodeRaw, tsunamiWarningCodeRaw) || other.tsunamiWarningCodeRaw == tsunamiWarningCodeRaw)&&const DeepCollectionEquality().equals(other._expectedTsunamiArrivalTimes, _expectedTsunamiArrivalTimes)&&const DeepCollectionEquality().equals(other._tsunamiHeights, _tsunamiHeights)&&const DeepCollectionEquality().equals(other._tsunamiHeightsRaw, _tsunamiHeightsRaw)&&const DeepCollectionEquality().equals(other._tsunamiForecastRegions, _tsunamiForecastRegions)&&const DeepCollectionEquality().equals(other._tsunamiForecastRegionsRaw, _tsunamiForecastRegionsRaw));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,sentence,const DeepCollectionEquality().hash(message),nmea,messageHeader,satelliteId,satellitePrn,const DeepCollectionEquality().hash(raw),preamble,messageType,version,reportClassification,reportClassificationEn,reportClassificationNo,disasterCategory,disasterCategoryEn,disasterCategoryNo,reportTime,informationType,informationTypeEn,informationTypeNo,const DeepCollectionEquality().hash(_notificationsOnDisasterPrevention),const DeepCollectionEquality().hash(_notificationsOnDisasterPreventionRaw),tsunamiWarningCode,tsunamiWarningCodeRaw,const DeepCollectionEquality().hash(_expectedTsunamiArrivalTimes),const DeepCollectionEquality().hash(_tsunamiHeights),const DeepCollectionEquality().hash(_tsunamiHeightsRaw),const DeepCollectionEquality().hash(_tsunamiForecastRegions),const DeepCollectionEquality().hash(_tsunamiForecastRegionsRaw)]);

@override
String toString() {
  return 'QzssDcReport.tsunami(sentence: $sentence, message: $message, nmea: $nmea, messageHeader: $messageHeader, satelliteId: $satelliteId, satellitePrn: $satellitePrn, raw: $raw, preamble: $preamble, messageType: $messageType, version: $version, reportClassification: $reportClassification, reportClassificationEn: $reportClassificationEn, reportClassificationNo: $reportClassificationNo, disasterCategory: $disasterCategory, disasterCategoryEn: $disasterCategoryEn, disasterCategoryNo: $disasterCategoryNo, reportTime: $reportTime, informationType: $informationType, informationTypeEn: $informationTypeEn, informationTypeNo: $informationTypeNo, notificationsOnDisasterPrevention: $notificationsOnDisasterPrevention, notificationsOnDisasterPreventionRaw: $notificationsOnDisasterPreventionRaw, tsunamiWarningCode: $tsunamiWarningCode, tsunamiWarningCodeRaw: $tsunamiWarningCodeRaw, expectedTsunamiArrivalTimes: $expectedTsunamiArrivalTimes, tsunamiHeights: $tsunamiHeights, tsunamiHeightsRaw: $tsunamiHeightsRaw, tsunamiForecastRegions: $tsunamiForecastRegions, tsunamiForecastRegionsRaw: $tsunamiForecastRegionsRaw)';
}
...
@override @useResult
$Res call({
 String sentence,@Uint8ListConverter() Uint8List message, String nmea, String? messageHeader, int? satelliteId, int? satellitePrn,@Uint8ListConverter() Uint8List raw, String preamble, String messageType, int version, String reportClassification, String reportClassificationEn, int reportClassificationNo, String disasterCategory, String disasterCategoryEn, int disasterCategoryNo, DateTime reportTime, String informationType, String informationTypeEn, int informationTypeNo, List<String> notificationsOnDisasterPrevention, List<int> notificationsOnDisasterPreventionRaw, String tsunamiWarningCode, int tsunamiWarningCodeRaw, List<DateTime?> expectedTsunamiArrivalTimes, List<String> tsunamiHeights, List<int> tsunamiHeightsRaw, List<String> tsunamiForecastRegions, List<int> tsunamiForecastRegionsRaw
});
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,sentence,const DeepCollectionEquality().hash(message),nmea,messageHeader,satelliteId,satellitePrn,const DeepCollectionEquality().hash(raw),preamble,messageType,version,reportClassification,reportClassificationEn,reportClassificationNo,disasterCategory,disasterCategoryEn,disasterCategoryNo,reportTime,informationType,informationTypeEn,informationTypeNo,informationSerialCode,informationSerialCodeRaw,const DeepCollectionEquality().hash(textInformation),pageNumber,totalPage]);

@override
String toString() {
  return 'QzssDcReport.nankaiTroughEarthquake(sentence: $sentence, message: $message, nmea: $nmea, messageHeader: $messageHeader, satelliteId: $satelliteId, satellitePrn: $satellitePrn, raw: $raw, preamble: $preamble, messageType: $messageType, version: $version, reportClassification: $reportClassification, reportClassificationEn: $reportClassificationEn, reportClassificationNo: $reportClassificationNo, disasterCategory: $disasterCategory, disasterCategoryEn: $disasterCategoryEn, disasterCategoryNo: $disasterCategoryNo, reportTime: $reportTime, informationType: $informationType, informationTypeEn: $informationTypeEn, informationTypeNo: $informationTypeNo, informationSerialCode: $informationSerialCode, informationSerialCodeRaw: $informationSerialCodeRaw, textInformation: $textInformation, pageNumber: $pageNumber, totalPage: $totalPage)';
}
...
/// Create a copy of QzssDcReport
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? sentence = null,Object? message = null,Object? nmea = null,Object? messageHeader = freezed,Object? satelliteId = freezed,Object? satellitePrn = freezed,Object? raw = null,Object? preamble = null,Object? messageType = null,Object? version = null,Object? reportClassification = null,Object? reportClassificationEn = null,Object? reportClassificationNo = null,Object? disasterCategory = null,Object? disasterCategoryEn = null,Object? disasterCategoryNo = null,Object? reportTime = null,Object? informationType = null,Object? informationTypeEn = null,Object? informationTypeNo = null,Object? informationSerialCode = null,Object? informationSerialCodeRaw = null,Object? textInformation = null,Object? pageNumber = null,Object? totalPage = null,}) {
...
class QzssDcReportNorthwestPacificTsunami extends QzssDcReport {
  const QzssDcReportNorthwestPacificTsunami({required this.sentence, @Uint8ListConverter() required this.message, required this.nmea, this.messageHeader, this.satelliteId, this.satellitePrn, @Uint8ListConverter() required this.raw, required this.preamble, required this.messageType, required this.version, required this.reportClassification, required this.reportClassificationEn, required this.reportClassificationNo, required this.disasterCategory, required this.disasterCategoryEn, required this.disasterCategoryNo, required this.reportTime, required this.informationType, required this.informationTypeEn, required this.informationTypeNo, required this.tsunamigenicPotentialEn, required this.tsunamigenicPotentialRaw, required final  List<DateTime?> expectedTsunamiArrivalTimes, required final  List<String> tsunamiHeightsEn, required final  List<int> tsunamiHeightsRaw, required final  List<String> coastalRegionsEn, required final  List<int> coastalRegionsRaw, final  String? $type}): _expectedTsunamiArrivalTimes = expectedTsunamiArrivalTimes,_tsunamiHeightsEn = tsunamiHeightsEn,_tsunamiHeightsRaw = tsunamiHeightsRaw,_coastalRegionsEn = coastalRegionsEn,_coastalRegionsRaw = coastalRegionsRaw,$type = $type ?? 'northwestPacificTsunami',super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is QzssDcReportNorthwestPacificTsunami&&(identical(other.sentence, sentence) || other.sentence == sentence)&&const DeepCollectionEquality().equals(other.message, message)&&(identical(other.nmea, nmea) || other.nmea == nmea)&&(identical(other.messageHeader, messageHeader) || other.messageHeader == messageHeader)&&(identical(other.satelliteId, satelliteId) || other.satelliteId == satelliteId)&&(identical(other.satellitePrn, satellitePrn) || other.satellitePrn == satellitePrn)&&const DeepCollectionEquality().equals(other.raw, raw)&&(identical(other.preamble, preamble) || other.preamble == preamble)&&(identical(other.messageType, messageType) || other.messageType == messageType)&&(identical(other.version, version) || other.version == version)&&(identical(other.reportClassification, reportClassification) || other.reportClassification == reportClassification)&&(identical(other.reportClassificationEn, reportClassificationEn) || other.reportClassificationEn == reportClassificationEn)&&(identical(other.reportClassificationNo, reportClassificationNo) || other.reportClassificationNo == reportClassificationNo)&&(identical(other.disasterCategory, disasterCategory) || other.disasterCategory == disasterCategory)&&(identical(other.disasterCategoryEn, disasterCategoryEn) || other.disasterCategoryEn == disasterCategoryEn)&&(identical(other.disasterCategoryNo, disasterCategoryNo) || other.disasterCategoryNo == disasterCategoryNo)&&(identical(other.reportTime, reportTime) || other.reportTime == reportTime)&&(identical(other.informationType, informationType) || other.informationType == informationType)&&(identical(other.informationTypeEn, informationTypeEn) || other.informationTypeEn == informationTypeEn)&&(identical(other.informationTypeNo, informationTypeNo) || other.informationTypeNo == informationTypeNo)&&(identical(other.tsunamigenicPotentialEn, tsunamigenicPotentialEn) || other.tsunamigenicPotentialEn == tsunamigenicPotentialEn)&&(identical(other.tsunamigenicPotentialRaw, tsunamigenicPotentialRaw) || other.tsunamigenicPotentialRaw == tsunamigenicPotentialRaw)&&const DeepCollectionEquality().equals(other._expectedTsunamiArrivalTimes, _expectedTsunamiArrivalTimes)&&const DeepCollectionEquality().equals(other._tsunamiHeightsEn, _tsunamiHeightsEn)&&const DeepCollectionEquality().equals(other._tsunamiHeightsRaw, _tsunamiHeightsRaw)&&const DeepCollectionEquality().equals(other._coastalRegionsEn, _coastalRegionsEn)&&const DeepCollectionEquality().equals(other._coastalRegionsRaw, _coastalRegionsRaw));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,sentence,const DeepCollectionEquality().hash(message),nmea,messageHeader,satelliteId,satellitePrn,const DeepCollectionEquality().hash(raw),preamble,messageType,version,reportClassification,reportClassificationEn,reportClassificationNo,disasterCategory,disasterCategoryEn,disasterCategoryNo,reportTime,informationType,informationTypeEn,informationTypeNo,tsunamigenicPotentialEn,tsunamigenicPotentialRaw,const DeepCollectionEquality().hash(_expectedTsunamiArrivalTimes),const DeepCollectionEquality().hash(_tsunamiHeightsEn),const DeepCollectionEquality().hash(_tsunamiHeightsRaw),const DeepCollectionEquality().hash(_coastalRegionsEn),const DeepCollectionEquality().hash(_coastalRegionsRaw)]);

@override
String toString() {
  return 'QzssDcReport.northwestPacificTsunami(sentence: $sentence, message: $message, nmea: $nmea, messageHeader: $messageHeader, satelliteId: $satelliteId, satellitePrn: $satellitePrn, raw: $raw, preamble: $preamble, messageType: $messageType, version: $version, reportClassification: $reportClassification, reportClassificationEn: $reportClassificationEn, reportClassificationNo: $reportClassificationNo, disasterCategory: $disasterCategory, disasterCategoryEn: $disasterCategoryEn, disasterCategoryNo: $disasterCategoryNo, reportTime: $reportTime, informationType: $informationType, informationTypeEn: $informationTypeEn, informationTypeNo: $informationTypeNo, tsunamigenicPotentialEn: $tsunamigenicPotentialEn, tsunamigenicPotentialRaw: $tsunamigenicPotentialRaw, expectedTsunamiArrivalTimes: $expectedTsunamiArrivalTimes, tsunamiHeightsEn: $tsunamiHeightsEn, tsunamiHeightsRaw: $tsunamiHeightsRaw, coastalRegionsEn: $coastalRegionsEn, coastalRegionsRaw: $coastalRegionsRaw)';
}
...
class QzssDcReportFlood extends QzssDcReport {
  const QzssDcReportFlood({required this.sentence, @Uint8ListConverter() required this.message, required this.nmea, this.messageHeader, this.satelliteId, this.satellitePrn, @Uint8ListConverter() required this.raw, required this.preamble, required this.messageType, required this.version, required this.reportClassification, required this.reportClassificationEn, required this.reportClassificationNo, required this.disasterCategory, required this.disasterCategoryEn, required this.disasterCategoryNo, required this.reportTime, required this.informationType, required this.informationTypeEn, required this.informationTypeNo, required final  List<String> floodWarningLevels, required final  List<int> floodWarningLevelsRaw, required final  List<String> floodForecastRegions, required final  List<int> floodForecastRegionsRaw, final  String? $type}): _floodWarningLevels = floodWarningLevels,_floodWarningLevelsRaw = floodWarningLevelsRaw,_floodForecastRegions = floodForecastRegions,_floodForecastRegionsRaw = floodForecastRegionsRaw,$type = $type ?? 'flood',super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is QzssDcReportFlood&&(identical(other.sentence, sentence) || other.sentence == sentence)&&const DeepCollectionEquality().equals(other.message, message)&&(identical(other.nmea, nmea) || other.nmea == nmea)&&(identical(other.messageHeader, messageHeader) || other.messageHeader == messageHeader)&&(identical(other.satelliteId, satelliteId) || other.satelliteId == satelliteId)&&(identical(other.satellitePrn, satellitePrn) || other.satellitePrn == satellitePrn)&&const DeepCollectionEquality().equals(other.raw, raw)&&(identical(other.preamble, preamble) || other.preamble == preamble)&&(identical(other.messageType, messageType) || other.messageType == messageType)&&(identical(other.version, version) || other.version == version)&&(identical(other.reportClassification, reportClassification) || other.reportClassification == reportClassification)&&(identical(other.reportClassificationEn, reportClassificationEn) || other.reportClassificationEn == reportClassificationEn)&&(identical(other.reportClassificationNo, reportClassificationNo) || other.reportClassificationNo == reportClassificationNo)&&(identical(other.disasterCategory, disasterCategory) || other.disasterCategory == disasterCategory)&&(identical(other.disasterCategoryEn, disasterCategoryEn) || other.disasterCategoryEn == disasterCategoryEn)&&(identical(other.disasterCategoryNo, disasterCategoryNo) || other.disasterCategoryNo == disasterCategoryNo)&&(identical(other.reportTime, reportTime) || other.reportTime == reportTime)&&(identical(other.informationType, informationType) || other.informationType == informationType)&&(identical(other.informationTypeEn, informationTypeEn) || other.informationTypeEn == informationTypeEn)&&(identical(other.informationTypeNo, informationTypeNo) || other.informationTypeNo == informationTypeNo)&&const DeepCollectionEquality().equals(other._floodWarningLevels, _floodWarningLevels)&&const DeepCollectionEquality().equals(other._floodWarningLevelsRaw, _floodWarningLevelsRaw)&&const DeepCollectionEquality().equals(other._floodForecastRegions, _floodForecastRegions)&&const DeepCollectionEquality().equals(other._floodForecastRegionsRaw, _floodForecastRegionsRaw));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,sentence,const DeepCollectionEquality().hash(message),nmea,messageHeader,satelliteId,satellitePrn,const DeepCollectionEquality().hash(raw),preamble,messageType,version,reportClassification,reportClassificationEn,reportClassificationNo,disasterCategory,disasterCategoryEn,disasterCategoryNo,reportTime,informationType,informationTypeEn,informationTypeNo,const DeepCollectionEquality().hash(_floodWarningLevels),const DeepCollectionEquality().hash(_floodWarningLevelsRaw),const DeepCollectionEquality().hash(_floodForecastRegions),const DeepCollectionEquality().hash(_floodForecastRegionsRaw)]);

@override
String toString() {
  return 'QzssDcReport.flood(sentence: $sentence, message: $message, nmea: $nmea, messageHeader: $messageHeader, satelliteId: $satelliteId, satellitePrn: $satellitePrn, raw: $raw, preamble: $preamble, messageType: $messageType, version: $version, reportClassification: $reportClassification, reportClassificationEn: $reportClassificationEn, reportClassificationNo: $reportClassificationNo, disasterCategory: $disasterCategory, disasterCategoryEn: $disasterCategoryEn, disasterCategoryNo: $disasterCategoryNo, reportTime: $reportTime, informationType: $informationType, informationTypeEn: $informationTypeEn, informationTypeNo: $informationTypeNo, floodWarningLevels: $floodWarningLevels, floodWarningLevelsRaw: $floodWarningLevelsRaw, floodForecastRegions: $floodForecastRegions, floodForecastRegionsRaw: $floodForecastRegionsRaw)';
}
...
@override @useResult
$Res call({
 String sentence,@Uint8ListConverter() Uint8List message, String nmea, String? messageHeader, int? satelliteId, int? satellitePrn,@Uint8ListConverter() Uint8List raw, String preamble, String messageType, int version, String reportClassification, String reportClassificationEn, int reportClassificationNo, String disasterCategory, String disasterCategoryEn, int disasterCategoryNo, DateTime reportTime, String informationType, String informationTypeEn, int informationTypeNo, List<String> floodWarningLevels, List<int> floodWarningLevelsRaw, List<String> floodForecastRegions, List<int> floodForecastRegionsRaw
});
...
/// Create a copy of QzssDcReport
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? sentence = null,Object? message = null,Object? nmea = null,Object? messageHeader = freezed,Object? satelliteId = freezed,Object? satellitePrn = freezed,Object? raw = null,Object? preamble = null,Object? messageType = null,Object? version = null,Object? reportClassification = null,Object? reportClassificationEn = null,Object? reportClassificationNo = null,Object? disasterCategory = null,Object? disasterCategoryEn = null,Object? disasterCategoryNo = null,Object? reportTime = null,Object? informationType = null,Object? informationTypeEn = null,Object? informationTypeNo = null,Object? floodWarningLevels = null,Object? floodWarningLevelsRaw = null,Object? floodForecastRegions = null,Object? floodForecastRegionsRaw = null,}) {
...
class QzssDcReportMarine extends QzssDcReport {
  const QzssDcReportMarine({required this.sentence, @Uint8ListConverter() required this.message, required this.nmea, this.messageHeader, this.satelliteId, this.satellitePrn, @Uint8ListConverter() required this.raw, required this.preamble, required this.messageType, required this.version, required this.reportClassification, required this.reportClassificationEn, required this.reportClassificationNo, required this.disasterCategory, required this.disasterCategoryEn, required this.disasterCategoryNo, required this.reportTime, required this.informationType, required this.informationTypeEn, required this.informationTypeNo, required final  List<String> marineWarningCodes, required final  List<int> marineWarningCodesRaw, required final  List<String> marineForecastRegions, required final  List<int> marineForecastRegionsRaw, final  String? $type}): _marineWarningCodes = marineWarningCodes,_marineWarningCodesRaw = marineWarningCodesRaw,_marineForecastRegions = marineForecastRegions,_marineForecastRegionsRaw = marineForecastRegionsRaw,$type = $type ?? 'marine',super._();
...
@override @useResult
$Res call({
 String sentence,@Uint8ListConverter() Uint8List message, String nmea, String? messageHeader, int? satelliteId, int? satellitePrn,@Uint8ListConverter() Uint8List raw, String preamble, String messageType, int version, String reportClassification, String reportClassificationEn, int reportClassificationNo, String disasterCategory, String disasterCategoryEn, int disasterCategoryNo, DateTime reportTime, String informationType, String informationTypeEn, int informationTypeNo, List<String> marineWarningCodes, List<int> marineWarningCodesRaw, List<String> marineForecastRegions, List<int> marineForecastRegionsRaw
});
...
class QzssDcReportWeather extends QzssDcReport {
  const QzssDcReportWeather({required this.sentence, @Uint8ListConverter() required this.message, required this.nmea, this.messageHeader, this.satelliteId, this.satellitePrn, @Uint8ListConverter() required this.raw, required this.preamble, required this.messageType, required this.version, required this.reportClassification, required this.reportClassificationEn, required this.reportClassificationNo, required this.disasterCategory, required this.disasterCategoryEn, required this.disasterCategoryNo, required this.reportTime, required this.informationType, required this.informationTypeEn, required this.informationTypeNo, required this.weatherWarningState, required this.weatherWarningStateRaw, required final  List<String> weatherRelatedDisasterSubCategories, required final  List<int> weatherRelatedDisasterSubCategoriesRaw, required final  List<String> weatherForecastRegions, required final  List<int> weatherForecastRegionsRaw, final  String? $type}): _weatherRelatedDisasterSubCategories = weatherRelatedDisasterSubCategories,_weatherRelatedDisasterSubCategoriesRaw = weatherRelatedDisasterSubCategoriesRaw,_weatherForecastRegions = weatherForecastRegions,_weatherForecastRegionsRaw = weatherForecastRegionsRaw,$type = $type ?? 'weather',super._();
...
@override @useResult
$Res call({
 String sentence,@Uint8ListConverter() Uint8List message, String nmea, String? messageHeader, int? satelliteId, int? satellitePrn,@Uint8ListConverter() Uint8List raw, String preamble, String messageType, int version, String reportClassification, String reportClassificationEn, int reportClassificationNo, String disasterCategory, String disasterCategoryEn, int disasterCategoryNo, DateTime reportTime, String informationType, String informationTypeEn, int informationTypeNo, String weatherWarningState, int weatherWarningStateRaw, List<String> weatherRelatedDisasterSubCategories, List<int> weatherRelatedDisasterSubCategoriesRaw, List<String> weatherForecastRegions, List<int> weatherForecastRegionsRaw
});
...
/// Create a copy of QzssDcReport
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? sentence = null,Object? message = null,Object? nmea = null,Object? messageHeader = freezed,Object? satelliteId = freezed,Object? satellitePrn = freezed,Object? raw = null,Object? preamble = null,Object? messageType = null,Object? version = null,Object? reportClassification = null,Object? reportClassificationEn = null,Object? reportClassificationNo = null,Object? disasterCategory = null,Object? disasterCategoryEn = null,Object? disasterCategoryNo = null,Object? reportTime = null,Object? informationType = null,Object? informationTypeEn = null,Object? informationTypeNo = null,Object? weatherWarningState = null,Object? weatherWarningStateRaw = null,Object? weatherRelatedDisasterSubCategories = null,Object? weatherRelatedDisasterSubCategoriesRaw = null,Object? weatherForecastRegions = null,Object? weatherForecastRegionsRaw = null,}) {
...
@override @useResult
$Res call({
 String sentence,@Uint8ListConverter() Uint8List message, String nmea, String? messageHeader, int? satelliteId, int? satellitePrn,@Uint8ListConverter() Uint8List raw, String preamble, String messageType, int version, String reportClassification, String reportClassificationEn, int reportClassificationNo, String disasterCategory, String disasterCategoryEn, int disasterCategoryNo, DateTime reportTime, String informationType, String informationTypeEn, int informationTypeNo, int ambiguityOfActivityTimeNo, DateTime activityTime, String volcanicWarningCode, int volcanicWarningCodeRaw, String volcanoName, int volcanoNameRaw, List<String> localGovernments, List<int> localGovernmentsRaw
});
...
/// Create a copy of QzssDcReport
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? sentence = null,Object? message = null,Object? nmea = null,Object? messageHeader = freezed,Object? satelliteId = freezed,Object? satellitePrn = freezed,Object? raw = null,Object? preamble = null,Object? messageType = null,Object? version = null,Object? reportClassification = null,Object? reportClassificationEn = null,Object? reportClassificationNo = null,Object? disasterCategory = null,Object? disasterCategoryEn = null,Object? disasterCategoryNo = null,Object? reportTime = null,Object? informationType = null,Object? informationTypeEn = null,Object? informationTypeNo = null,Object? ambiguityOfActivityTimeNo = null,Object? activityTime = null,Object? volcanicWarningCode = null,Object? volcanicWarningCodeRaw = null,Object? volcanoName = null,Object? volcanoNameRaw = null,Object? localGovernments = null,Object? localGovernmentsRaw = null,}) {
...
class QzssDcReportAshFall extends QzssDcReport {
  const QzssDcReportAshFall({required this.sentence, @Uint8ListConverter() required this.message, required this.nmea, this.messageHeader, this.satelliteId, this.satellitePrn, @Uint8ListConverter() required this.raw, required this.preamble, required this.messageType, required this.version, required this.reportClassification, required this.reportClassificationEn, required this.reportClassificationNo, required this.disasterCategory, required this.disasterCategoryEn, required this.disasterCategoryNo, required this.reportTime, required this.informationType, required this.informationTypeEn, required this.informationTypeNo, required this.activityTime, required this.ashFallWarningType, required this.ashFallWarningTypeRaw, required this.volcanoName, required this.volcanoNameRaw, required final  List<int> expectedAshFallTimes, required final  List<String> ashFallWarningCodes, required final  List<int> ashFallWarningCodesRaw, required final  List<String> localGovernments, required final  List<int> localGovernmentsRaw, final  String? $type}): _expectedAshFallTimes = expectedAshFallTimes,_ashFallWarningCodes = ashFallWarningCodes,_ashFallWarningCodesRaw = ashFallWarningCodesRaw,_localGovernments = localGovernments,_localGovernmentsRaw = localGovernmentsRaw,$type = $type ?? 'ashFall',super._();
...
@override @useResult
$Res call({
 String sentence,@Uint8ListConverter() Uint8List message, String nmea, String? messageHeader, int? satelliteId, int? satellitePrn,@Uint8ListConverter() Uint8List raw, String preamble, String messageType, int version, String reportClassification, String reportClassificationEn, int reportClassificationNo, String disasterCategory, String disasterCategoryEn, int disasterCategoryNo, DateTime reportTime, String informationType, String informationTypeEn, int informationTypeNo, DateTime activityTime, String ashFallWarningType, int ashFallWarningTypeRaw, String volcanoName, int volcanoNameRaw, List<int> expectedAshFallTimes, List<String> ashFallWarningCodes, List<int> ashFallWarningCodesRaw, List<String> localGovernments, List<int> localGovernmentsRaw
});
...
@override @useResult
$Res call({
 String sentence,@Uint8ListConverter() Uint8List message, String nmea, String? messageHeader, int? satelliteId, int? satellitePrn,@Uint8ListConverter() Uint8List raw, String preamble, String messageType, int version, String reportClassification, String reportClassificationEn, int reportClassificationNo, String disasterCategory, String disasterCategoryEn, int disasterCategoryNo, DateTime reportTime, String informationType, String informationTypeEn, int informationTypeNo, DateTime referenceTime, String referenceTimeType, int referenceTimeTypeRaw, int elapsedTimeFromReferenceTime, String typhoonNumber, int typhoonNumberRaw, String typhoonScaleCategory, int typhoonScaleCategoryRaw, String typhoonIntensityCategory, int typhoonIntensityCategoryRaw, HypocenterCoordinates coordinatesOfTyphoon, String centralPressure, int centralPressureRaw, String maximumWindSpeed, int maximumWindSpeedRaw, String maximumGustWindSpeed, int maximumGustWindSpeedRaw
});
...
class QzssDcReportDcxNull extends QzssDcReport {
  const QzssDcReportDcxNull({required this.sentence, @Uint8ListConverter() required this.message, required this.nmea, this.messageHeader, this.satelliteId, this.satellitePrn, @Uint8ListConverter() required this.raw, required this.preamble, required this.messageType, required this.dcxMessageType, final  String? $type}): $type = $type ?? 'dcxNull',super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is QzssDcReportDcxNull&&(identical(other.sentence, sentence) || other.sentence == sentence)&&const DeepCollectionEquality().equals(other.message, message)&&(identical(other.nmea, nmea) || other.nmea == nmea)&&(identical(other.messageHeader, messageHeader) || other.messageHeader == messageHeader)&&(identical(other.satelliteId, satelliteId) || other.satelliteId == satelliteId)&&(identical(other.satellitePrn, satellitePrn) || other.satellitePrn == satellitePrn)&&const DeepCollectionEquality().equals(other.raw, raw)&&(identical(other.preamble, preamble) || other.preamble == preamble)&&(identical(other.messageType, messageType) || other.messageType == messageType)&&(identical(other.dcxMessageType, dcxMessageType) || other.dcxMessageType == dcxMessageType));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,sentence,const DeepCollectionEquality().hash(message),nmea,messageHeader,satelliteId,satellitePrn,const DeepCollectionEquality().hash(raw),preamble,messageType,dcxMessageType);

@override
String toString() {
  return 'QzssDcReport.dcxNull(sentence: $sentence, message: $message, nmea: $nmea, messageHeader: $messageHeader, satelliteId: $satelliteId, satellitePrn: $satellitePrn, raw: $raw, preamble: $preamble, messageType: $messageType, dcxMessageType: $dcxMessageType)';
}
...
@override @useResult
$Res call({
 String sentence,@Uint8ListConverter() Uint8List message, String nmea, String? messageHeader, int? satelliteId, int? satellitePrn,@Uint8ListConverter() Uint8List raw, String preamble, String messageType, String dcxMessageType
});
...
/// Create a copy of QzssDcReport
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? sentence = null,Object? message = null,Object? nmea = null,Object? messageHeader = freezed,Object? satelliteId = freezed,Object? satellitePrn = freezed,Object? raw = null,Object? preamble = null,Object? messageType = null,Object? dcxMessageType = null,}) {
...
@override
String toString() {
  return 'QzssDcReport.dcxOutsideJapan(sentence: $sentence, message: $message, nmea: $nmea, messageHeader: $messageHeader, satelliteId: $satelliteId, satellitePrn: $satellitePrn, raw: $raw, preamble: $preamble, messageType: $messageType, dcxMessageType: $dcxMessageType)';
}
...
@override
String toString() {
  return 'QzssDcReport.dcxLAlert(sentence: $sentence, message: $message, nmea: $nmea, messageHeader: $messageHeader, satelliteId: $satelliteId, satellitePrn: $satellitePrn, raw: $raw, preamble: $preamble, messageType: $messageType, dcxMessageType: $dcxMessageType)';
}
...
@override
String toString() {
  return 'QzssDcReport.dcxJAlert(sentence: $sentence, message: $message, nmea: $nmea, messageHeader: $messageHeader, satelliteId: $satelliteId, satellitePrn: $satellitePrn, raw: $raw, preamble: $preamble, messageType: $messageType, dcxMessageType: $dcxMessageType)';
}
...
@override
String toString() {
  return 'QzssDcReport.dcxMTInfo(sentence: $sentence, message: $message, nmea: $nmea, messageHeader: $messageHeader, satelliteId: $satelliteId, satellitePrn: $satellitePrn, raw: $raw, preamble: $preamble, messageType: $messageType, dcxMessageType: $dcxMessageType)';
}
...
@override
String toString() {
  return 'QzssDcReport.dcxUnknown(sentence: $sentence, message: $message, nmea: $nmea, messageHeader: $messageHeader, satelliteId: $satelliteId, satellitePrn: $satellitePrn, raw: $raw, preamble: $preamble, messageType: $messageType, dcxMessageType: $dcxMessageType)';
}
