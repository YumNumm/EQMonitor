...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Result? result, @JsonKey(fromJson: dateTimeOrNullFromString, toJson: dateTimeOrNullToString)  DateTime? reportTime,  String? regionCode,  String? requestTime,  String? regionName, @JsonKey(fromJson: doubleOrNullFromString, toJson: doubleOrNullToString)  double? longitude, @JsonKey(name: 'is_cancel', fromJson: boolFromDynamic)  bool? isCancel, @JsonKey(fromJson: depthFromString, toJson: depthToString)  int? depth, @JsonKey(name: 'calcintensity', fromJson: JmaIntensity.fromString)  JmaIntensity? intensity, @JsonKey(name: 'is_final', fromJson: boolFromDynamic)  bool? isFinal, @JsonKey(name: 'isTraining', fromJson: boolFromDynamic)  bool? isTraining, @JsonKey(fromJson: doubleOrNullFromString, toJson: doubleOrNullToString)  double? latitude, @JsonKey(name: 'origin_time', fromJson: originTimeFromString)  DateTime? originTime,  Security? security, @JsonKey(fromJson: doubleOrNullFromString, toJson: doubleOrNullToString)  double? magnitude, @JsonKey(name: 'report_num', fromJson: intFromString, toJson: intToString)  int? reportNum,  String? requestHypoType,  String? reportId, @JsonKey(name: 'alertflg')  String? alertFlag)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Eew() when $default != null:
return $default(_that.result,_that.reportTime,_that.regionCode,_that.requestTime,_that.regionName,_that.longitude,_that.isCancel,_that.depth,_that.intensity,_that.isFinal,_that.isTraining,_that.latitude,_that.originTime,_that.security,_that.magnitude,_that.reportNum,_that.requestHypoType,_that.reportId,_that.alertFlag);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Result? result, @JsonKey(fromJson: dateTimeOrNullFromString, toJson: dateTimeOrNullToString)  DateTime? reportTime,  String? regionCode,  String? requestTime,  String? regionName, @JsonKey(fromJson: doubleOrNullFromString, toJson: doubleOrNullToString)  double? longitude, @JsonKey(name: 'is_cancel', fromJson: boolFromDynamic)  bool? isCancel, @JsonKey(fromJson: depthFromString, toJson: depthToString)  int? depth, @JsonKey(name: 'calcintensity', fromJson: JmaIntensity.fromString)  JmaIntensity? intensity, @JsonKey(name: 'is_final', fromJson: boolFromDynamic)  bool? isFinal, @JsonKey(name: 'isTraining', fromJson: boolFromDynamic)  bool? isTraining, @JsonKey(fromJson: doubleOrNullFromString, toJson: doubleOrNullToString)  double? latitude, @JsonKey(name: 'origin_time', fromJson: originTimeFromString)  DateTime? originTime,  Security? security, @JsonKey(fromJson: doubleOrNullFromString, toJson: doubleOrNullToString)  double? magnitude, @JsonKey(name: 'report_num', fromJson: intFromString, toJson: intToString)  int? reportNum,  String? requestHypoType,  String? reportId, @JsonKey(name: 'alertflg')  String? alertFlag)  $default,) {final _that = this;
switch (_that) {
case _Eew():
return $default(_that.result,_that.reportTime,_that.regionCode,_that.requestTime,_that.regionName,_that.longitude,_that.isCancel,_that.depth,_that.intensity,_that.isFinal,_that.isTraining,_that.latitude,_that.originTime,_that.security,_that.magnitude,_that.reportNum,_that.requestHypoType,_that.reportId,_that.alertFlag);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Result? result, @JsonKey(fromJson: dateTimeOrNullFromString, toJson: dateTimeOrNullToString)  DateTime? reportTime,  String? regionCode,  String? requestTime,  String? regionName, @JsonKey(fromJson: doubleOrNullFromString, toJson: doubleOrNullToString)  double? longitude, @JsonKey(name: 'is_cancel', fromJson: boolFromDynamic)  bool? isCancel, @JsonKey(fromJson: depthFromString, toJson: depthToString)  int? depth, @JsonKey(name: 'calcintensity', fromJson: JmaIntensity.fromString)  JmaIntensity? intensity, @JsonKey(name: 'is_final', fromJson: boolFromDynamic)  bool? isFinal, @JsonKey(name: 'isTraining', fromJson: boolFromDynamic)  bool? isTraining, @JsonKey(fromJson: doubleOrNullFromString, toJson: doubleOrNullToString)  double? latitude, @JsonKey(name: 'origin_time', fromJson: originTimeFromString)  DateTime? originTime,  Security? security, @JsonKey(fromJson: doubleOrNullFromString, toJson: doubleOrNullToString)  double? magnitude, @JsonKey(name: 'report_num', fromJson: intFromString, toJson: intToString)  int? reportNum,  String? requestHypoType,  String? reportId, @JsonKey(name: 'alertflg')  String? alertFlag)?  $default,) {final _that = this;
switch (_that) {
case _Eew() when $default != null:
return $default(_that.result,_that.reportTime,_that.regionCode,_that.requestTime,_that.regionName,_that.longitude,_that.isCancel,_that.depth,_that.intensity,_that.isFinal,_that.isTraining,_that.latitude,_that.originTime,_that.security,_that.magnitude,_that.reportNum,_that.requestHypoType,_that.reportId,_that.alertFlag);case _:
  return null;
