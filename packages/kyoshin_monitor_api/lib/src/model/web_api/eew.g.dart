      ...
      ($checkedConvert) {
        final val = _$EewImpl(
          ...
          latitude: $checkedConvert(
              'latitude', (v) => doubleOrNullFromString(v as String?)),
          originTime: $checkedConvert(
              'origin_time', (v) => originTimeFromString(v as String?)),
          ...
          magnitude: $checkedConvert(
              'magnitude', (v) => doubleOrNullFromString(v as String?)),
          reportNum:
              $checkedConvert('report_num', (v) => intFromString(v as String?)),
          requestHypoType:
              $checkedConvert('request_hypo_type', (v) => v as String?),
