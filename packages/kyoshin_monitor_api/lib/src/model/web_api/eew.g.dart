...
_$EewImpl _$$EewImplFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      r'_$EewImpl',
      json,
      ($checkedConvert) {
        final val = _$EewImpl(
          ...
          isCancel: $checkedConvert(
            'is_cancel',
            (v) => boolFromDynamic(v),
          ),
          depth: $checkedConvert(
            'depth',
            (v) => depthFromString(v as String?),
          ),
          intensity: $checkedConvert(
            'calcintensity',
            (v) => JmaIntensity.fromString(v as String?),
          ),
          isFinal: $checkedConvert(
            'is_final',
            (v) => boolFromDynamic(v),
          ),
          isTraining: $checkedConvert(
            'isTraining',
            (v) => boolFromDynamic(v),
          ),
          ...
          reportId: $checkedConvert(
            'report_id',
            (v) => v as String?,
          ),
          alertFlag: $checkedConvert(
            'alertflg',
            (v) => v as String?,
          ),
        );
...
Map<String, dynamic> _$$EewImplToJson(_$EewImpl instance) =>
    <String, dynamic>{
      'result': instance.result,
      'report_time': dateTimeOrNullToString(
        instance.reportTime,
      ),
      ...
      'calcintensity':
          _$JmaIntensityEnumMap[instance.intensity],
