...
Map<String, dynamic> _$$SiteListImplToJson(
  _$SiteListImpl instance,
) => <String, dynamic>{
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        final val = _$SiteImpl(
          ...
          siteidx: $checkedConvert(
            'siteidx',
            (v) => (v as num?)?.toInt(),
          ),
          prefectureId: $checkedConvert(
            'pref',
            (v) => (v as num?)?.toInt(),
          ),
          siteId: $checkedConvert(
            'siteid',
            (v) => v as String?,
          ),
          lat: $checkedConvert(
...
Map<String, dynamic> _$$SiteImplToJson(
  _$SiteImpl instance,
) => <String, dynamic>{
  'muni': instance.muni,
