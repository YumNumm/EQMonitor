...
/// Adds pattern-matching-related methods to [RealTimeData].
extension RealTimeDataPatterns on RealTimeData {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _RealTimeData value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _RealTimeData() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _RealTimeData value)  $default,){
final _that = this;
switch (_that) {
case _RealTimeData():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _RealTimeData value)?  $default,){
final _that = this;
switch (_that) {
case _RealTimeData() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( DateTime? dateTime,  String? packetType,  String? kyoshinType,  String? baseData,  String? baseSerialNo,  List<double?>? items,  Result? result,  Security? security)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RealTimeData() when $default != null:
return $default(_that.dateTime,_that.packetType,_that.kyoshinType,_that.baseData,_that.baseSerialNo,_that.items,_that.result,_that.security);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( DateTime? dateTime,  String? packetType,  String? kyoshinType,  String? baseData,  String? baseSerialNo,  List<double?>? items,  Result? result,  Security? security)  $default,) {final _that = this;
switch (_that) {
case _RealTimeData():
return $default(_that.dateTime,_that.packetType,_that.kyoshinType,_that.baseData,_that.baseSerialNo,_that.items,_that.result,_that.security);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( DateTime? dateTime,  String? packetType,  String? kyoshinType,  String? baseData,  String? baseSerialNo,  List<double?>? items,  Result? result,  Security? security)?  $default,) {final _that = this;
switch (_that) {
case _RealTimeData() when $default != null:
return $default(_that.dateTime,_that.packetType,_that.kyoshinType,_that.baseData,_that.baseSerialNo,_that.items,_that.result,_that.security);case _:
  return null;
...
class _RealTimeData implements RealTimeData {
  const _RealTimeData({required this.dateTime, required this.packetType, required this.kyoshinType, required this.baseData, required this.baseSerialNo, required  List<double?>? items, required this.result, required this.security}): _items = items;
