...
class DownloadCommand extends Command<void> {
  ...
  Future<void> run() async {
    ...
    final kyoshinMonitorWebApiDataSource =
    ...
    try {
      final data =
          type.isLpgm
              ? await lpgmKyoshinMonitorWebApiDataSource
                  .getRealtimeImageData(
                    type,
                    layer,
                    datetime,
                  )
              : await kyoshinMonitorWebApiDataSource
                  .getRealtimeImageData(
                    type: type,
                    layer: layer,
                    dateTime: datetime,
