...
_$$InformationV3ResultImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(r'_$InformationV3ResultImpl', json, (
  $checkedConvert,
) {
...
_$InformationV3Impl _$$InformationV3ImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
...
Map<String, dynamic> _$$InformationV3ImplToJson(
  _$InformationV3Impl instance,
) => <String, dynamic>{
  'id': instance.id,
