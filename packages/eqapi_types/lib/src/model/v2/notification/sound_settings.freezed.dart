...
mixin _$SoundSettings {
 ...
 IntensitySoundMode get mode; Map<String, String>? get map;
...
@useResult
$Res call({
 IntensitySoundMode mode, Map<String, String>? map
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( IntensitySoundMode mode,  Map<String, String>? map)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SoundSettings() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( IntensitySoundMode mode,  Map<String, String>? map)  $default,) {final _that = this;
switch (_that) {
case _SoundSettings():
return $default(_that.mode,_that.map);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( IntensitySoundMode mode,  Map<String, String>? map)?  $default,) {final _that = this;
switch (_that) {
case _SoundSettings() when $default != null:
return $default(_that.mode,_that.map);case _:
  return null;
...
class _SoundSettings implements SoundSettings {
  const _SoundSettings({required this.mode, final  Map<String, String>? map}): _map = map;
...
@override Map<String, String>? get map {
  final value = _map;
