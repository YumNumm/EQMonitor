...
@useResult
$Res call({
 CodeName value, bool hadWarning
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( CodeName value,  bool hadWarning)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EewWarningZoneItem() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( CodeName value,  bool hadWarning)  $default,) {final _that = this;
switch (_that) {
case _EewWarningZoneItem():
return $default(_that.value,_that.hadWarning);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( CodeName value,  bool hadWarning)?  $default,) {final _that = this;
switch (_that) {
case _EewWarningZoneItem() when $default != null:
return $default(_that.value,_that.hadWarning);case _:
  return null;
...
class _EewWarningZoneItem implements EewWarningZoneItem {
  const _EewWarningZoneItem({required this.value, required this.hadWarning});
