...
_$$ShakeDetectionWebSocketTelegramImplFromJson(Map<String, dynamic> json) =>
    $checkedCreate(r'_$ShakeDetectionWebSocketTelegramImpl', json, (
      $checkedConvert,
    ) {
        ...
        events: $checkedConvert(
          ...
          (v) =>
              (v as List<dynamic>)
                  .map(
                    (e) =>
                        ShakeDetectionEvent.fromJson(e as Map<String, dynamic>),
                  )
                  .toList(),
        ),
      );
...
_$ShakeDetectionEventImpl _$$ShakeDetectionEventImplFromJson(
  ...
  ($checkedConvert) {
    final val = _$ShakeDetectionEventImpl(
      ...
      serialNo: $checkedConvert('serial_no', (v) => (v as num?)?.toInt() ?? -1),
...
_$ShakeDetectionRegionImpl _$$ShakeDetectionRegionImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(r'_$ShakeDetectionRegionImpl', json, ($checkedConvert) {
  final val = _$ShakeDetectionRegionImpl(
    ...
    points: $checkedConvert(
      ...
      (v) =>
          (v as List<dynamic>)
              .map(
                (e) => ShakeDetectionPoint.fromJson(e as Map<String, dynamic>),
              )
              .toList(),
    ),
  );
...
_$ShakeDetectionPointImpl _$$ShakeDetectionPointImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(r'_$ShakeDetectionPointImpl', json, ($checkedConvert) {
...
_$ShakeDetectionLatLngImpl _$$ShakeDetectionLatLngImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(r'_$ShakeDetectionLatLngImpl', json, ($checkedConvert) {
