...
_$$ShakeDetectionWebSocketTelegramImplFromJson(
    ...
    final val = _$ShakeDetectionWebSocketTelegramImpl(
      events: $checkedConvert(
        ...
        (v) =>
            (v as List<dynamic>)
                .map(
                  (e) => ShakeDetectionEvent.fromJson(
    ...
    final val = _$ShakeDetectionEventImpl(
      ...
      regions: $checkedConvert(
        ...
        (v) =>
            (v as List<dynamic>)
                .map(
                  (e) => ShakeDetectionRegion.fromJson(
                    e as Map<String, dynamic>,
                  ),
                )
                .toList(),
      ...
      topLeft: $checkedConvert(
        'top_left',
        (v) => ShakeDetectionLatLng.fromJson(
...
Map<String, dynamic> _$$ShakeDetectionEventImplToJson(
  ...
  'max_intensity':
      _$JmaForecastIntensityEnumMap[instance.maxIntensity]!,
...
_$$ShakeDetectionRegionImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(r'_$ShakeDetectionRegionImpl', json, (
  $checkedConvert,
) {
  final val = _$ShakeDetectionRegionImpl(
    ...
    points: $checkedConvert(
      ...
      (v) =>
          (v as List<dynamic>)
              .map(
                (e) => ShakeDetectionPoint.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList(),
...
_$$ShakeDetectionPointImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(r'_$ShakeDetectionPointImpl', json, (
  $checkedConvert,
) {
...
Map<String, dynamic> _$$ShakeDetectionPointImplToJson(
  ...
  'intensity':
      _$JmaForecastIntensityEnumMap[instance.intensity]!,
  'code': instance.code,
};

_$ShakeDetectionLatLngImpl
_$$ShakeDetectionLatLngImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(r'_$ShakeDetectionLatLngImpl', json, (
  $checkedConvert,
) {
