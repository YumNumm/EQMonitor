...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<DevicesEarthquakeSettings> earthquake,  List<DevicesEewSettings> eew)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotificationSettingsResponse() when $default != null:
return $default(_that.earthquake,_that.eew);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<DevicesEarthquakeSettings> earthquake,  List<DevicesEewSettings> eew)  $default,) {final _that = this;
switch (_that) {
case _NotificationSettingsResponse():
return $default(_that.earthquake,_that.eew);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<DevicesEarthquakeSettings> earthquake,  List<DevicesEewSettings> eew)?  $default,) {final _that = this;
switch (_that) {
case _NotificationSettingsResponse() when $default != null:
return $default(_that.earthquake,_that.eew);case _:
  return null;
