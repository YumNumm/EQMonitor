...
/// Adds pattern-matching-related methods to [RealtimePostgresInsertPayload].
extension RealtimePostgresInsertPayloadPatterns<T extends V1Database> on RealtimePostgresInsertPayload<T> {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _RealtimePostgresInsertPayload<T> value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _RealtimePostgresInsertPayload() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _RealtimePostgresInsertPayload<T> value)  $default,){
final _that = this;
switch (_that) {
case _RealtimePostgresInsertPayload():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _RealtimePostgresInsertPayload<T> value)?  $default,){
final _that = this;
switch (_that) {
case _RealtimePostgresInsertPayload() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String schema,  String table,  DateTime commitTimestamp,  List<String>? errors, @JsonKey(name: 'new')  T newData)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RealtimePostgresInsertPayload() when $default != null:
return $default(_that.schema,_that.table,_that.commitTimestamp,_that.errors,_that.newData);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String schema,  String table,  DateTime commitTimestamp,  List<String>? errors, @JsonKey(name: 'new')  T newData)  $default,) {final _that = this;
switch (_that) {
case _RealtimePostgresInsertPayload():
return $default(_that.schema,_that.table,_that.commitTimestamp,_that.errors,_that.newData);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String schema,  String table,  DateTime commitTimestamp,  List<String>? errors, @JsonKey(name: 'new')  T newData)?  $default,) {final _that = this;
switch (_that) {
case _RealtimePostgresInsertPayload() when $default != null:
return $default(_that.schema,_that.table,_that.commitTimestamp,_that.errors,_that.newData);case _:
  return null;
...
/// Adds pattern-matching-related methods to [RealtimePostgresUpdatePayload].
extension RealtimePostgresUpdatePayloadPatterns<T extends V1Database> on RealtimePostgresUpdatePayload<T> {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _RealtimePostgresUpdatePayload<T> value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _RealtimePostgresUpdatePayload() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _RealtimePostgresUpdatePayload<T> value)  $default,){
final _that = this;
switch (_that) {
case _RealtimePostgresUpdatePayload():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _RealtimePostgresUpdatePayload<T> value)?  $default,){
final _that = this;
switch (_that) {
case _RealtimePostgresUpdatePayload() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String schema,  String table,  DateTime commitTimestamp,  List<String>? errors, @JsonKey(name: 'new')  T newData,  Map<String, dynamic>? old)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RealtimePostgresUpdatePayload() when $default != null:
return $default(_that.schema,_that.table,_that.commitTimestamp,_that.errors,_that.newData,_that.old);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String schema,  String table,  DateTime commitTimestamp,  List<String>? errors, @JsonKey(name: 'new')  T newData,  Map<String, dynamic>? old)  $default,) {final _that = this;
switch (_that) {
case _RealtimePostgresUpdatePayload():
return $default(_that.schema,_that.table,_that.commitTimestamp,_that.errors,_that.newData,_that.old);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String schema,  String table,  DateTime commitTimestamp,  List<String>? errors, @JsonKey(name: 'new')  T newData,  Map<String, dynamic>? old)?  $default,) {final _that = this;
switch (_that) {
case _RealtimePostgresUpdatePayload() when $default != null:
return $default(_that.schema,_that.table,_that.commitTimestamp,_that.errors,_that.newData,_that.old);case _:
  return null;
...
/// Adds pattern-matching-related methods to [RealtimePostgresDeletePayload].
extension RealtimePostgresDeletePayloadPatterns<T extends V1Database> on RealtimePostgresDeletePayload<T> {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _RealtimePostgresDeletePayload<T> value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _RealtimePostgresDeletePayload() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _RealtimePostgresDeletePayload<T> value)  $default,){
final _that = this;
switch (_that) {
case _RealtimePostgresDeletePayload():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _RealtimePostgresDeletePayload<T> value)?  $default,){
final _that = this;
switch (_that) {
case _RealtimePostgresDeletePayload() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String schema,  String table,  DateTime commitTimestamp,  List<String>? errors,  Map<String, dynamic>? old)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RealtimePostgresDeletePayload() when $default != null:
return $default(_that.schema,_that.table,_that.commitTimestamp,_that.errors,_that.old);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String schema,  String table,  DateTime commitTimestamp,  List<String>? errors,  Map<String, dynamic>? old)  $default,) {final _that = this;
switch (_that) {
case _RealtimePostgresDeletePayload():
return $default(_that.schema,_that.table,_that.commitTimestamp,_that.errors,_that.old);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String schema,  String table,  DateTime commitTimestamp,  List<String>? errors,  Map<String, dynamic>? old)?  $default,) {final _that = this;
switch (_that) {
case _RealtimePostgresDeletePayload() when $default != null:
return $default(_that.schema,_that.table,_that.commitTimestamp,_that.errors,_that.old);case _:
  return null;
