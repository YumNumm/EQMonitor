...
_$_TsunamiV1BaseImpl _$$_TsunamiV1BaseImplFromJson(
...
_$CommentImpl _$$CommentImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(r'_$CommentImpl', json, (
  $checkedConvert,
) {
...
Map<String, dynamic> _$$CommentImplToJson(
  _$CommentImpl instance,
) => <String, dynamic>{
  'free': instance.free,
  'warning': instance.warning,
};

_$CommentWarningImpl _$$CommentWarningImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(r'_$CommentWarningImpl', json, (
  $checkedConvert,
) {
...
_$CancelBodyImpl _$$CancelBodyImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(r'_$CancelBodyImpl', json, (
  $checkedConvert,
) {
...
Map<String, dynamic> _$$CancelBodyImplToJson(
  _$CancelBodyImpl instance,
) => <String, dynamic>{'text': instance.text};

_$PublicBodyVTSE41TsunamiImpl
_$$PublicBodyVTSE41TsunamiImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
...
_$$PublicBodyVTSE51TsunamiImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
...
_$$PublicBodyVTSE52TsunamiImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
...
_$TsunamiForecastImpl _$$TsunamiForecastImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(r'_$TsunamiForecastImpl', json, (
  $checkedConvert,
) {
  final val = _$TsunamiForecastImpl(
    ...
    stations: $checkedConvert(
      ...
      (v) =>
          (v as List<dynamic>?)
              ?.map(
                (e) => TsunamiForecastStation.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList(),
...
_$$TsunamiForecastFirstHeightImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
    ...
    final val = _$TsunamiForecastFirstHeightImpl(
      ...
      condition: $checkedConvert(
        ...
        (v) => $enumDecodeNullable(
          _$TsunamiForecastFirstHeightConditionEnumMap,
          v,
        ),
      ),
    );
...
Map<String, dynamic>
_$$TsunamiForecastFirstHeightImplToJson(
  _$TsunamiForecastFirstHeightImpl instance,
) => <String, dynamic>{
  'arrivalTime': instance.arrivalTime?.toIso8601String(),
  'condition':
      _$TsunamiForecastFirstHeightConditionEnumMap[instance
          .condition],
};

const _$TsunamiForecastFirstHeightConditionEnumMap = {
  TsunamiForecastFirstHeightCondition.arrival: '津波到達中と推測',
  TsunamiForecastFirstHeightCondition.firstTideDetected:
      '第１波の到達を確認',
  TsunamiForecastFirstHeightCondition.immediately:
      'ただちに津波来襲と予測',
};
  ...
  ($checkedConvert) {
    final val = _$TsunamiForecastMaxHeightImpl(
      ...
      condition: $checkedConvert(
        'condition',
        (v) => $enumDecodeNullable(
          _$TsunamiMaxHeightConditionEnumMap,
          v,
        ),
      ),
    );
...
Map<String, dynamic> _$$TsunamiForecastMaxHeightImplToJson(
  ...
  'condition':
      _$TsunamiMaxHeightConditionEnumMap[instance
          .condition],
};
...
_$$TsunamiForecastStationImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(r'_$TsunamiForecastStationImpl', json, (
  $checkedConvert,
) {
...
Map<String, dynamic> _$$TsunamiForecastStationImplToJson(
  ...
  'firstHeightTime':
      instance.firstHeightTime?.toIso8601String(),
  'condition':
      _$TsunamiForecastFirstHeightConditionEnumMap[instance
          .condition],
};
...
_$TsunamiObservationImpl _$$TsunamiObservationImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(r'_$TsunamiObservationImpl', json, (
  $checkedConvert,
) {
...
_$$TsunamiObservationStationImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  ...
  ($checkedConvert) {
    final val = _$TsunamiObservationStationImpl(
      ...
      maxHeightIsOver: $checkedConvert(
        'maxHeightIsOver',
        (v) => v as bool?,
      ),
      maxHeightIsRising: $checkedConvert(
        'maxHeightIsRising',
        (v) => v as bool?,
      ),
      condition: $checkedConvert(
        'condition',
        (v) => $enumDecodeNullable(
          _$TsunamiObservationStationConditionEnumMap,
          v,
        ),
      ),
    );
...
Map<String, dynamic> _$$TsunamiObservationStationImplToJson(
  ...
  'firstHeightInitial':
      _$TsunamiObservationStationFirstHeightIntialEnumMap[instance
          .firstHeightInitial],
  'maxHeightTime':
      instance.maxHeightTime?.toIso8601String(),
  ...
  'condition':
      _$TsunamiObservationStationConditionEnumMap[instance
          .condition],
};
...
_$TsunamiEstimationImpl _$$TsunamiEstimationImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(r'_$TsunamiEstimationImpl', json, (
  $checkedConvert,
) {
...
const _$TsunamiEstimationFirstHeightConditionEnumMap = {
  TsunamiEstimationFirstHeightCondition.alreadyArrived:
      '早いところでは既に津波到達と推定',
};

_$PublicBodyVTSE41Impl _$$PublicBodyVTSE41ImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(r'_$PublicBodyVTSE41Impl', json, (
  $checkedConvert,
) {
  final val = _$PublicBodyVTSE41Impl(
    tsunami: $checkedConvert(
      'tsunami',
      (v) => PublicBodyVTSE41Tsunami.fromJson(
        v as Map<String, dynamic>,
      ),
    ),
...
_$PublicBodyVTSE51Impl _$$PublicBodyVTSE51ImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(r'_$PublicBodyVTSE51Impl', json, (
  $checkedConvert,
) {
  final val = _$PublicBodyVTSE51Impl(
    tsunami: $checkedConvert(
      'tsunami',
      (v) => PublicBodyVTSE51Tsunami.fromJson(
        v as Map<String, dynamic>,
      ),
    ),
    earthquakes: $checkedConvert(
...
_$PublicBodyVTSE52Impl _$$PublicBodyVTSE52ImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(r'_$PublicBodyVTSE52Impl', json, (
  $checkedConvert,
) {
  final val = _$PublicBodyVTSE52Impl(
    tsunami: $checkedConvert(
      'tsunami',
      (v) => PublicBodyVTSE52Tsunami.fromJson(
        v as Map<String, dynamic>,
      ),
    ),
    earthquakes: $checkedConvert(
...
_$EarthquakeImpl _$$EarthquakeImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  r'_$EarthquakeImpl',
  json,
  ($checkedConvert) {
    final val = _$EarthquakeImpl(
      ...
      hypocenter: $checkedConvert(
        'hypocenter',
        (v) => EarthquakeHypocenter.fromJson(
          v as Map<String, dynamic>,
        ),
      ),
      magnitude: $checkedConvert(
        'magnitude',
        (v) => EarthquakeMagnitude.fromJson(
          v as Map<String, dynamic>,
        ),
      ),
    );
...
Map<String, dynamic> _$$EarthquakeImplToJson(
  _$EarthquakeImpl instance,
) => <String, dynamic>{
...
_$$EarthquakeHypocenterImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(r'_$EarthquakeHypocenterImpl', json, (
  $checkedConvert,
) {
...
_$$EarthquakeHypocenterDetailedImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
...
Map<String, dynamic>
_$$EarthquakeHypocenterDetailedImplToJson(
...
_$$EarthquakeHypocenterCoordinateImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
...
Map<String, dynamic>
_$$EarthquakeHypocenterCoordinateImplToJson(
...
_$$EarthquakeMagnitudeImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(r'_$EarthquakeMagnitudeImpl', json, (
  $checkedConvert,
) {
  final val = _$EarthquakeMagnitudeImpl(
    ...
    condition: $checkedConvert(
      'condition',
      (v) => $enumDecodeNullable(
        _$EarthquakeMagnitudeConditionEnumMap,
        v,
      ),
    ),
  );
...
Map<String, dynamic> _$$EarthquakeMagnitudeImplToJson(
  ...
  'value': instance.value,
  'condition':
      _$EarthquakeMagnitudeConditionEnumMap[instance
          .condition],
};
