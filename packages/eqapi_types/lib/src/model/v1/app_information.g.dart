...
_$AppInformationImpl _$$AppInformationImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(r'_$AppInformationImpl', json, (
  $checkedConvert,
) {
  final val = _$AppInformationImpl(
    ios: $checkedConvert(
      'ios',
      (v) => PlatformAppInformation.fromJson(
...
_$$PlatformAppInformationImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
...
_$AppVersionImpl _$$AppVersionImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(r'_$AppVersionImpl', json, (
  $checkedConvert,
) {
...
Map<String, dynamic> _$$AppVersionImplToJson(
  _$AppVersionImpl instance,
) => <String, dynamic>{
