...
class _TelegramApiClient implements TelegramApiClient {
  ...
  @override
  Future<TelegramListResponse> getList({int? limit, String? cursor}) async {
    ...
    final _options = _setStreamType<TelegramListResponse>(
  ...
  @override
  Future<TelegramDetailResponse> getDetail({required String id}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<TelegramDetailResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v2/telegram/${id}',
