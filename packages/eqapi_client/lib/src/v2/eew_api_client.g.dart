...
class _EewApiClient implements EewApiClient {
  ...
  @override
  Future<EewListResponse> getList({int? limit, String? cursor}) async {
    ...
    final _options = _setStreamType<EewListResponse>(
  ...
  @override
  Future<EewLatestResponse> getLatest() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<EewLatestResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v2/eew/latest',
  ...
  @override
  Future<EewArrayResponse> getByEventId({required String eventId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<EewArrayResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v2/eew/${eventId}',
  ...
  Future<EewItemWithRelations> getByEventIdAndSerialNo({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<EewItemWithRelations>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
