...
class _V1 implements V1 {
  ...
  Future<HttpResponse<List<EarthquakeV1>>> getEarthquakes({
    ...
    final _options = _setStreamType<HttpResponse<List<EarthquakeV1>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<HttpResponse<EarthquakeV1>> getEarthquakeDetail(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<EarthquakeV1>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<HttpResponse<List<RegionItem>>> getEarthquakeRegions({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<List<RegionItem>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<HttpResponse<List<InformationV1>>> getInformations({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<List<InformationV1>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<HttpResponse<List<EewV1>>> getEew({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<List<EewV1>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<List<ShakeDetectionEvent>> getLatestShakeDetectionEvents() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<ShakeDetectionEvent>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
