    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        final val = _$JmaXmlTelegramReplayDataImpl(
          type: $checkedConvert(
              'type', (v) => $enumDecode(_$ReplayDataTypeEnumMap, v)),
...
Map<String, dynamic> _$$KyoshinMonitorImageReplayDataImplToJson(
    ...
    <String, dynamic>{
      ...
      'time': instance.time.toIso8601String(),
      'images':
          instance.images.map((k, e) => MapEntry(_$ImageTypeEnumMap[k]!, e)),
    };
      ...
      ($checkedConvert) {
        final val = _$KeviJsonReplayDataImpl(
          ...
          jsonType: $checkedConvert(
              'json_type', (v) => $enumDecode(_$JsonTypeEnumMap, v)),
          json: $checkedConvert('json', (v) => v as String),
        );
        return val;
      },
