...
/// Adds pattern-matching-related methods to [ReplayFileHeader].
extension ReplayFileHeaderPatterns on ReplayFileHeader {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ReplayFileHeader value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ReplayFileHeader() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ReplayFileHeader value)  $default,){
final _that = this;
switch (_that) {
case _ReplayFileHeader():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ReplayFileHeader value)?  $default,){
final _that = this;
switch (_that) {
case _ReplayFileHeader() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int version,  String softwareName,  DateTime startTime,  DateTime endTime,  ReplayFileCompressionMode compressionMode)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ReplayFileHeader() when $default != null:
return $default(_that.version,_that.softwareName,_that.startTime,_that.endTime,_that.compressionMode);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int version,  String softwareName,  DateTime startTime,  DateTime endTime,  ReplayFileCompressionMode compressionMode)  $default,) {final _that = this;
switch (_that) {
case _ReplayFileHeader():
return $default(_that.version,_that.softwareName,_that.startTime,_that.endTime,_that.compressionMode);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int version,  String softwareName,  DateTime startTime,  DateTime endTime,  ReplayFileCompressionMode compressionMode)?  $default,) {final _that = this;
switch (_that) {
case _ReplayFileHeader() when $default != null:
return $default(_that.version,_that.softwareName,_that.startTime,_that.endTime,_that.compressionMode);case _:
  return null;
