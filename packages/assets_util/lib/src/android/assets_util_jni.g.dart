...
/// from: `net.yumnumm.assets_util.AssetsUtil`
///
/// Copies a platform asset into app-private storage and returns its absolute path.
///
/// Reuses an existing copy when the marker matches the current app versionCode. Writes via a
/// temporary file then renames atomically to avoid partial files.
///
/// Note: assets may be compressed in the APK, so android.content.res.AssetManager\#openFd
/// is not used.
extension type AssetsUtil._(jni$_.JObject _$this) implements jni$_.JObject {
  static final _class = jni$_.JClass.forName(
    r'net/yumnumm/assets_util/AssetsUtil',
  );

  /// The type which includes information such as the signature of this class.
  static const jni$_.JType<AssetsUtil> type = $AssetsUtil$Type$();
  static final _id_resolveLocalPath = _class.staticMethodId(
    r'resolveLocalPath',
    r'(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;',
  );

  static final _resolveLocalPath =
      jni$_.ProtectedJniExtensions.lookup<
            jni$_.NativeFunction<
              jni$_.JniResult Function(
                jni$_.Pointer<jni$_.Void>,
  ...
  /// from: `static public java.lang.String resolveLocalPath(android.content.Context context, java.lang.String fileName)`
  /// The returned object must be released after use, by calling the [release] method.
  static jni$_.JString? resolveLocalPath(
    Context? context,
    jni$_.JString? fileName,
  ) {
    final _$context = context?.reference ?? jni$_.jNullReference;
    final _$fileName = fileName?.reference ?? jni$_.jNullReference;
    return _resolveLocalPath(
      _class.reference.pointer,
      _id_resolveLocalPath.pointer,
      _$context.pointer,
      _$fileName.pointer,
    ).object<jni$_.JString?>();
  }
...
final class $AssetsUtil$Type$ extends jni$_.JType<AssetsUtil> {
  @jni$_.internal
  const $AssetsUtil$Type$();

  @jni$_.internal
  @core$_.override
  String get signature => r'Lnet/yumnumm/assets_util/AssetsUtil;';
}
