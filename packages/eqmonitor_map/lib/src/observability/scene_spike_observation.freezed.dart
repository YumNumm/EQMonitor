...
mixin _$SceneSpikeEvidence {
 ...
 int get schemaVersion; SceneSpikeRunKey get run; String get deviceModel; String get operatingSystemVersion; String get flutterFrameworkRevision; String get flutterEngineRevision; String get dartVersion; String get flutterSceneRevision; String get eqmonitorMapRendererRevision; bool get eqmonitorMapRendererCheckoutDirty; SceneSpikeObservationProvenance get revisionProvenance; String get renderingBackend; SceneSpikeObservationProvenance get renderingBackendProvenance; DateTime get startedAtUtc; int get elapsedMicroseconds; int get frameCount; int get partialUpdateCount; int get lifecycleResumeCount; int get appResourceGeneration; List<SceneSpikeCapabilityResult> get capabilities; SceneSpikePerformanceSnapshot get performance;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,schemaVersion,run,deviceModel,operatingSystemVersion,flutterFrameworkRevision,flutterEngineRevision,dartVersion,flutterSceneRevision,eqmonitorMapRendererRevision,eqmonitorMapRendererCheckoutDirty,revisionProvenance,renderingBackend,renderingBackendProvenance,startedAtUtc,elapsedMicroseconds,frameCount,partialUpdateCount,lifecycleResumeCount,appResourceGeneration,const DeepCollectionEquality().hash(capabilities),performance]);
