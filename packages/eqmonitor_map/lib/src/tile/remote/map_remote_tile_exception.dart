...
@immutable
sealed class const MapRemoteTileException() implements Exception {
  String get message;
}
...
final class const MapRemoteTileNonIdentityEncodingException({
  /// 拒否した `Content-Encoding` の生値(複数値ならすべて)。
  required final List<String> contentEncoding,
...
/// 扱わない。
final class const MapRemoteTileUnexpectedStatusException({
...
final class const MapRemoteTileSnapshotMismatchException({
  required final String? expectedEtag,
  required final String? receivedEtag,
  required final int statusCode,
}) extends MapRemoteTileException {
  @override
  String get message =>
...
final class const MapRemoteTileWeakValidatorException({
...
final class const MapRemoteTileContentRangeMismatchException({
...
/// 破棄する。
final class const MapRemoteTileBodyLengthMismatchException({
...
final class const MapRemoteTileRedirectRejectedException({
  required final int statusCode,
...
final class const MapRemoteTileNetworkException({required final String reason})
    extends MapRemoteTileException {
  @override
...
final class const MapRemoteTileClosedException()
    extends MapRemoteTileException {
  @override
