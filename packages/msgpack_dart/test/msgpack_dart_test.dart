// ignore_for_file: unreachable_from_main, avoid_dynamic_calls
...
void largeArray() {
  ...
  final deserialized = deserialize(serialized) as List<dynamic>;
...
void largeMap() {
  ...
  final deserialized = deserialize(serialized) as Map<dynamic, dynamic>;
