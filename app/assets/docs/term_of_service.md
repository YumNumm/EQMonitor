...
1. ユーザーは、本アプリのアンインストール及び、その他の方法により、いつでも本アプリの利用を終了できます。
...
1. 当方は、ユーザーに事前に通知することなく、本アプリの内容の全部もしくは一部を変更、追加または廃止でき、または本アプリの提供の全部または一部を中断、中止、または終了できます。当方は、本項の措置を行ったことにより、ユーザーに生じた損害に対して一切の責任を負わないものとします。
