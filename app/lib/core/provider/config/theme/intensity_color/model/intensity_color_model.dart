...
class IntensityColorModel with _$IntensityColorModel {
  ...
  factory IntensityColorModel.fromJson(
  ...
  factory IntensityColorModel.jma() =>
      const IntensityColorModel(
        zero: TextColorModel(
  ...
  factory IntensityColorModel.eqmonitor() =>
      IntensityColorModel(
  ...
  factory IntensityColorModel.earthQuickly() =>
      const IntensityColorModel(
        zero: TextColorModel(
          foreground: Colors.white,
...
class TextColorModel with _$TextColorModel {
  ...
  factory TextColorModel.fromJson(
    Map<String, dynamic> json,
  ) => _$TextColorModelFromJson(json);

  factory TextColorModel.fromBackground(Color background) =>
      TextColorModel(
        foreground:
