...
final class NtpProvider extends $NotifierProvider<Ntp, NtpStateModel> {
  ...
  @$internal
  @override
  $NotifierProviderElement<Ntp, NtpStateModel> $createElement(
  ...
  Override overrideWithValue(NtpStateModel value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $ValueProvider<NtpStateModel>(value),
    );
  }
}
...
abstract class _$Ntp extends $Notifier<NtpStateModel> {
  ...
  void runBuild() {
    final created = build();
    final ref = this.ref as $Ref<NtpStateModel>;
    final element =
        ref.element
            as $ClassProviderElement<
              AnyNotifier<NtpStateModel>,
              NtpStateModel,
              Object?,
              Object?
            >;
