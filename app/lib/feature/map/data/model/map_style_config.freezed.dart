...
abstract class $MapStyleConfigCopyWith<$Res> {
  factory $MapStyleConfigCopyWith(
          MapStyleConfig value, $Res Function(MapStyleConfig) then) =
...
abstract class _$$MapStyleConfigImplCopyWith<$Res>
    implements $MapStyleConfigCopyWith<$Res> {
  factory _$$MapStyleConfigImplCopyWith(_$MapStyleConfigImpl value,
...
class __$$MapStyleConfigImplCopyWithImpl<$Res>
  ...
  __$$MapStyleConfigImplCopyWithImpl(
      _$MapStyleConfigImpl _value, $Res Function(_$MapStyleConfigImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$MapStyleConfigImpl(
      theme: null == theme
          ? _value.theme
          : theme // ignore: cast_nullable_to_non_nullable
              as MapStyleTheme,
...
class _$MapStyleConfigImpl implements _MapStyleConfig {
  ...
  Map<String, dynamic> toJson() {
    return _$$MapStyleConfigImplToJson(
      this,
    );
  }
}
...
abstract class _MapStyleConfig implements MapStyleConfig {
  const factory _MapStyleConfig(
      ...
      final MapStyleColorScheme? colorScheme,
      @JsonKey(includeToJson: false, includeFromJson: false)
      final String? styleString}) = _$MapStyleConfigImpl;
...
abstract class $MapStyleColorSchemeCopyWith<$Res> {
  factory $MapStyleColorSchemeCopyWith(
          MapStyleColorScheme value, $Res Function(MapStyleColorScheme) then) =
...
abstract class _$$MapStyleColorSchemeImplCopyWith<$Res>
    implements $MapStyleColorSchemeCopyWith<$Res> {
  factory _$$MapStyleColorSchemeImplCopyWith(_$MapStyleColorSchemeImpl value,
...
class __$$MapStyleColorSchemeImplCopyWithImpl<$Res>
  ...
  __$$MapStyleColorSchemeImplCopyWithImpl(_$MapStyleColorSchemeImpl _value,
  ...
  $Res call({
    ...
    return _then(_$MapStyleColorSchemeImpl(
      backgroundColor: null == backgroundColor
          ? _value.backgroundColor
          : backgroundColor // ignore: cast_nullable_to_non_nullable
              as Color,
...
class _$MapStyleColorSchemeImpl implements _MapStyleColorScheme {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, backgroundColor, landColor,
      lineColor, japanLandColor, japanLineColor);
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$MapStyleColorSchemeImplToJson(
      this,
    );
  }
}
