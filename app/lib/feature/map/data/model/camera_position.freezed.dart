...
@pragma('vm:prefer-inline') @override $Res call({Object? target = null,Object? zoom = null,Object? tilt = null,Object? bearing = null,}) {
  return _then(MapCameraPosition(
...
/// Adds pattern-matching-related methods to [MapCameraPosition].
extension MapCameraPositionPatterns on MapCameraPosition {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _MapCameraPosition value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _MapCameraPosition() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _MapCameraPosition value)  $default,){
final _that = this;
switch (_that) {
case _MapCameraPosition():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _MapCameraPosition value)?  $default,){
final _that = this;
switch (_that) {
case _MapCameraPosition() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( LatLng target,  double zoom,  double tilt,  double bearing)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MapCameraPosition() when $default != null:
return $default(_that.target,_that.zoom,_that.tilt,_that.bearing);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( LatLng target,  double zoom,  double tilt,  double bearing)  $default,) {final _that = this;
switch (_that) {
case _MapCameraPosition():
return $default(_that.target,_that.zoom,_that.tilt,_that.bearing);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( LatLng target,  double zoom,  double tilt,  double bearing)?  $default,) {final _that = this;
switch (_that) {
case _MapCameraPosition() when $default != null:
return $default(_that.target,_that.zoom,_that.tilt,_that.bearing);case _:
  return null;
