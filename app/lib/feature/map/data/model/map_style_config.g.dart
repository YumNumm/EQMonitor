...
_$MapStyleConfigImpl _$$MapStyleConfigImplFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      r'_$MapStyleConfigImpl',
      json,
      ($checkedConvert) {
        final val = _$MapStyleConfigImpl(
          theme: $checkedConvert(
              'theme', (v) => $enumDecode(_$MapStyleThemeEnumMap, v)),
        );
        return val;
      },
    );
...
Map<String, dynamic> _$$MapStyleConfigImplToJson(
    ...
    <String, dynamic>{
      'theme': _$MapStyleThemeEnumMap[instance.theme]!,
    };
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        final val = _$MapStyleColorSchemeImpl(
          backgroundColor: $checkedConvert('background_color',
              (v) => const ColorConverter().fromJson(v as String)),
          landColor: $checkedConvert('land_color',
              (v) => const ColorConverter().fromJson(v as String)),
          lineColor: $checkedConvert('line_color',
              (v) => const ColorConverter().fromJson(v as String)),
          japanLandColor: $checkedConvert('japan_land_color',
              (v) => const ColorConverter().fromJson(v as String)),
          japanLineColor: $checkedConvert('japan_line_color',
              (v) => const ColorConverter().fromJson(v as String)),
        );
        return val;
      },
...
Map<String, dynamic> _$$MapStyleColorSchemeImplToJson(
    ...
    <String, dynamic>{
      ...
      'japan_land_color':
          const ColorConverter().toJson(instance.japanLandColor),
      'japan_line_color':
          const ColorConverter().toJson(instance.japanLineColor),
    };
