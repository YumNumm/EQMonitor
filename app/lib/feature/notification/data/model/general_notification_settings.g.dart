...
_GeneralNotificationSettings _$GeneralNotificationSettingsFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  '_GeneralNotificationSettings',
  json,
  ($checkedConvert) {
    final val = _GeneralNotificationSettings(
...
Map<String, dynamic> _$GeneralNotificationSettingsToJson(
  _GeneralNotificationSettings instance,
) => <String, dynamic>{
