...
class _TrackedRegionStation implements TrackedRegionStation {
  const _TrackedRegionStation({required this.code, required this.name, required final  Tracked<TsunamiStationForecast?> forecast, required final  Tracked<TsunamiStationObservation?> observation}): _forecast = forecast,_observation = observation;
