...
class _TrackedTsunamiTimeline implements TrackedTsunamiTimeline {
  const _TrackedTsunamiTimeline({required final  List<TsunamiTelegramMeta> telegrams, required final  List<TrackedRegion> regions, required final  List<TrackedOffshoreStation> offshoreStations}): _telegrams = telegrams,_regions = regions,_offshoreStations = offshoreStations;
