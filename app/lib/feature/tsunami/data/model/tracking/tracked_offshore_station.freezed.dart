...
class _TrackedOffshoreStation implements TrackedOffshoreStation {
  const _TrackedOffshoreStation({required this.code, required this.name, required final  Tracked<TsunamiObservationFirstHeight> firstHeight, required final  Tracked<TsunamiObservationMaxHeight?> maxHeight}): _firstHeight = firstHeight,_maxHeight = maxHeight;
