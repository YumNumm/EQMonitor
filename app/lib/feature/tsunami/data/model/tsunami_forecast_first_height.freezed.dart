...
mixin _$TsunamiForecastFirstHeight {
 ...
 DateTime? get arrivalTime; FirstHeightCondition? get condition; Revise? get revise;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TsunamiForecastFirstHeight&&(identical(other.arrivalTime, arrivalTime) || other.arrivalTime == arrivalTime)&&(identical(other.condition, condition) || other.condition == condition)&&(identical(other.revise, revise) || other.revise == revise));
}
...
@override
String toString() {
  return 'TsunamiForecastFirstHeight(arrivalTime: $arrivalTime, condition: $condition, revise: $revise)';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? arrivalTime = freezed,Object? condition = freezed,Object? revise = freezed,}) {
  return _then(TsunamiForecastFirstHeight(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( DateTime? arrivalTime,  FirstHeightCondition? condition,  Revise? revise)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TsunamiForecastFirstHeight() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( DateTime? arrivalTime,  FirstHeightCondition? condition,  Revise? revise)  $default,) {final _that = this;
switch (_that) {
case _TsunamiForecastFirstHeight():
return $default(_that.arrivalTime,_that.condition,_that.revise);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( DateTime? arrivalTime,  FirstHeightCondition? condition,  Revise? revise)?  $default,) {final _that = this;
switch (_that) {
case _TsunamiForecastFirstHeight() when $default != null:
return $default(_that.arrivalTime,_that.condition,_that.revise);case _:
  return null;
...
class _TsunamiForecastFirstHeight implements TsunamiForecastFirstHeight {
  const _TsunamiForecastFirstHeight({required this.arrivalTime, required this.condition, required this.revise});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TsunamiForecastFirstHeight&&(identical(other.arrivalTime, arrivalTime) || other.arrivalTime == arrivalTime)&&(identical(other.condition, condition) || other.condition == condition)&&(identical(other.revise, revise) || other.revise == revise));
}
