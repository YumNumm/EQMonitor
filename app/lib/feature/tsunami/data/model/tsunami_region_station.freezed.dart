...
mixin _$TsunamiRegionStation {
 ...
 String get code; String get name; TsunamiStationForecast? get forecast; TsunamiStationObservation? get observation;
...
@useResult
$Res call({
 String code, String name, TsunamiStationForecast? forecast, TsunamiStationObservation? observation
});
...
@pragma('vm:prefer-inline') @override $Res call({Object? code = null,Object? name = null,Object? forecast = freezed,Object? observation = freezed,}) {
  return _then(TsunamiRegionStation(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String code,  String name,  TsunamiStationForecast? forecast,  TsunamiStationObservation? observation)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TsunamiRegionStation() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String code,  String name,  TsunamiStationForecast? forecast,  TsunamiStationObservation? observation)  $default,) {final _that = this;
switch (_that) {
case _TsunamiRegionStation():
return $default(_that.code,_that.name,_that.forecast,_that.observation);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String code,  String name,  TsunamiStationForecast? forecast,  TsunamiStationObservation? observation)?  $default,) {final _that = this;
switch (_that) {
case _TsunamiRegionStation() when $default != null:
return $default(_that.code,_that.name,_that.forecast,_that.observation);case _:
  return null;
...
class _TsunamiRegionStation implements TsunamiRegionStation {
  const _TsunamiRegionStation({required this.code, required this.name, this.forecast, this.observation});
  

@override final  String code;
@override final  String name;
@override final  TsunamiStationForecast? forecast;
@override final  TsunamiStationObservation? observation;
