...
mixin _$TsunamiRegion {
 ...
 String get code; String get name; TsunamiWarningKind get kind; TsunamiWarningKind get lastKind; List<TsunamiRegionStation> get stations; TsunamiRegionForecast? get forecast; TsunamiRegionEstimation? get estimation;
...
@useResult
$Res call({
 String code, String name, TsunamiWarningKind kind, TsunamiWarningKind lastKind, List<TsunamiRegionStation> stations, TsunamiRegionForecast? forecast, TsunamiRegionEstimation? estimation
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String code,  String name,  TsunamiWarningKind kind,  TsunamiWarningKind lastKind,  List<TsunamiRegionStation> stations,  TsunamiRegionForecast? forecast,  TsunamiRegionEstimation? estimation)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TsunamiRegion() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String code,  String name,  TsunamiWarningKind kind,  TsunamiWarningKind lastKind,  List<TsunamiRegionStation> stations,  TsunamiRegionForecast? forecast,  TsunamiRegionEstimation? estimation)  $default,) {final _that = this;
switch (_that) {
case _TsunamiRegion():
return $default(_that.code,_that.name,_that.kind,_that.lastKind,_that.stations,_that.forecast,_that.estimation);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String code,  String name,  TsunamiWarningKind kind,  TsunamiWarningKind lastKind,  List<TsunamiRegionStation> stations,  TsunamiRegionForecast? forecast,  TsunamiRegionEstimation? estimation)?  $default,) {final _that = this;
switch (_that) {
case _TsunamiRegion() when $default != null:
return $default(_that.code,_that.name,_that.kind,_that.lastKind,_that.stations,_that.forecast,_that.estimation);case _:
  return null;
...
class _TsunamiRegion implements TsunamiRegion {
  const _TsunamiRegion({required this.code, required this.name, required this.kind, required this.lastKind, required  List<TsunamiRegionStation> stations, this.forecast, this.estimation}): _stations = stations;
  

@override final  String code;
@override final  String name;
@override final  TsunamiWarningKind kind;
@override final  TsunamiWarningKind lastKind;
...
@override final  TsunamiRegionForecast? forecast;
@override final  TsunamiRegionEstimation? estimation;
