...
mixin _$TsunamiOffshoreStation {
 ...
 String get code; String get name; TsunamiObservationFirstHeight get firstHeight; String? get sensor; TsunamiObservationMaxHeight? get maxHeight;
...
@useResult
$Res call({
 String code, String name, TsunamiObservationFirstHeight firstHeight, String? sensor, TsunamiObservationMaxHeight? maxHeight
});
...
@pragma('vm:prefer-inline') @override $Res call({Object? code = null,Object? name = null,Object? firstHeight = null,Object? sensor = freezed,Object? maxHeight = freezed,}) {
  return _then(TsunamiOffshoreStation(
...
as TsunamiObservationFirstHeight,sensor: freezed == sensor ? _self.sensor : sensor // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String code,  String name,  TsunamiObservationFirstHeight firstHeight,  String? sensor,  TsunamiObservationMaxHeight? maxHeight)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TsunamiOffshoreStation() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String code,  String name,  TsunamiObservationFirstHeight firstHeight,  String? sensor,  TsunamiObservationMaxHeight? maxHeight)  $default,) {final _that = this;
switch (_that) {
case _TsunamiOffshoreStation():
return $default(_that.code,_that.name,_that.firstHeight,_that.sensor,_that.maxHeight);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String code,  String name,  TsunamiObservationFirstHeight firstHeight,  String? sensor,  TsunamiObservationMaxHeight? maxHeight)?  $default,) {final _that = this;
switch (_that) {
case _TsunamiOffshoreStation() when $default != null:
return $default(_that.code,_that.name,_that.firstHeight,_that.sensor,_that.maxHeight);case _:
  return null;
...
class _TsunamiOffshoreStation implements TsunamiOffshoreStation {
  const _TsunamiOffshoreStation({required this.code, required this.name, required this.firstHeight, this.sensor, this.maxHeight});
