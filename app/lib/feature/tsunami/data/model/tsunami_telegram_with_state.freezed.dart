...
mixin _$TsunamiTelegramWithState {
 ...
 TsunamiTelegramMeta get telegram; TsunamiState get state;
...
@useResult
$Res call({
 TsunamiTelegramMeta telegram, TsunamiState state
});


$TsunamiTelegramMetaCopyWith<$Res> get telegram;$TsunamiStateCopyWith<$Res> get state;
...
@pragma('vm:prefer-inline') @override $Res call({Object? telegram = null,Object? state = null,}) {
  return _then(TsunamiTelegramWithState(
telegram: null == telegram ? _self.telegram : telegram // ignore: cast_nullable_to_non_nullable
as TsunamiTelegramMeta,state: null == state ? _self.state : state // ignore: cast_nullable_to_non_nullable
as TsunamiState,
  ));
}
/// Create a copy of TsunamiTelegramWithState
...
@override
@pragma('vm:prefer-inline')
$TsunamiTelegramMetaCopyWith<$Res> get telegram {
  
  return $TsunamiTelegramMetaCopyWith<$Res>(_self.telegram, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( TsunamiTelegramMeta telegram,  TsunamiState state)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TsunamiTelegramWithState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( TsunamiTelegramMeta telegram,  TsunamiState state)  $default,) {final _that = this;
switch (_that) {
case _TsunamiTelegramWithState():
return $default(_that.telegram,_that.state);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( TsunamiTelegramMeta telegram,  TsunamiState state)?  $default,) {final _that = this;
switch (_that) {
case _TsunamiTelegramWithState() when $default != null:
return $default(_that.telegram,_that.state);case _:
  return null;
...
@override final  TsunamiTelegramMeta telegram;
...
@override $TsunamiTelegramMetaCopyWith<$Res> get telegram;@override $TsunamiStateCopyWith<$Res> get state;
