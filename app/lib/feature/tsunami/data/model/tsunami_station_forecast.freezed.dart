...
mixin _$TsunamiStationForecast {
 ...
 DateTime get highTideAt; TsunamiForecastFirstHeight? get firstHeight;
...
@useResult
$Res call({
 DateTime highTideAt, TsunamiForecastFirstHeight? firstHeight
});
...
@pragma('vm:prefer-inline') @override $Res call({Object? highTideAt = null,Object? firstHeight = freezed,}) {
  return _then(TsunamiStationForecast(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( DateTime highTideAt,  TsunamiForecastFirstHeight? firstHeight)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TsunamiStationForecast() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( DateTime highTideAt,  TsunamiForecastFirstHeight? firstHeight)  $default,) {final _that = this;
switch (_that) {
case _TsunamiStationForecast():
return $default(_that.highTideAt,_that.firstHeight);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( DateTime highTideAt,  TsunamiForecastFirstHeight? firstHeight)?  $default,) {final _that = this;
switch (_that) {
case _TsunamiStationForecast() when $default != null:
return $default(_that.highTideAt,_that.firstHeight);case _:
  return null;
...
class _TsunamiStationForecast implements TsunamiStationForecast {
  const _TsunamiStationForecast({required this.highTideAt, required this.firstHeight});
