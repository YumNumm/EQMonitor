...
mixin _$HighestIntensityResponse {
 ...
 DateTime get aggregatedAt; List<HighestIntensityEntry> get items;
...
@useResult
$Res call({
 DateTime aggregatedAt, List<HighestIntensityEntry> items
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( DateTime aggregatedAt,  List<HighestIntensityEntry> items)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HighestIntensityResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( DateTime aggregatedAt,  List<HighestIntensityEntry> items)  $default,) {final _that = this;
switch (_that) {
case _HighestIntensityResponse():
return $default(_that.aggregatedAt,_that.items);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( DateTime aggregatedAt,  List<HighestIntensityEntry> items)?  $default,) {final _that = this;
switch (_that) {
case _HighestIntensityResponse() when $default != null:
return $default(_that.aggregatedAt,_that.items);case _:
  return null;
...
class _HighestIntensityResponse implements HighestIntensityResponse {
  const _HighestIntensityResponse({required this.aggregatedAt, required  List<HighestIntensityEntry> items}): _items = items;
...
@override final  DateTime aggregatedAt;
 final  List<HighestIntensityEntry> _items;
@override List<HighestIntensityEntry> get items {
