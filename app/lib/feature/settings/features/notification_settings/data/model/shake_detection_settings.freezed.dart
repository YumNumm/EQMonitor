...
mixin _$ShakeDetectionEntry {
 ...
 String get id; String? get subRegionId; String? get subRegionName; api.ShakeDetectionLevel get minLevel; bool get isCurrentLocation;
...
@override
String toString() {
  return 'ShakeDetectionEntry(id: $id, subRegionId: $subRegionId, subRegionName: $subRegionName, minLevel: $minLevel, isCurrentLocation: $isCurrentLocation)';
}
...
@useResult
$Res call({
 String id, String? subRegionId, String? subRegionName, api.ShakeDetectionLevel minLevel, bool isCurrentLocation
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String? subRegionId,  String? subRegionName,  api.ShakeDetectionLevel minLevel,  bool isCurrentLocation)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ShakeDetectionEntry() when $default != null:
return $default(_that.id,_that.subRegionId,_that.subRegionName,_that.minLevel,_that.isCurrentLocation);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String? subRegionId,  String? subRegionName,  api.ShakeDetectionLevel minLevel,  bool isCurrentLocation)  $default,) {final _that = this;
switch (_that) {
case _ShakeDetectionEntry():
return $default(_that.id,_that.subRegionId,_that.subRegionName,_that.minLevel,_that.isCurrentLocation);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String? subRegionId,  String? subRegionName,  api.ShakeDetectionLevel minLevel,  bool isCurrentLocation)?  $default,) {final _that = this;
switch (_that) {
case _ShakeDetectionEntry() when $default != null:
return $default(_that.id,_that.subRegionId,_that.subRegionName,_that.minLevel,_that.isCurrentLocation);case _:
  return null;
...
class _ShakeDetectionEntry implements ShakeDetectionEntry {
  const _ShakeDetectionEntry({required this.id, required this.subRegionId, required this.subRegionName, required this.minLevel, required this.isCurrentLocation});
