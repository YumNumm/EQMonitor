...
class EewEstimatedIntensityLayerDebugPage extends BaseLayerDebugPage {
  ...
  @override
  String get description => 'EEW予想震度レイヤーは、緊急地震速報の予想震度を地図上に表示します。'
    ...
    return Column(
      ...
      children: [
        ...
        ListTile(
          ...
          subtitle: Text('${((layerParams.value['fillOpacity'] as double) * 100).round()}%'),
        ),
        Slider(
          min: 0.1,
          max: 1.0,
          ...
          label: '${((layerParams.value['fillOpacity'] as double) * 100).round()}%',
          onChanged: (value) {
            layerParams.value = {
              ...layerParams.value,
              'fillOpacity': value,
        ...
        SwitchListTile(
          ...
          subtitle: Text(layerParams.value['showBorder'] as bool ? 'ON' : 'OFF'),
              ...
              builder: (context) => AlertDialog(
                ...
                content: SingleChildScrollView(
                  child: _ColorPickerSimple(
                    ...
                    selectedColor: Color(layerParams.value['borderColor'] as int),
