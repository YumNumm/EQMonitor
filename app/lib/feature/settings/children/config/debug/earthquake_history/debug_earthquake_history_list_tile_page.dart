      ...
      body: ListView(
        children: [
          ...
          for (final intensity in _domesticIntensities)
            EarthquakeHistoryListTile(
              item: EarthquakePartial.normal(
                eventId: 'debug-domestic-${intensity.name}',
              ...
              searchParameter: const EarthquakeHistoryParameter.all(
                sortBy: .eventId,
                sortOrder: .asc,
              ),
              onTap: () {},
          ...
          for (final entry in _searchAreaSamples)
            EarthquakeHistoryListTile(
              item: EarthquakePartial.normal(
                eventId: 'debug-domestic-${entry.maxIntensity.name}',
                status: TelegramStatus.normal,
                originTime: DateTime(2024, 1, 1, 12),
                originTimePrecision: OriginTimePrecision.second,
                arrivalTime: null,
...
_searchAreaSamples = [
  (
    ...
    areaInfo: const IntensityAreaInfo(
      code: '330',
      name: LocalizedName(ja: '東京都23区', en: 'Tokyo 23 Ward'),
  ...
  (
    ...
    areaInfo: const IntensityAreaInfo(
      code: '270',
      name: LocalizedName(ja: '大阪府', en: 'Osaka Prefecture'),
