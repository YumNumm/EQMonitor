...
mixin _$EarthquakeVxseDebugDraft {
 ...
 String get eventId; DateTime get reportedAt; List<EarthquakeTelegramComment> get comments;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EarthquakeVxseDebugDraft&&(identical(other.eventId, eventId) || other.eventId == eventId)&&(identical(other.reportedAt, reportedAt) || other.reportedAt == reportedAt)&&const DeepCollectionEquality().equals(other.comments, comments));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,eventId,reportedAt,const DeepCollectionEquality().hash(comments));

@override
String toString() {
  return 'EarthquakeVxseDebugDraft(eventId: $eventId, reportedAt: $reportedAt, comments: $comments)';
}
...
@useResult
$Res call({
 String eventId, DateTime reportedAt, List<EarthquakeTelegramComment> comments
});
...
/// Create a copy of EarthquakeVxseDebugDraft
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? eventId = null,Object? reportedAt = null,Object? comments = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String eventId,  DateTime reportedAt,  JmaIntensity maxIntensity,  Map<JmaIntensity, List<IntensityRegion>> regions,  Map<JmaIntensity, List<IntensityPrefecture>> prefectures,  List<EarthquakeTelegramComment> comments)?  vxse51,TResult Function( String eventId,  DateTime reportedAt,  EarthquakeHypocenter hypocenter,  List<EarthquakeTelegramComment> comments)?  vxse52,TResult Function( String eventId,  DateTime reportedAt,  EarthquakeHypocenter hypocenter,  JmaIntensity maxIntensity,  Map<JmaIntensity, List<IntensityRegion>> regions,  Map<JmaIntensity, List<PrefectureIntensityNode>> intensityTree,  List<EarthquakeTelegramComment> comments)?  vxse53,TResult Function( String eventId,  DateTime reportedAt,  EarthquakeHypocenter hypocenter,  List<EarthquakeTelegramComment> comments)?  vxse61,TResult Function( String eventId,  DateTime reportedAt,  EarthquakeHypocenter hypocenter,  JmaLpgmIntensity maxLpgmIntensity,  Map<JmaLpgmIntensity, List<LpgmIntensityRegion>> lpgmRegions,  Map<JmaLpgmIntensity, List<PrefectureLpgmIntensityNode>> lpgmIntensityTree,  List<EarthquakeTelegramComment> comments)?  vxse62,required TResult orElse(),}) {final _that = this;
switch (_that) {
case EarthquakeVxse51DebugDraft() when vxse51 != null:
return vxse51(_that.eventId,_that.reportedAt,_that.maxIntensity,_that.regions,_that.prefectures,_that.comments);case EarthquakeVxse52DebugDraft() when vxse52 != null:
return vxse52(_that.eventId,_that.reportedAt,_that.hypocenter,_that.comments);case EarthquakeVxse53DebugDraft() when vxse53 != null:
return vxse53(_that.eventId,_that.reportedAt,_that.hypocenter,_that.maxIntensity,_that.regions,_that.intensityTree,_that.comments);case EarthquakeVxse61DebugDraft() when vxse61 != null:
return vxse61(_that.eventId,_that.reportedAt,_that.hypocenter,_that.comments);case EarthquakeVxse62DebugDraft() when vxse62 != null:
return vxse62(_that.eventId,_that.reportedAt,_that.hypocenter,_that.maxLpgmIntensity,_that.lpgmRegions,_that.lpgmIntensityTree,_that.comments);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String eventId,  DateTime reportedAt,  JmaIntensity maxIntensity,  Map<JmaIntensity, List<IntensityRegion>> regions,  Map<JmaIntensity, List<IntensityPrefecture>> prefectures,  List<EarthquakeTelegramComment> comments)  vxse51,required TResult Function( String eventId,  DateTime reportedAt,  EarthquakeHypocenter hypocenter,  List<EarthquakeTelegramComment> comments)  vxse52,required TResult Function( String eventId,  DateTime reportedAt,  EarthquakeHypocenter hypocenter,  JmaIntensity maxIntensity,  Map<JmaIntensity, List<IntensityRegion>> regions,  Map<JmaIntensity, List<PrefectureIntensityNode>> intensityTree,  List<EarthquakeTelegramComment> comments)  vxse53,required TResult Function( String eventId,  DateTime reportedAt,  EarthquakeHypocenter hypocenter,  List<EarthquakeTelegramComment> comments)  vxse61,required TResult Function( String eventId,  DateTime reportedAt,  EarthquakeHypocenter hypocenter,  JmaLpgmIntensity maxLpgmIntensity,  Map<JmaLpgmIntensity, List<LpgmIntensityRegion>> lpgmRegions,  Map<JmaLpgmIntensity, List<PrefectureLpgmIntensityNode>> lpgmIntensityTree,  List<EarthquakeTelegramComment> comments)  vxse62,}) {final _that = this;
switch (_that) {
case EarthquakeVxse51DebugDraft():
return vxse51(_that.eventId,_that.reportedAt,_that.maxIntensity,_that.regions,_that.prefectures,_that.comments);case EarthquakeVxse52DebugDraft():
return vxse52(_that.eventId,_that.reportedAt,_that.hypocenter,_that.comments);case EarthquakeVxse53DebugDraft():
return vxse53(_that.eventId,_that.reportedAt,_that.hypocenter,_that.maxIntensity,_that.regions,_that.intensityTree,_that.comments);case EarthquakeVxse61DebugDraft():
return vxse61(_that.eventId,_that.reportedAt,_that.hypocenter,_that.comments);case EarthquakeVxse62DebugDraft():
return vxse62(_that.eventId,_that.reportedAt,_that.hypocenter,_that.maxLpgmIntensity,_that.lpgmRegions,_that.lpgmIntensityTree,_that.comments);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String eventId,  DateTime reportedAt,  JmaIntensity maxIntensity,  Map<JmaIntensity, List<IntensityRegion>> regions,  Map<JmaIntensity, List<IntensityPrefecture>> prefectures,  List<EarthquakeTelegramComment> comments)?  vxse51,TResult? Function( String eventId,  DateTime reportedAt,  EarthquakeHypocenter hypocenter,  List<EarthquakeTelegramComment> comments)?  vxse52,TResult? Function( String eventId,  DateTime reportedAt,  EarthquakeHypocenter hypocenter,  JmaIntensity maxIntensity,  Map<JmaIntensity, List<IntensityRegion>> regions,  Map<JmaIntensity, List<PrefectureIntensityNode>> intensityTree,  List<EarthquakeTelegramComment> comments)?  vxse53,TResult? Function( String eventId,  DateTime reportedAt,  EarthquakeHypocenter hypocenter,  List<EarthquakeTelegramComment> comments)?  vxse61,TResult? Function( String eventId,  DateTime reportedAt,  EarthquakeHypocenter hypocenter,  JmaLpgmIntensity maxLpgmIntensity,  Map<JmaLpgmIntensity, List<LpgmIntensityRegion>> lpgmRegions,  Map<JmaLpgmIntensity, List<PrefectureLpgmIntensityNode>> lpgmIntensityTree,  List<EarthquakeTelegramComment> comments)?  vxse62,}) {final _that = this;
switch (_that) {
case EarthquakeVxse51DebugDraft() when vxse51 != null:
return vxse51(_that.eventId,_that.reportedAt,_that.maxIntensity,_that.regions,_that.prefectures,_that.comments);case EarthquakeVxse52DebugDraft() when vxse52 != null:
return vxse52(_that.eventId,_that.reportedAt,_that.hypocenter,_that.comments);case EarthquakeVxse53DebugDraft() when vxse53 != null:
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,eventId,reportedAt,maxIntensity,const DeepCollectionEquality().hash(_regions),const DeepCollectionEquality().hash(_prefectures),const DeepCollectionEquality().hash(_comments));

@override
String toString() {
  return 'EarthquakeVxseDebugDraft.vxse51(eventId: $eventId, reportedAt: $reportedAt, maxIntensity: $maxIntensity, regions: $regions, prefectures: $prefectures, comments: $comments)';
}
...
@override @useResult
$Res call({
 String eventId, DateTime reportedAt, JmaIntensity maxIntensity, Map<JmaIntensity, List<IntensityRegion>> regions, Map<JmaIntensity, List<IntensityPrefecture>> prefectures, List<EarthquakeTelegramComment> comments
});
...
/// Create a copy of EarthquakeVxseDebugDraft
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? eventId = null,Object? reportedAt = null,Object? maxIntensity = null,Object? regions = null,Object? prefectures = null,Object? comments = null,}) {
...
class EarthquakeVxse52DebugDraft implements EarthquakeVxseDebugDraft {
  const EarthquakeVxse52DebugDraft({required this.eventId, required this.reportedAt, required this.hypocenter, required final  List<EarthquakeTelegramComment> comments, final  String? $type}): _comments = comments,$type = $type ?? 'VXSE52';
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,eventId,reportedAt,hypocenter,const DeepCollectionEquality().hash(_comments));

@override
String toString() {
  return 'EarthquakeVxseDebugDraft.vxse52(eventId: $eventId, reportedAt: $reportedAt, hypocenter: $hypocenter, comments: $comments)';
}
...
@override @useResult
$Res call({
 String eventId, DateTime reportedAt, EarthquakeHypocenter hypocenter, List<EarthquakeTelegramComment> comments
});
...
/// Create a copy of EarthquakeVxseDebugDraft
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? eventId = null,Object? reportedAt = null,Object? hypocenter = null,Object? comments = null,}) {
...
class EarthquakeVxse53DebugDraft implements EarthquakeVxseDebugDraft {
  const EarthquakeVxse53DebugDraft({required this.eventId, required this.reportedAt, required this.hypocenter, required this.maxIntensity, required final  Map<JmaIntensity, List<IntensityRegion>> regions, required final  Map<JmaIntensity, List<PrefectureIntensityNode>> intensityTree, required final  List<EarthquakeTelegramComment> comments, final  String? $type}): _regions = regions,_intensityTree = intensityTree,_comments = comments,$type = $type ?? 'VXSE53';
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,eventId,reportedAt,hypocenter,maxIntensity,const DeepCollectionEquality().hash(_regions),const DeepCollectionEquality().hash(_intensityTree),const DeepCollectionEquality().hash(_comments));

@override
String toString() {
  return 'EarthquakeVxseDebugDraft.vxse53(eventId: $eventId, reportedAt: $reportedAt, hypocenter: $hypocenter, maxIntensity: $maxIntensity, regions: $regions, intensityTree: $intensityTree, comments: $comments)';
}
...
@override @useResult
$Res call({
 String eventId, DateTime reportedAt, EarthquakeHypocenter hypocenter, JmaIntensity maxIntensity, Map<JmaIntensity, List<IntensityRegion>> regions, Map<JmaIntensity, List<PrefectureIntensityNode>> intensityTree, List<EarthquakeTelegramComment> comments
});
...
/// Create a copy of EarthquakeVxseDebugDraft
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? eventId = null,Object? reportedAt = null,Object? hypocenter = null,Object? maxIntensity = null,Object? regions = null,Object? intensityTree = null,Object? comments = null,}) {
...
class EarthquakeVxse61DebugDraft implements EarthquakeVxseDebugDraft {
  const EarthquakeVxse61DebugDraft({required this.eventId, required this.reportedAt, required this.hypocenter, required final  List<EarthquakeTelegramComment> comments, final  String? $type}): _comments = comments,$type = $type ?? 'VXSE61';
...
@override
String toString() {
  return 'EarthquakeVxseDebugDraft.vxse61(eventId: $eventId, reportedAt: $reportedAt, hypocenter: $hypocenter, comments: $comments)';
}
...
class EarthquakeVxse62DebugDraft implements EarthquakeVxseDebugDraft {
  const EarthquakeVxse62DebugDraft({required this.eventId, required this.reportedAt, required this.hypocenter, required this.maxLpgmIntensity, required final  Map<JmaLpgmIntensity, List<LpgmIntensityRegion>> lpgmRegions, required final  Map<JmaLpgmIntensity, List<PrefectureLpgmIntensityNode>> lpgmIntensityTree, required final  List<EarthquakeTelegramComment> comments, final  String? $type}): _lpgmRegions = lpgmRegions,_lpgmIntensityTree = lpgmIntensityTree,_comments = comments,$type = $type ?? 'VXSE62';
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EarthquakeVxse62DebugDraft&&(identical(other.eventId, eventId) || other.eventId == eventId)&&(identical(other.reportedAt, reportedAt) || other.reportedAt == reportedAt)&&(identical(other.hypocenter, hypocenter) || other.hypocenter == hypocenter)&&(identical(other.maxLpgmIntensity, maxLpgmIntensity) || other.maxLpgmIntensity == maxLpgmIntensity)&&const DeepCollectionEquality().equals(other._lpgmRegions, _lpgmRegions)&&const DeepCollectionEquality().equals(other._lpgmIntensityTree, _lpgmIntensityTree)&&const DeepCollectionEquality().equals(other._comments, _comments));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,eventId,reportedAt,hypocenter,maxLpgmIntensity,const DeepCollectionEquality().hash(_lpgmRegions),const DeepCollectionEquality().hash(_lpgmIntensityTree),const DeepCollectionEquality().hash(_comments));

@override
String toString() {
  return 'EarthquakeVxseDebugDraft.vxse62(eventId: $eventId, reportedAt: $reportedAt, hypocenter: $hypocenter, maxLpgmIntensity: $maxLpgmIntensity, lpgmRegions: $lpgmRegions, lpgmIntensityTree: $lpgmIntensityTree, comments: $comments)';
}
...
@override @useResult
$Res call({
 String eventId, DateTime reportedAt, EarthquakeHypocenter hypocenter, JmaLpgmIntensity maxLpgmIntensity, Map<JmaLpgmIntensity, List<LpgmIntensityRegion>> lpgmRegions, Map<JmaLpgmIntensity, List<PrefectureLpgmIntensityNode>> lpgmIntensityTree, List<EarthquakeTelegramComment> comments
});
...
/// Create a copy of EarthquakeVxseDebugDraft
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? eventId = null,Object? reportedAt = null,Object? hypocenter = null,Object? maxLpgmIntensity = null,Object? lpgmRegions = null,Object? lpgmIntensityTree = null,Object? comments = null,}) {
  return _then(EarthquakeVxse62DebugDraft(
eventId: null == eventId ? _self.eventId : eventId // ignore: cast_nullable_to_non_nullable
as String,reportedAt: null == reportedAt ? _self.reportedAt : reportedAt // ignore: cast_nullable_to_non_nullable
as DateTime,hypocenter: null == hypocenter ? _self.hypocenter : hypocenter // ignore: cast_nullable_to_non_nullable
as EarthquakeHypocenter,maxLpgmIntensity: null == maxLpgmIntensity ? _self.maxLpgmIntensity : maxLpgmIntensity // ignore: cast_nullable_to_non_nullable
as JmaLpgmIntensity,lpgmRegions: null == lpgmRegions ? _self._lpgmRegions : lpgmRegions // ignore: cast_nullable_to_non_nullable
