...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( CoordinateUnknown value)?  unknown,TResult Function( CoordinateLatLng value)?  latLng,required TResult orElse(),}){
final _that = this;
switch (_that) {
case CoordinateUnknown() when unknown != null:
return unknown(_that);case CoordinateLatLng() when latLng != null:
return latLng(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( CoordinateUnknown value)  unknown,required TResult Function( CoordinateLatLng value)  latLng,}){
final _that = this;
switch (_that) {
case CoordinateUnknown():
return unknown(_that);case CoordinateLatLng():
return latLng(_that);}
}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( CoordinateUnknown value)?  unknown,TResult? Function( CoordinateLatLng value)?  latLng,}){
final _that = this;
switch (_that) {
case CoordinateUnknown() when unknown != null:
return unknown(_that);case CoordinateLatLng() when latLng != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  unknown,TResult Function( double latitude,  double longitude)?  latLng,required TResult orElse(),}) {final _that = this;
switch (_that) {
case CoordinateUnknown() when unknown != null:
return unknown();case CoordinateLatLng() when latLng != null:
return latLng(_that.latitude,_that.longitude);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  unknown,required TResult Function( double latitude,  double longitude)  latLng,}) {final _that = this;
switch (_that) {
case CoordinateUnknown():
return unknown();case CoordinateLatLng():
return latLng(_that.latitude,_that.longitude);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  unknown,TResult? Function( double latitude,  double longitude)?  latLng,}) {final _that = this;
switch (_that) {
case CoordinateUnknown() when unknown != null:
return unknown();case CoordinateLatLng() when latLng != null:
return latLng(_that.latitude,_that.longitude);case _:
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CoordinateUnknown);
}
