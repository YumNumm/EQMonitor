...
mixin _$EarthquakeIntensity {
 ...
 JmaIntensity get maxIntensity; JmaLpgmIntensity? get maxLpgmIntensity; Map<JmaIntensity, List<RegionIntensityNode>> get intensityTree; Map<JmaLpgmIntensity, List<RegionLpgmIntensityNode>> get lpgmIntensityTree;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EarthquakeIntensity&&(identical(other.maxIntensity, maxIntensity) || other.maxIntensity == maxIntensity)&&(identical(other.maxLpgmIntensity, maxLpgmIntensity) || other.maxLpgmIntensity == maxLpgmIntensity)&&const DeepCollectionEquality().equals(other.intensityTree, intensityTree)&&const DeepCollectionEquality().equals(other.lpgmIntensityTree, lpgmIntensityTree));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,maxIntensity,maxLpgmIntensity,const DeepCollectionEquality().hash(intensityTree),const DeepCollectionEquality().hash(lpgmIntensityTree));

@override
String toString() {
  return 'EarthquakeIntensity(maxIntensity: $maxIntensity, maxLpgmIntensity: $maxLpgmIntensity, intensityTree: $intensityTree, lpgmIntensityTree: $lpgmIntensityTree)';
}
...
@useResult
$Res call({
 JmaIntensity maxIntensity, JmaLpgmIntensity? maxLpgmIntensity, Map<JmaIntensity, List<RegionIntensityNode>> intensityTree, Map<JmaLpgmIntensity, List<RegionLpgmIntensityNode>> lpgmIntensityTree
});
...
/// Create a copy of EarthquakeIntensity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? maxIntensity = null,Object? maxLpgmIntensity = freezed,Object? intensityTree = null,Object? lpgmIntensityTree = null,}) {
...
as Map<JmaIntensity, List<RegionIntensityNode>>,lpgmIntensityTree: null == lpgmIntensityTree ? _self.lpgmIntensityTree : lpgmIntensityTree // ignore: cast_nullable_to_non_nullable
as Map<JmaLpgmIntensity, List<RegionLpgmIntensityNode>>,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( JmaIntensity maxIntensity,  JmaLpgmIntensity? maxLpgmIntensity,  Map<JmaIntensity, List<RegionIntensityNode>> intensityTree,  Map<JmaLpgmIntensity, List<RegionLpgmIntensityNode>> lpgmIntensityTree)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EarthquakeIntensity() when $default != null:
return $default(_that.maxIntensity,_that.maxLpgmIntensity,_that.intensityTree,_that.lpgmIntensityTree);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( JmaIntensity maxIntensity,  JmaLpgmIntensity? maxLpgmIntensity,  Map<JmaIntensity, List<RegionIntensityNode>> intensityTree,  Map<JmaLpgmIntensity, List<RegionLpgmIntensityNode>> lpgmIntensityTree)  $default,) {final _that = this;
switch (_that) {
case _EarthquakeIntensity():
return $default(_that.maxIntensity,_that.maxLpgmIntensity,_that.intensityTree,_that.lpgmIntensityTree);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( JmaIntensity maxIntensity,  JmaLpgmIntensity? maxLpgmIntensity,  Map<JmaIntensity, List<RegionIntensityNode>> intensityTree,  Map<JmaLpgmIntensity, List<RegionLpgmIntensityNode>> lpgmIntensityTree)?  $default,) {final _that = this;
switch (_that) {
case _EarthquakeIntensity() when $default != null:
return $default(_that.maxIntensity,_that.maxLpgmIntensity,_that.intensityTree,_that.lpgmIntensityTree);case _:
  return null;
...
class _EarthquakeIntensity implements EarthquakeIntensity {
  const _EarthquakeIntensity({required this.maxIntensity, required this.maxLpgmIntensity, required final  Map<JmaIntensity, List<RegionIntensityNode>> intensityTree, required final  Map<JmaLpgmIntensity, List<RegionLpgmIntensityNode>> lpgmIntensityTree}): _intensityTree = intensityTree,_lpgmIntensityTree = lpgmIntensityTree;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _EarthquakeIntensity&&(identical(other.maxIntensity, maxIntensity) || other.maxIntensity == maxIntensity)&&(identical(other.maxLpgmIntensity, maxLpgmIntensity) || other.maxLpgmIntensity == maxLpgmIntensity)&&const DeepCollectionEquality().equals(other._intensityTree, _intensityTree)&&const DeepCollectionEquality().equals(other._lpgmIntensityTree, _lpgmIntensityTree));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,maxIntensity,maxLpgmIntensity,const DeepCollectionEquality().hash(_intensityTree),const DeepCollectionEquality().hash(_lpgmIntensityTree));
...
/// Create a copy of EarthquakeIntensity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? maxIntensity = null,Object? maxLpgmIntensity = freezed,Object? intensityTree = null,Object? lpgmIntensityTree = null,}) {
...
as Map<JmaIntensity, List<RegionIntensityNode>>,lpgmIntensityTree: null == lpgmIntensityTree ? _self._lpgmIntensityTree : lpgmIntensityTree // ignore: cast_nullable_to_non_nullable
as Map<JmaLpgmIntensity, List<RegionLpgmIntensityNode>>,
  ));
}
