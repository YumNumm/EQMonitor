...
Duration? kyoshinMonitorEffectiveOffset(Ref ref) {
  ...
  return switch (api.delayAdjustType) {
    .latestJson || .latestJsonMultiple => publishDelay,
    .imageFetch404DeviceTime ||
    .imageFetch404Ntp => KyoshinMonitorDelayAdjuster.effectiveOffset(
      publishDelay: publishDelay,
      adjustment: adjustments[settings.delayProfile] ?? Duration.zero,
