...
final class LiveMonitorEarthquakePresentation {
  ...
  factory forSplit({
    ...
    return LiveMonitorEarthquakePresentation._(
      displayMode: LiveMonitorEarthquakeCardPresenter.preferredIntensityMode(
...
class LiveMonitorEarthquakeCardPresenter {
  ...
  static LiveMonitorEarthquakeTrigger? latestSupportedTelegramTrigger(
    Earthquake earthquake,
  ) {
  ...
  static List<EewTelegramItem> orderedEews(List<EewTelegramItem> eews) {
    final ordered = [...eews]
      ..sort((left, right) {
  ...
  static List<ShakeDetectionEvent> orderedShakes(
