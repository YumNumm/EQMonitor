...
class DioExceptionMapper {
  static DeviceProvisioningException map(DioException e, [StackTrace? stack]) {
    // AppCheck 失敗は最優先で判定
  ...
  static DeviceProvisioningException _fromStatus(
    int? statusCode,
    DioException e,
    StackTrace? stack,
  ) {
    ...
    return switch (statusCode) {
      ...
      final int s when s == 400 || s == 422 => InvalidRequestException(
        statusCode: s,
        body: body,
        cause: e,
        stackTrace: stack,
