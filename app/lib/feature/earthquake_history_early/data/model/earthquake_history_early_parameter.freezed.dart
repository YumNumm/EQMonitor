...
/// Adds pattern-matching-related methods to [EarthquakeHistoryEarlyParameter].
extension EarthquakeHistoryEarlyParameterPatterns on EarthquakeHistoryEarlyParameter {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _EarthquakeHistoryEarlyParameter value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _EarthquakeHistoryEarlyParameter() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _EarthquakeHistoryEarlyParameter value)  $default,){
final _that = this;
switch (_that) {
case _EarthquakeHistoryEarlyParameter():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _EarthquakeHistoryEarlyParameter value)?  $default,){
final _that = this;
switch (_that) {
case _EarthquakeHistoryEarlyParameter() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( EarthquakeEarlySortType sort,  bool ascending,  double? magnitudeLte,  double? magnitudeGte,  double? depthLte,  double? depthGte,  JmaIntensity? intensityLte,  JmaIntensity? intensityGte,  DateTime? originTimeLte,  DateTime? originTimeGte)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EarthquakeHistoryEarlyParameter() when $default != null:
return $default(_that.sort,_that.ascending,_that.magnitudeLte,_that.magnitudeGte,_that.depthLte,_that.depthGte,_that.intensityLte,_that.intensityGte,_that.originTimeLte,_that.originTimeGte);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( EarthquakeEarlySortType sort,  bool ascending,  double? magnitudeLte,  double? magnitudeGte,  double? depthLte,  double? depthGte,  JmaIntensity? intensityLte,  JmaIntensity? intensityGte,  DateTime? originTimeLte,  DateTime? originTimeGte)  $default,) {final _that = this;
switch (_that) {
case _EarthquakeHistoryEarlyParameter():
return $default(_that.sort,_that.ascending,_that.magnitudeLte,_that.magnitudeGte,_that.depthLte,_that.depthGte,_that.intensityLte,_that.intensityGte,_that.originTimeLte,_that.originTimeGte);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( EarthquakeEarlySortType sort,  bool ascending,  double? magnitudeLte,  double? magnitudeGte,  double? depthLte,  double? depthGte,  JmaIntensity? intensityLte,  JmaIntensity? intensityGte,  DateTime? originTimeLte,  DateTime? originTimeGte)?  $default,) {final _that = this;
switch (_that) {
case _EarthquakeHistoryEarlyParameter() when $default != null:
return $default(_that.sort,_that.ascending,_that.magnitudeLte,_that.magnitudeGte,_that.depthLte,_that.depthGte,_that.intensityLte,_that.intensityGte,_that.originTimeLte,_that.originTimeGte);case _:
  return null;
