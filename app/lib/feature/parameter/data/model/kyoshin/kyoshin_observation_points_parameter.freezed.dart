...
mixin _$KyoshinObservationPoint {
 ...
 KyoshinObservationPointType get type; String get sourceType; String get name; String get code; String? get prefectureCode; String? get regionCode; bool get isSuspended; LatLng get location; KyoshinObservationPointMapPoint? get point;@JsonKey(name: 'arv_400') double? get arv400;
...
@useResult
$Res call({
 KyoshinObservationPointType type, String sourceType, String name, String code, String? prefectureCode, String? regionCode, bool isSuspended, LatLng location, KyoshinObservationPointMapPoint? point,@JsonKey(name: 'arv_400') double? arv400
});
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( KyoshinObservationPointType type,  String sourceType,  String name,  String code,  String? prefectureCode,  String? regionCode,  bool isSuspended,  LatLng location,  KyoshinObservationPointMapPoint? point, @JsonKey(name: 'arv_400')  double? arv400)  $default,) {final _that = this;
switch (_that) {
case _KyoshinObservationPoint():
return $default(_that.type,_that.sourceType,_that.name,_that.code,_that.prefectureCode,_that.regionCode,_that.isSuspended,_that.location,_that.point,_that.arv400);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( KyoshinObservationPointType type,  String sourceType,  String name,  String code,  String? prefectureCode,  String? regionCode,  bool isSuspended,  LatLng location,  KyoshinObservationPointMapPoint? point, @JsonKey(name: 'arv_400')  double? arv400)?  $default,) {final _that = this;
switch (_that) {
case _KyoshinObservationPoint() when $default != null:
return $default(_that.type,_that.sourceType,_that.name,_that.code,_that.prefectureCode,_that.regionCode,_that.isSuspended,_that.location,_that.point,_that.arv400);case _:
  return null;
...
class _KyoshinObservationPoint implements KyoshinObservationPoint {
  const _KyoshinObservationPoint({required this.type, required this.sourceType, required this.name, required this.code, required this.prefectureCode, required this.regionCode, required this.isSuspended, required this.location, required this.point, @JsonKey(name: 'arv_400') required this.arv400});
