...
class _ShakeDetectionSnapshot implements ShakeDetectionSnapshot {
  const _ShakeDetectionSnapshot({required this.revision, required this.responseAt, required  List<ShakeDetectionEvent> events, this.sourceRecord}): _events = events;
