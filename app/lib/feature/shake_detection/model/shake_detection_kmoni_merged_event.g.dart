...
_$$ShakeDetectionKmoniMergedEventImplFromJson(
  ...
  ($checkedConvert) {
    final val = _$ShakeDetectionKmoniMergedEventImpl(
      event: $checkedConvert(
        'event',
        (v) => ShakeDetectionEvent.fromJson(
      ...
      regions: $checkedConvert(
        ...
        (v) =>
            (v as List<dynamic>)
                .map(
                  (e) =>
                      ShakeDetectionKmoniMergedRegion.fromJson(
...
Map<String, dynamic>
_$$ShakeDetectionKmoniMergedEventImplToJson(
...
_$$ShakeDetectionKmoniMergedRegionImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
      ...
      points: $checkedConvert(
        ...
        (v) =>
            (v as List<dynamic>)
                .map(
                  (e) =>
                      ShakeDetectionKmoniMergedPoint.fromJson(
                        e as Map<String, dynamic>,
                      ),
                )
                .toList(),
...
Map<String, dynamic>
_$$ShakeDetectionKmoniMergedRegionImplToJson(
...
_$$ShakeDetectionKmoniMergedPointImplFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  ...
  ($checkedConvert) {
    final val = _$ShakeDetectionKmoniMergedPointImpl(
      ...
      point: $checkedConvert(
        'point',
        (v) =>
            KyoshinObservationPoint.fromJson(v as String),
      ),
    );
    return val;
  },
...
Map<String, dynamic>
_$$ShakeDetectionKmoniMergedPointImplToJson(
