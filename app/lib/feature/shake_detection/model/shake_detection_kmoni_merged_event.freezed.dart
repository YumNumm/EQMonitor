...
/// Adds pattern-matching-related methods to [ShakeDetectionKmoniMergedEvent].
extension ShakeDetectionKmoniMergedEventPatterns on ShakeDetectionKmoniMergedEvent {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ShakeDetectionKmoniMergedEvent value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ShakeDetectionKmoniMergedEvent() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ShakeDetectionKmoniMergedEvent value)  $default,){
final _that = this;
switch (_that) {
case _ShakeDetectionKmoniMergedEvent():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ShakeDetectionKmoniMergedEvent value)?  $default,){
final _that = this;
switch (_that) {
case _ShakeDetectionKmoniMergedEvent() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ShakeDetectionEvent event,  List<ShakeDetectionKmoniMergedRegion> regions)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ShakeDetectionKmoniMergedEvent() when $default != null:
return $default(_that.event,_that.regions);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ShakeDetectionEvent event,  List<ShakeDetectionKmoniMergedRegion> regions)  $default,) {final _that = this;
switch (_that) {
case _ShakeDetectionKmoniMergedEvent():
return $default(_that.event,_that.regions);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ShakeDetectionEvent event,  List<ShakeDetectionKmoniMergedRegion> regions)?  $default,) {final _that = this;
switch (_that) {
case _ShakeDetectionKmoniMergedEvent() when $default != null:
return $default(_that.event,_that.regions);case _:
  return null;
...
/// Adds pattern-matching-related methods to [ShakeDetectionKmoniMergedRegion].
extension ShakeDetectionKmoniMergedRegionPatterns on ShakeDetectionKmoniMergedRegion {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ShakeDetectionKmoniMergedRegion value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ShakeDetectionKmoniMergedRegion() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ShakeDetectionKmoniMergedRegion value)  $default,){
final _that = this;
switch (_that) {
case _ShakeDetectionKmoniMergedRegion():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ShakeDetectionKmoniMergedRegion value)?  $default,){
final _that = this;
switch (_that) {
case _ShakeDetectionKmoniMergedRegion() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name, @JsonKey(name: 'maxIntensity', unknownEnumValue: JmaForecastIntensity.unknown, defaultValue: JmaForecastIntensity.unknown)  JmaForecastIntensity maxIntensity,  List<ShakeDetectionKmoniMergedPoint> points)  $default,) {final _that = this;
switch (_that) {
case _ShakeDetectionKmoniMergedRegion():
return $default(_that.name,_that.maxIntensity,_that.points);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name, @JsonKey(name: 'maxIntensity', unknownEnumValue: JmaForecastIntensity.unknown, defaultValue: JmaForecastIntensity.unknown)  JmaForecastIntensity maxIntensity,  List<ShakeDetectionKmoniMergedPoint> points)?  $default,) {final _that = this;
switch (_that) {
case _ShakeDetectionKmoniMergedRegion() when $default != null:
return $default(_that.name,_that.maxIntensity,_that.points);case _:
  return null;
...
/// Adds pattern-matching-related methods to [ShakeDetectionKmoniMergedPoint].
extension ShakeDetectionKmoniMergedPointPatterns on ShakeDetectionKmoniMergedPoint {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ShakeDetectionKmoniMergedPoint value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ShakeDetectionKmoniMergedPoint() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ShakeDetectionKmoniMergedPoint value)  $default,){
final _that = this;
switch (_that) {
case _ShakeDetectionKmoniMergedPoint():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ShakeDetectionKmoniMergedPoint value)?  $default,){
final _that = this;
switch (_that) {
case _ShakeDetectionKmoniMergedPoint() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(unknownEnumValue: JmaForecastIntensity.unknown, defaultValue: JmaForecastIntensity.unknown)  JmaForecastIntensity intensity,  String code, @JsonKey(fromJson: KyoshinObservationPoint.fromJson, toJson: _pointToJson)  KyoshinObservationPoint point)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ShakeDetectionKmoniMergedPoint() when $default != null:
return $default(_that.intensity,_that.code,_that.point);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(unknownEnumValue: JmaForecastIntensity.unknown, defaultValue: JmaForecastIntensity.unknown)  JmaForecastIntensity intensity,  String code, @JsonKey(fromJson: KyoshinObservationPoint.fromJson, toJson: _pointToJson)  KyoshinObservationPoint point)  $default,) {final _that = this;
switch (_that) {
case _ShakeDetectionKmoniMergedPoint():
return $default(_that.intensity,_that.code,_that.point);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(unknownEnumValue: JmaForecastIntensity.unknown, defaultValue: JmaForecastIntensity.unknown)  JmaForecastIntensity intensity,  String code, @JsonKey(fromJson: KyoshinObservationPoint.fromJson, toJson: _pointToJson)  KyoshinObservationPoint point)?  $default,) {final _that = this;
switch (_that) {
case _ShakeDetectionKmoniMergedPoint() when $default != null:
return $default(_that.intensity,_that.code,_that.point);case _:
  return null;
