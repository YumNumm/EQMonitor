...
void main() {
  group('EarthquakeHistoryParameterMatch Extension', () {
    group('isRealtimeDataMatch', () {
      test(
    ...
    group('isEarthquakeV1Match', () {
      ...
      group('maxIntensity', () {
        ...
        test('maxIntensity < intensityGteはfalseを返す', () {
          // Arrange
          const parameter = EarthquakeHistoryParameter(
        ...
        test('intesityLte < maxIntensityはfalseを返す', () {
          // Arrange
          const parameter = EarthquakeHistoryParameter(
