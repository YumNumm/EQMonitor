...
1. 当方は、当方の判断において、いつでも本規約の内容を変更または追加できるものとします。変更後の利用規約は、当方が別途定める場合を除いて、本アプリ上または当方の運営するウェブサイト([https://emqonitor.pages.dev](https://emqonitor.pages.dev))に掲載します。これらの掲載方法についても、いつでも当方は変更できるものとします。
