...
1. 当方は、当方の判断において、いつでも本規約の内容を変更または追加できるものとします。変更後の利用規約は、当方が別途定める場合を除いて、本アプリ上または当方の運営するウェブサイト([https://eqmonitor.pages.dev](https://eqmonitor.pages.dev))に掲載します。これらの掲載方法についても、いつでも当方は変更できるものとします。
1. ユーザーは、変更後の本規約に同意しない場合には、本アプリをご利用いただくことができません。
1. 本規約が当方により変更または追加された際には、プッシュ通知経由でユーザに通知するともに、本規約改正後のアプリ初回起動時に変更後の利用規約に同意するかを選択する画面を表示します。ユーザが変更後の本規約に対して同意ボタンを押した時点で、変更後の本規約に同意したものとします。また、以前に同意したものがある場合は、新しい本規約に同意した時点で破棄されたものとします。
...
- 地震情報
気象庁から配信される緊急地震速報(予報、警報及び地震動予報を含む)の他に、震度速報(電文コードVXSE1.)、震源に関する情報(電文コードVXSE1.)、震源・震度に関する情報(電文コードVXSE1.)などのすべての地震に関する情報のことを指します。
