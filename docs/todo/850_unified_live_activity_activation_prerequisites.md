...
- 新型Widget非対応の旧アプリには統合Startを表示できない。公開だけで利用者が更新したとは判断せず、有効化対象の対応状況と切り替え方針を合意する。
...
完了条件は [実装計画の Task 6–7 とリリースゲート](../superpowers/plans/2026-09-12-unified-live-activity-ios.md)に従う。解消した項目に実施結果を追記し、契約・実機検証・本番有効化を区別する。
