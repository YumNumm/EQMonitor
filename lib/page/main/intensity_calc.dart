...
class IntensityCalcPage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final intensityCalcResult = useState<List<EstimatedShindoPoint>>([]);
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          final result = intensityCalc.estimateIntensity(
            ...
            obsPoints: ref.read(kmoniController).obsPoints,
          );
          intensityCalcResult.value = result;
                      ...
                      children: [
                        ...
                        CustomPaint(
                          painter: EstimatedShindoPainter(
                            estimatedShindoPoints: intensityCalcResult.value,
                          ),
                        ),
                      ],
                    ),
